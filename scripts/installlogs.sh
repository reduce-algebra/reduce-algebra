 ...
 $here/installlogs-sub.sh assert       "assert"                          
 $here/installlogs-sub.sh odesolve     "odesolve"    non             
 ...
 $here/installlogs-sub.sh ofsf "redlog/ofsf"                             
 $here/installlogs-sub.sh ibalp "redlog/ibalp"                           
 $here/installlogs-sub.sh pasf "redlog/pasf"                             
 $here/installlogs-sub.sh qqe_ofsf     "redlog/qqe_ofsf"                 
 ...
 $here/installlogs-sub.sh lpdo "lpdo"                                    
 $here/installlogs-sub.sh guardian     "guardian"                        
 $here/installlogs-sub.sh cdiff "cdiff"                                  
