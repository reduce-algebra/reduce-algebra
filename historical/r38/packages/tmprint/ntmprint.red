...
% scope/coddom.red defined dm!-print in a way that is not tmprint-aware or
% friendly.
% MANY MANY packages call prin2!* clearly expecting use of it and terpri!*
% to cooperate.
% tps/tpseval.red, rataprx/decrep.red, hephys/physop.red and others access
% posn!* directly.
...
%
% Hah another nasty. alg/intro.red redefined typerr (from rlisp/lpri.red),
