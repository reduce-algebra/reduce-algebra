...
setq n (random!-number (difference 256 j))) (print n) (setq q p) (prog (k) (setq k 1) 
lab1000 (cond ((minusp (times 1 (difference n k))) (return nil))) (setq q (
cdr q)) (setq k (plus k 1)) (go lab1000)) (setq w (car p)) (rplaca p (car q))
(rplaca q w) (setq p (cdr p))) (setq j (plus j 1)) (go lab1001)))))
