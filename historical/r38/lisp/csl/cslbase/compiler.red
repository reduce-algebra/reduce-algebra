...
%       Copyright (C) Codemist Ltd, 1990-2007
%
...
%     I have to pass an export library "r38.lib" to the compilation rather
...
% have IMPORTS definitions here but instead I must include r38.lib as
% input to the compilation. But I will not support this on win64 until
% I sort out how to work around that.
           printc "IMPORTS";
           print!-imports();
           close wrs w1;
