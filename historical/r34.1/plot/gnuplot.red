...
fluid '(plotranges!* plotfunctions!* xplotcommandprefix plotpipe!*
        plotstyle!* plotoptions!*);
 
global '(plotcommand plotdata plotdata2 plotheader);

share plotdata,plotdata2,plotcommand;
...
symbolic procedure PlotOpenDisplay();
   begin
    ...
    plotprin2 plotheader; plotterpri();
   end;
...
symbolic procedure plotshow();
   ...
   <<plotprin2 "pause -1 "; plotterpri(); close  plotpipe!*;
     plotpipe!* := nil;
     if getd 'system and getd 'bldmsg then 
...
symbolic procedure plotprinexpr u;
   <<writepri(mkquote u,nil)>> where v=wrs plotpipe!*,!*nat=nil,
                                     !*lower=t;
