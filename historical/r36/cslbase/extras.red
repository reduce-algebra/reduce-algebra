...
% Converts an integer into a sequence of letters and digits by
...
symbolic macro procedure format u;
...
smacro procedure s!:top; car stack;
smacro procedure s!:depth frm; car frm;
smacro procedure s!:indenting frm; cadr frm;
smacro procedure s!:blankcount frm; caddr frm;
smacro procedure s!:blanklist frm; cdddr frm;
smacro procedure s!:setindenting(frm,val); rplaca(cdr frm,val);
smacro procedure s!:setblankcount(frm,val); rplaca(cddr frm,val);
smacro procedure s!:setblanklist(frm,val); rplacd(cddr frm,val);
smacro procedure s!:newframe n; list(n,nil,0);
smacro procedure s!:blankp char; numberp car char;
