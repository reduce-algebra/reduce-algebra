/*  sysxwin.c                       Copyright (C) 1993-6 Codemist Ltd */

/*
 * General Unix/X/StdWin system-specific code
 */

/* Signature: 1e68f6c9 07-Mar-2000 */
...
static char *loads[] = {
  "arnum", "assist", "CSLboolean", "changevr", "compact", "complex",
