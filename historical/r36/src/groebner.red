...
put('groebner,'version,2.9);

% Other packages needed.

load!-package 'dipoly;

if(null v or v<3.7) where v=get('dipoly,'version)
...
fluid '(!*factor !*complex !*exp asymplis!* current!-modulus);

global '(!*match powlis!* largest!-small!-modulus);
