...
put('car,'setqfn,'(lambda (u v) (progn (rplaca u v) v)));

put('cdr,'setqfn,'(lambda (u v) (progn (rplacd u v) v)));

put('caar,'setqfn,'(lambda (u v) (progn (rplaca (car u) v) v)));

put('cadr,'setqfn,'(lambda (u v) (progn (rplaca (cdr u) v) v)));

put('cdar,'setqfn,'(lambda (u v) (progn (rplacd (car u) v) v)));

put('cddr,'setqfn,'(lambda (u v) (progn (rplacd (cdr u) v) v)));

put('caaar,'setqfn,'(lambda (u v) (progn (rplaca (caar u) v) v)));

put('caadr,'setqfn,'(lambda (u v) (progn (rplaca (cadr u) v) v)));

put('cadar,'setqfn,'(lambda (u v) (progn (rplaca (cdar u) v) v)));

put('caddr,'setqfn,'(lambda (u v) (progn (rplaca (cddr u) v) v)));

put('cdaar,'setqfn,'(lambda (u v) (progn (rplacd (caar u) v) v)));

put('cdadr,'setqfn,'(lambda (u v) (progn (rplacd (cadr u) v) v)));

put('cddar,'setqfn,'(lambda (u v) (progn (rplacd (cdar u) v) v)));

put('cdddr,'setqfn,'(lambda (u v) (progn (rplacd (cddr u) v) v)));

put('caaaar,'setqfn,'(lambda (u v) (progn (rplaca (caaar u) v) v)));

put('caaadr,'setqfn,'(lambda (u v) (progn (rplaca (caadr u) v) v)));

put('caadar,'setqfn,'(lambda (u v) (progn (rplaca (cadar u) v) v)));

put('caaddr,'setqfn,'(lambda (u v) (progn (rplaca (caddr u) v) v)));

put('cadaar,'setqfn,'(lambda (u v) (progn (rplaca (cdaar u) v) v)));

put('cadadr,'setqfn,'(lambda (u v) (progn (rplaca (cdadr u) v) v)));

put('caddar,'setqfn,'(lambda (u v) (progn (rplaca (cddar u) v) v)));

put('cadddr,'setqfn,'(lambda (u v) (progn (rplaca (cdddr u) v) v)));

put('cdaaar,'setqfn,'(lambda (u v) (progn (rplacd (caaar u) v) v)));

put('cdaadr,'setqfn,'(lambda (u v) (progn (rplacd (caadr u) v) v)));

put('cdadar,'setqfn,'(lambda (u v) (progn (rplacd (cadar u) v) v)));

put('cdaddr,'setqfn,'(lambda (u v) (progn (rplacd (caddr u) v) v)));

put('cddaar,'setqfn,'(lambda (u v) (progn (rplacd (cdaar u) v) v)));

put('cddadr,'setqfn,'(lambda (u v) (progn (rplacd (cdadr u) v) v)));

put('cdddar,'setqfn,'(lambda (u v) (progn (rplacd (cddar u) v) v)));

put('cddddr,'setqfn,'(lambda (u v) (progn (rplacd (cdddr u) v) v)));

put('nth,'setqfn,'(lambda (l i x) (rplaca (pnth l i) x)));
      ...
      for each x in v do
       ...
       if null erfg!*
         then <<put(car x,'rtype,'array);
            put(car x,'avalue,list('array,mkarray(y,u)));
