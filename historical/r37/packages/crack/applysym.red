create!-package('(applysym), nil);      % FJW
...
symbolic fluid '(print_ logoprint_ nfct_ fname_ time_ facint_ adjust_fnc)$
...
begin
  scalar lcopy,x,cS,flist,soln,printold,timeold,facintold,
         adjustold,e1,e2,e3,e4,n,nmax,dff;
