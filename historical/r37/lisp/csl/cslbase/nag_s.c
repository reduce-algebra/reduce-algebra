/* Signature: 1b4f8465 08-Apr-2002 */
...
#ifdef LOADLIB
  typedef void (__stdcall *PSXXEAF) (double *, double *, int32 *);
  HINSTANCE hLib;
  PSXXEAF sxxeaf_proc;
#else
...
#ifdef LOADLIB
  typedef double (__stdcall *PS13AAF) (double *, int32 *);
  HINSTANCE hLib;
  PS13AAF s13aaf_proc;
#else
...
#ifdef LOADLIB
  typedef double (__stdcall *PS13ACF) (double *, int32 *);
  HINSTANCE hLib;
  PS13ACF s13acf_proc;
#else
  extern double __stdcall S13ACF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS13ADF) (double *, int32 *);
  HINSTANCE hLib;
  PS13ADF s13adf_proc;
#else
  extern double __stdcall S13ADF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS14AAF) (double *, int32 *);
  HINSTANCE hLib;
  PS14AAF s14aaf_proc;
#else
  extern double __stdcall S14AAF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS14ABF) (double *, int32 *);
  HINSTANCE hLib;
  PS14ABF s14abf_proc;
#else
  extern double __stdcall S14ABF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS15ADF) (double *, int32 *);
  HINSTANCE hLib;
  PS15ADF s15adf_proc;
#else
  extern double __stdcall S15ADF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS15AEF) (double *, int32 *);
  HINSTANCE hLib;
  PS15AEF s15aef_proc;
#else
  extern double __stdcall S15AEF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS17ACF) (double *, int32 *);
  HINSTANCE hLib;
  PS17ACF s17acf_proc;
#else
  extern double __stdcall S17ACF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS17ADF) (double *, int32 *);
  HINSTANCE hLib;
  PS17ADF s17adf_proc;
#else
  extern double __stdcall S17ADF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS17AEF) (double *, int32 *);
  HINSTANCE hLib;
  PS17AEF s17aef_proc;
#else
  extern double __stdcall S17AEF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS17AFF) (double *, int32 *);
  HINSTANCE hLib;
  PS17AFF s17aff_proc;
#else
  extern double __stdcall S17AFF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS17AGF) (double *, int32 *);
  HINSTANCE hLib;
  PS17AGF s17agf_proc;
#else
  extern double __stdcall S17AGF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS17AHF) (double *, int32 *);
  HINSTANCE hLib;
  PS17AHF s17ahf_proc;
#else
  extern double __stdcall S17AHF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS17AJF) (double *, int32 *);
  HINSTANCE hLib;
  PS17AJF s17ajf_proc;
#else
  extern double __stdcall S17AJF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS17AKF) (double *, int32 *);
  HINSTANCE hLib;
  PS17AKF s17akf_proc;
#else
  extern double __stdcall S17AKF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef void (__stdcall *PS17DCF) (double *, double *, int32 *, fstring1,
	  double *, int32 *, double *, int32 *);
  HINSTANCE hLib;
  PS17DCF s17dcf_proc;
#else
  extern void __stdcall S17DCF (double *, double *, int32 *, fstring1,
	  double *, int32 *, double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef void (__stdcall *PS17DEF) (double *, double *, int32 *, fstring1,
	  double *, int32 *, int32 *);
  HINSTANCE hLib;
  PS17DEF s17def_proc;
#else
  extern void __stdcall S17DEF (double *, double *, int32 *, fstring1,
	  double *, int32 *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef void (__stdcall *PS17DLF) (int32 *, double *, double *, int32 *,
	  fstring1, double *, int32 *, int32 *);
  HINSTANCE hLib;
  PS17DLF s17dlf_proc;
#else
  extern void __stdcall S17DLF (int32 *, double *, double *, int32 *,
	  fstring1, double *, int32 *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS18ACF) (double *, int32 *);
  HINSTANCE hLib;
  PS18ACF s18acf_proc;
#else
  extern double __stdcall S18ACF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS18ADF) (double *, int32 *);
  HINSTANCE hLib;
  PS18ADF s18adf_proc;
#else
  extern double __stdcall S18ADF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS18AEF) (double *, int32 *);
  HINSTANCE hLib;
  PS18AEF s18aef_proc;
#else
  extern double __stdcall S18AEF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS18AFF) (double *, int32 *);
  HINSTANCE hLib;
  PS18AFF s18aff_proc;
#else
  extern double __stdcall S18AFF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef void (__stdcall *PS18DCF) (double *, double *, int32 *, fstring1,
	  double *, int32 *, int32 *);
  HINSTANCE hLib;
  PS18DCF s18dcf_proc;
#else
  extern void __stdcall S18DCF (double *, double *, int32 *, fstring1,
	  double *, int32 *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef void (__stdcall *PS18DEF) (double *, double *, int32 *, fstring1,
	  double *, int32 *, int32 *);
  HINSTANCE hLib;
  PS18DEF s18def_proc;
#else
  extern void __stdcall S18DEF (double *, double *, int32 *, fstring1,
	  double *, int32 *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS19AAF) (double *, int32 *);
  HINSTANCE hLib;
  PS19AAF s19aaf_proc;
#else
  extern double __stdcall S19AAF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS19ABF) (double *, int32 *);
  HINSTANCE hLib;
  PS19ABF s19abf_proc;
#else
  extern double __stdcall S19ABF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS19ACF) (double *, int32 *);
  HINSTANCE hLib;
  PS19ACF s19acf_proc;
#else
  extern double __stdcall S19ACF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS19ADF) (double *, int32 *);
  HINSTANCE hLib;
  PS19ADF s19adf_proc;
#else
  extern double __stdcall S19ADF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS20ACF) (double *, int32 *);
  HINSTANCE hLib;
  PS20ACF s20acf_proc;
#else
  extern double __stdcall S20ACF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS20ADF) (double *, int32 *);
  HINSTANCE hLib;
  PS20ADF s20adf_proc;
#else
  extern double __stdcall S20ADF (double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS21BAF) (double *, double *, int32 *);
  HINSTANCE hLib;
  PS21BAF s21baf_proc;
#else
  extern double __stdcall S21BAF (double *, double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS21BBF) (double *, double *, double *, int32 *);
  HINSTANCE hLib;
  PS21BBF s21bbf_proc;
#else
  extern double __stdcall S21BBF (double *, double *, double *, int32 *);
#endif
...
#ifdef LOADLIB
  typedef double (__stdcall *PS21BCF) (double *, double *, double *, int32 *);
  HINSTANCE hLib;
  PS21BCF s21bcf_proc;
#else
  extern double __stdcall S21BCF (double *, double *, double *, int32 *);
#endif
