/*  sysdos.c                       Copyright (C) 1989-2002 Codemist Ltd */
 ...
 * compilers.  It is also used with LCC where the term "DOS" is used to
 * indicate "primitive command-line interface with no fancy frills"!
 */
...
/* Signature: 458c3739 21-Apr-2002 */
