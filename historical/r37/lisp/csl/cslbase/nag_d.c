...
/* Signature: 062f0fe1 08-Apr-2002 */
...
Lisp_Object MS_CDECL Ld01ajf(Lisp_Object nil, int nargs, ...)
{
  ...
  iw = (int32 *)malloc(liw*sizeof(int));
...
Lisp_Object MS_CDECL Ld01alf(Lisp_Object nil, int nargs, ...)
{
  ...
  int32  ifail, lw, *iw, liw, npts;
  extern double __stdcall asp1(double *);

#ifdef LOADLIB
  typedef void (__stdcall *PD01ALF) (double __stdcall (*fst) (double *),
	  double *, double *, int32 *, double *, double *, double *,
...
Lisp_Object MS_CDECL Ld01amf(Lisp_Object nil, int nargs, ...)
{
  ...
  extern void __stdcall D01AMF(double __stdcall (*fst) (double *), double *,
	  int32 *, double *, double *, double *, double *, double *, int32 *,
	  int32 *, int32 *, int32 *);
#endif
...
Lisp_Object MS_CDECL Ld01anf(Lisp_Object nil, int nargs, ...)
{
  ...
  int32  ifail, lw, *iw, liw, key;
  extern double __stdcall asp1(double *);

#ifdef LOADLIB
  typedef void (__stdcall *PD01ANF) (double __stdcall (*fst) (double *),
	  double *, double *, double *, int32 *, double *, double *,
	  double *, double *, double *, int32 *, int32 *, int32 *, int32 *);
  HINSTANCE hLib;
  PD01ANF d01anf_proc;
#else
...
Lisp_Object MS_CDECL Ld01asf(Lisp_Object nil, int nargs, ...)
{
  ...
  int32  ifail, lw, *iw, liw, key, limlst, lst, *ierlst;
  extern double __stdcall asp1(double *);

#ifdef LOADLIB
  typedef void (__stdcall *PD01ASF) (double __stdcall (*fst) (double *),
	  double *, double *, int32 *, double *, double *, double *, int32 *,
	  int32 *, double *, double *, int32 *, double *, int32 *, int32 *,
	  int32 *, int32 *);
  HINSTANCE hLib;
  PD01ASF d01asf_proc;
#else
  extern void __stdcall D01ASF(double __stdcall (*fst) (double *), double *,
	  double *, int32 *, double *, double *, double *, int32 *, int32 *,
	  double *, double *, int32 *, double *, int32 *, int32 *, int32 *,
	  int32 *);
#endif
  ...
  ierlst = (int32 *)malloc(limlst*sizeof(int));
  w = (double *)malloc(lw*sizeof(double));
  iw = (int32 *)malloc(liw*sizeof(int));
...
Lisp_Object MS_CDECL Ld01bbf(Lisp_Object nil, int nargs, ...)
{
  ...
  int32  ifail, itype, n, gtype;

#ifdef LOADLIB
  typedef void (__stdcall *PAD01BB) (double *, double *, int32 *, int32 *,
	  double *, double *, int32 *, int32 *);
  HINSTANCE hLib;
  PAD01BB ad01bb_proc;
#else
  extern void __stdcall AD01BB(double *, double *, int32 *, int32 *,
	  double *, double *, int32 *, int32 *);
#endif
...
Lisp_Object MS_CDECL Ld01fcf(Lisp_Object nil, int nargs, ...)
{
  ...
  int32  ifail, ndim, minpts, maxpts, lenwrk;
  extern double __stdcall asp4(int32 *, double *);

#ifdef LOADLIB
  typedef void (__stdcall *PD01FCF) (int32 *, double *, double *, int32 *,
	  int32 *, double __stdcall (*functn) (int32 *, double *), double *,
	  double *, int32 *, double *, double *, int32 *);
  HINSTANCE hLib;
  PD01FCF d01fcf_proc;
#else
  extern void __stdcall D01FCF(int32 *, double *, double *, int32 *, int32 *,
	  double __stdcall (*functn) (int32 *, double *), double *, double *,
...
#ifdef LOADLIB
  typedef void (__stdcall *PD01GAF) (double *, double *, int32 *, double *,
	  double *, int32 *);
  HINSTANCE hLib;
  PD01GAF d01gaf_proc;
#else
  extern void __stdcall D01GAF(double *, double *, int32 *, double *,
	  double *, int32 *);
#endif
...
Lisp_Object MS_CDECL Ld01gbf(Lisp_Object nil, int nargs, ...)
{
  ...
  Lisp_Object La, Lb, Lndim, Leps, Lmincls, Lmaxcls, Lifail, Lfinval, Lacc,
              Llenwrk, Lwrkstr;
  double *a, *b, eps, finval, acc, *wrkstr;
  int32  ifail, ndim, mincls, maxcls, lenwrk;
  extern double __stdcall asp4(int32 *, double *);

#ifdef LOADLIB
  typedef void (__stdcall *PD01GBF) (int32 *, double *, double *, int32 *,
	  int32 *, double __stdcall (*functn) (int32 *, double *), double *,
	  double *, int32 *, double *, double *, int32 *);
  HINSTANCE hLib;
  PD01GBF d01gbf_proc;
#else
  extern void __stdcall D01GBF(int32 *, double *, double *, int32 *, int32 *,
	  double __stdcall (*functn) (int32 *, double *), double *, double *,
	  int32 *, double *, double *, int32 *);
#endif
...
#if 0
{
  ...
  int32  ifail, m, n, irelab;
  extern void __stdcall asp7(double *, double *, double *);
  extern void __stdcall asp8(double *, double *);

#ifdef LOADLIB
  typedef void (__stdcall *PXD02BB) (double *, double *, int32 *, int32 *,
	  double *, double *, int32 *, double *,
	  void __stdcall (*fcn) (double *, double *, double *),
	  void __stdcall (*out) (double *, double *), double *, int32 *);
  HINSTANCE hLib;
  PXD02BB xd02bb_proc;
#else
  extern void __stdcall XD02BB(double *, double *, int32 *, int32 *,
	  double *, double *, int32 *, double *,
	  void __stdcall (*fcn) (double *, double *, double *),
	  void __stdcall (*out) (double *, double *), double *, int32 *);
#endif
...
#if 0
{
  ...
  int32  ifail, n, irelab;
  extern void __stdcall asp7(double *, double *, double *);
  extern double __stdcall asp9(double *, double *);

#ifdef LOADLIB
  typedef void (__stdcall *PD02BHF) (double *, double *, int32 *, int32 *,
	  double *, double *, int32 *, double *,
	  void __stdcall (*fcn) (double *, double *, double *),
	  double __stdcall (*g) (double *, double *), double *, int32 *);
  HINSTANCE hLib;
  PD02BHF d02bhf_proc;
#else
  extern void __stdcall D02BHF(double *, double *, int32 *, int32 *,
	  double *, double *, int32 *, double *,
	  void __stdcall (*fcn) (double *, double *, double *),
	  double __stdcall (*g) (double *, double *), double *, int32 *);
#endif
...
{							/* FIXME: strings */
...
#ifdef LOADLIB
  typedef void (__stdcall *PXD02CJ) (double *, double *, int32 *, int32 *,
  ...
  PXD02CJ xd02cj_proc;
#else
  extern void __stdcall XD02CJ(double *, double *, int32 *, int32 *,
	  double *, void __stdcall (*fcn) (double *, double *, double *),
	  double *, fstring1, double *,
	  void __stdcall (*out) (double *, double *),
	  double __stdcall (*g) (double *, double *), double *, int32 *);
...
{							/* FIXME: strings */
...
#ifdef LOADLIB
  typedef void (__stdcall *PXD02EJ) (double *, double *, int32 *, int32 *,
	  double *, void __stdcall (*fcn) (double *, double *, double *),
  ...
  PXD02EJ xd02ej_proc;
#else
  extern void __stdcall XD02EJ(double *, double *, int32 *, int32 *,
	  double *, void __stdcall (*fcn) (double *, double *, double *),
	  void __stdcall (*pederv) (double *, double *, double *), double *,
	  fstring1, void __stdcall (*out) (double *, double *),
	  double __stdcall (*g) (double *, double *), double *, int32 *,
