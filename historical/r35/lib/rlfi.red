%***********************************************************************
%*****                                                            ******
%*****     M O D U L E     R L F I      Ver. 1.2     02/10/1992   ******
%*****                                                            ******
%***********************************************************************
...
%         tjerl@aci.cvut.cs      (Internet)
% Program RLFI, Version REDUCE 3.4.1 02/10/1992
...
DEFLIST('((!( !\left!() (!) !\right!)) (PI !\pi! ) (pi !\pi! )
          (E e) (I i)),'NAME);
DEFLIST('((TIMES ! )(SETQ !=)(GEQ !\geq! )(LEQ !\leq! )),'LAPR);
% LaTeX supported operators
DEFLIST('(
          (ACOS !\arccos)   (COTH !\coth)   (SEC !\sec)
          (ASIN !\arcsin)   (CSC  !\csc)    (SIN !\sin)
          (ATAN !\arctan)   (EXP !\exp)     (SINH !\sinh)
          (ARG !\arg)       (LN !\ln)       (TAN !\tan)
          (COS !\cos)       (LOG !\log)     (TANH !\tanh)
          (COSH !\cosh)     (MAX !\max)     (SUM !\sum)
          (COT !\cot)       (MIN !\min)     (PRODUCT !\prod)
          ),'LAPOP);
...
<<!*!*a2sfn:='texaeval;
  !*raise:=nil;
  if 'psl memq lispsystem!* then !*lower := nil;   % PSL kludge.
...
<<!*!*a2sfn:='aeval;
  !*raise:=t;
  if 'psl memq lispsystem!* then !*lower := t;
  remprop('tex,'rtypefn);
  if !*verbatim then
      <<terpri();
        prin2t "\end{verbatim}" >>;
