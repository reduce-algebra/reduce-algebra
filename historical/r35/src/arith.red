  ...
  begin scalar result; integer j;
    ...
    for each char in lst do <<
      ...
      if j=5 then <<if !*nat and !*bfspace then result := '!  . result;
                    j := 0>>>>;
    if ex neq 0 then <<
    if not (!*nat and !*bfspace) then result := 'e . result
     else if j=0 then <<result := '!  . 'e . result; j := 2>>
     else if j=1 then <<result := '!  . 'e . '!  . result; j := 4>>
     else if j=2
      then <<result := '!  . '!  . 'e . '!  . result; j := 0>>
     else if j=3 then <<result := '!  . 'e . '!  . result; j := 0>>
     else if j=4 then <<result := '!  . 'e . '!  . result; j := 2>>;
