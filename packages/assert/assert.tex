...
% sturm@lennier[~/Desktop] time redpsl < taylor.tst > taylor.log 

% real	0m0.778s
% user	0m0.587s
% sys	0m0.185s
% sturm@lennier[~/Desktop] time redcsl < taylor.tst > taylor.log 
...
the TAYLOR package. For CSL we observe a slowdown of factor 3.3, and for
PSL we observe a slowdown of factor 1.7 in this particular example.
