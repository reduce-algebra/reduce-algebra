...
{ArcCos[a*x]/x, x, 5, (-(1/2))*I*ArcCos[a*x]^2 + ArcCos[a*x]*Log[1 + E^(2*I*ArcCos[a*x])] - (1/2)*I*PolyLog[2, -E^(2*I*ArcCos[a*x])]}
...
{ArcCos[a*x]^2/x, x, 6, (-(1/3))*I*ArcCos[a*x]^3 + ArcCos[a*x]^2*Log[1 + E^(2*I*ArcCos[a*x])] - I*ArcCos[a*x]*PolyLog[2, -E^(2*I*ArcCos[a*x])] + (1/2)*PolyLog[3, -E^(2*I*ArcCos[a*x])]}
{ArcCos[a*x]^2/x^2, x, 5, -(ArcCos[a*x]^2/x) - 4*I*a*ArcCos[a*x]*ArcTan[E^(I*ArcCos[a*x])] + 2*I*a*PolyLog[2, (-I)*E^(I*ArcCos[a*x])] - 2*I*a*PolyLog[2, I*E^(I*ArcCos[a*x])]}
{ArcCos[a*x]^2/x^3, x, 2, (a*Sqrt[1 - a^2*x^2]*ArcCos[a*x])/x - ArcCos[a*x]^2/(2*x^2) + a^2*Log[x]}
{ArcCos[a*x]^2/x^4, x, 7, -(a^2/(3*x)) + (a*Sqrt[1 - a^2*x^2]*ArcCos[a*x])/(3*x^2) - ArcCos[a*x]^2/(3*x^3) - (2/3)*I*a^3*ArcCos[a*x]*ArcTan[E^(I*ArcCos[a*x])] + (1/3)*I*a^3*PolyLog[2, (-I)*E^(I*ArcCos[a*x])] - (1/3)*I*a^3*PolyLog[2, I*E^(I*ArcCos[a*x])]}
...
{ArcCos[a*x^2]/x, x, 5, (-(1/4))*I*ArcCos[a*x^2]^2 + (1/2)*ArcCos[a*x^2]*Log[1 + E^(2*I*ArcCos[a*x^2])] - (1/4)*I*PolyLog[2, -E^(2*I*ArcCos[a*x^2])]}
...
{ArcCos[Sqrt[x]]/x, x, 5, (-I)*ArcCos[Sqrt[x]]^2 + 2*ArcCos[Sqrt[x]]*Log[1 + E^(2*I*ArcCos[Sqrt[x]])] - I*PolyLog[2, -E^(2*I*ArcCos[Sqrt[x]])]}
...
{1/ArcCos[a + b*x], x, 1, -(SinIntegral[ArcCos[a + b*x]]/b)}
{1/ArcCos[a + b*x]^2, x, 1, Sqrt[1 - (a + b*x)^2]/(b*ArcCos[a + b*x]) - CosIntegral[ArcCos[a + b*x]]/b}
{1/ArcCos[a + b*x]^3, x, 2, Sqrt[1 - (a + b*x)^2]/(2*b*ArcCos[a + b*x]^2) + (a + b*x)/(2*b*ArcCos[a + b*x]) + SinIntegral[ArcCos[a + b*x]]/(2*b)}
...
{ArcCos[a + b*x]/((a*d)/b + d*x), x, 8, -((I*ArcCos[a + b*x]^2)/(2*d)) + (ArcCos[a + b*x]*Log[1 + E^(2*I*ArcCos[a + b*x])])/d - (I*PolyLog[2, -E^(2*I*ArcCos[a + b*x])])/(2*d)}
...
{E^ArcCos[x]/x, x, 2, -Subst[Int[E^x*Tan[x], x], x, ArcCos[x]]}
