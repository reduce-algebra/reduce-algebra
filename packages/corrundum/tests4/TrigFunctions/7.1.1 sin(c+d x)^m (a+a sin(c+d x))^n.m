...
{Sin[x]^4/(a + a*Sin[x]), x, 4, -((3*x)/(2*a)) - (4*Cos[x])/a + (4*Cos[x]^3)/(3*a) + (3*Cos[x]*Sin[x])/(2*a) + (Cos[x]*Sin[x]^3)/(a + a*Sin[x])}
{Sin[x]^3/(a + a*Sin[x]), x, 3, (3*x)/(2*a) + (2*Cos[x])/a - (3*Cos[x]*Sin[x])/(2*a) + (Cos[x]*Sin[x]^2)/(a + a*Sin[x])}
{Sin[x]^2/(a + a*Sin[x]), x, 3, -(x/a) - Cos[x]/a - Cos[x]/(a + a*Sin[x])}
{Sin[x]^1/(a + a*Sin[x]), x, 2, x/a + Cos[x]/(a + a*Sin[x])}
{Csc[x]^1/(a + a*Sin[x]), x, 3, -(ArcTanh[Cos[x]]/a) + Cos[x]/(a + a*Sin[x])}
{Csc[x]^2/(a + a*Sin[x]), x, 3, ArcTanh[Cos[x]]/a - (2*Cot[x])/a + Cot[x]/(a + a*Sin[x])}
{Csc[x]^3/(a + a*Sin[x]), x, 4, -((3*ArcTanh[Cos[x]])/(2*a)) + (2*Cot[x])/a - (3*Cot[x]*Csc[x])/(2*a) + (Cot[x]*Csc[x])/(a + a*Sin[x])}
{Csc[x]^4/(a + a*Sin[x]), x, 5, (3*ArcTanh[Cos[x]])/(2*a) - (4*Cot[x])/a - (4*Cot[x]^3)/(3*a) + (3*Cot[x]*Csc[x])/(2*a) + (Cot[x]*Csc[x]^2)/(a + a*Sin[x])}


{Sin[x]^4/(a + a*Sin[x])^2, x, 5, (7*x)/(2*a^2) + (16*Cos[x])/(3*a^2) - (7*Cos[x]*Sin[x])/(2*a^2) + (8*Cos[x]*Sin[x]^2)/(3*a^2*(1 + Sin[x])) + (Cos[x]*Sin[x]^3)/(3*(a + a*Sin[x])^2)}
{Sin[x]^3/(a + a*Sin[x])^2, x, 4, -((2*x)/a^2) - (4*Cos[x])/(3*a^2) - (2*Cos[x])/(a^2*(1 + Sin[x])) + (Cos[x]*Sin[x]^2)/(3*(a + a*Sin[x])^2)}
{Sin[x]^2/(a + a*Sin[x])^2, x, 3, x/a^2 + (5*Cos[x])/(3*a^2*(1 + Sin[x])) - Cos[x]/(3*(a + a*Sin[x])^2)}
{Sin[x]^1/(a + a*Sin[x])^2, x, 2, Cos[x]/(3*(a + a*Sin[x])^2) - (2*Cos[x])/(3*(a^2 + a^2*Sin[x]))}
{Csc[x]^1/(a + a*Sin[x])^2, x, 3, -(ArcTanh[Cos[x]]/a^2) + (4*Cos[x])/(3*a^2*(1 + Sin[x])) + Cos[x]/(3*(a + a*Sin[x])^2)}
{Csc[x]^2/(a + a*Sin[x])^2, x, 5, (2*ArcTanh[Cos[x]])/a^2 - (10*Cot[x])/(3*a^2) + (2*Cot[x])/(a^2*(1 + Sin[x])) + Cot[x]/(3*(a + a*Sin[x])^2)}
{Csc[x]^3/(a + a*Sin[x])^2, x, 6, -((7*ArcTanh[Cos[x]])/(2*a^2)) + (16*Cot[x])/(3*a^2) - (7*Cot[x]*Csc[x])/(2*a^2) + (8*Cot[x]*Csc[x])/(3*a^2*(1 + Sin[x])) + (Cot[x]*Csc[x])/(3*(a + a*Sin[x])^2)}
{Csc[x]^4/(a + a*Sin[x])^2, x, 7, (5*ArcTanh[Cos[x]])/a^2 - (4*Cot[x])/a^2 - Cot[x]^3/(3*a^2) + (Cot[x]*Csc[x])/a^2 - Cos[x]/(3*a^2*(1 + Sin[x])^2) - (13*Cos[x])/(3*a^2*(1 + Sin[x])), (5*ArcTanh[Cos[x]])/a^2 - (12*Cot[x])/a^2 - (4*Cot[x]^3)/a^2 + (5*Cot[x]*Csc[x])/a^2 + (10*Cot[x]*Csc[x]^2)/(3*a^2*(1 + Sin[x])) + (Cot[x]*Csc[x]^2)/(3*(a + a*Sin[x])^2)}


{Sin[x]^6/(a + a*Sin[x])^3, x, 7, -((23*x)/(2*a^3)) - (136*Cos[x])/(5*a^3) + (136*Cos[x]^3)/(15*a^3) + (23*Cos[x]*Sin[x])/(2*a^3) + (Cos[x]*Sin[x]^5)/(5*(a + a*Sin[x])^3) + (13*Cos[x]*Sin[x]^4)/(15*a*(a + a*Sin[x])^2) + (23*Cos[x]*Sin[x]^3)/(3*(a^3 + a^3*Sin[x]))}
{Sin[x]^5/(a + a*Sin[x])^3, x, 6, (13*x)/(2*a^3) + (152*Cos[x])/(15*a^3) - (13*Cos[x]*Sin[x])/(2*a^3) + (Cos[x]*Sin[x]^4)/(5*(a + a*Sin[x])^3) + (11*Cos[x]*Sin[x]^3)/(15*a*(a + a*Sin[x])^2) + (76*Cos[x]*Sin[x]^2)/(15*(a^3 + a^3*Sin[x]))}
{Sin[x]^4/(a + a*Sin[x])^3, x, 5, -((3*x)/a^3) - (9*Cos[x])/(5*a^3) + (Cos[x]*Sin[x]^3)/(5*(a + a*Sin[x])^3) + (3*Cos[x]*Sin[x]^2)/(5*a*(a + a*Sin[x])^2) - (3*Cos[x])/(a^3 + a^3*Sin[x])}
{Sin[x]^3/(a + a*Sin[x])^3, x, 4, x/a^3 + (Cos[x]*Sin[x]^2)/(5*(a + a*Sin[x])^3) - (7*Cos[x])/(15*a*(a + a*Sin[x])^2) + (29*Cos[x])/(15*(a^3 + a^3*Sin[x]))}
{Sin[x]^2/(a + a*Sin[x])^3, x, 3, -(Cos[x]/(5*(a + a*Sin[x])^3)) + (8*Cos[x])/(15*a*(a + a*Sin[x])^2) - (7*Cos[x])/(15*(a^3 + a^3*Sin[x]))}
{Sin[x]^1/(a + a*Sin[x])^3, x, 3, Cos[x]/(5*(a + a*Sin[x])^3) - Cos[x]/(5*a*(a + a*Sin[x])^2) - Cos[x]/(5*(a^3 + a^3*Sin[x]))}
{Csc[x]^1/(a + a*Sin[x])^3, x, 4, -(ArcTanh[Cos[x]]/a^3) + Cos[x]/(5*(a + a*Sin[x])^3) + (7*Cos[x])/(15*a*(a + a*Sin[x])^2) + (22*Cos[x])/(15*(a^3 + a^3*Sin[x]))}
{Csc[x]^2/(a + a*Sin[x])^3, x, 6, (3*ArcTanh[Cos[x]])/a^3 - (24*Cot[x])/(5*a^3) + Cot[x]/(5*(a + a*Sin[x])^3) + (3*Cot[x])/(5*a*(a + a*Sin[x])^2) + (3*Cot[x])/(a^3 + a^3*Sin[x])}
{Csc[x]^3/(a + a*Sin[x])^3, x, 7, -((13*ArcTanh[Cos[x]])/(2*a^3)) + (152*Cot[x])/(15*a^3) - (13*Cot[x]*Csc[x])/(2*a^3) + (Cot[x]*Csc[x])/(5*(a + a*Sin[x])^3) + (11*Cot[x]*Csc[x])/(15*a*(a + a*Sin[x])^2) + (76*Cot[x]*Csc[x])/(15*(a^3 + a^3*Sin[x]))}
{Csc[x]^4/(a + a*Sin[x])^3, x, 8, (23*ArcTanh[Cos[x]])/(2*a^3) - (136*Cot[x])/(5*a^3) - (136*Cot[x]^3)/(15*a^3) + (23*Cot[x]*Csc[x])/(2*a^3) + (Cot[x]*Csc[x]^2)/(5*(a + a*Sin[x])^3) + (13*Cot[x]*Csc[x]^2)/(15*a*(a + a*Sin[x])^2) + (23*Cot[x]*Csc[x]^2)/(3*(a^3 + a^3*Sin[x]))}
...
{Sin[x]^1/Sqrt[a + a*Sin[x]], x, 3, (2*ArcTanh[Sin[Pi/4 - x/2]]*Cos[Pi/4 - x/2])/Sqrt[a + a*Sin[x]] - (2*Cos[x])/Sqrt[a + a*Sin[x]]}
...
{(Csc[c + d*x]*(A + B*Sin[c + d*x]))/(a + a*Sin[c + d*x]), x, 2, -((A*ArcTanh[Cos[c + d*x]])/(a*d)) + ((A - B)*Cos[c + d*x])/(d*(a + a*Sin[c + d*x]))}
{(Csc[c + d*x]*(A + B*Sin[c + d*x]))/(a - a*Sin[c + d*x]), x, 2, -((A*ArcTanh[Cos[c + d*x]])/(a*d)) + ((A + B)*Cos[c + d*x])/(d*(a - a*Sin[c + d*x]))}
