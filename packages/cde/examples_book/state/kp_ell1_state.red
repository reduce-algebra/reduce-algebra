...
all_parametric_der!*:=(u u_t u_x u_y u_2t u_tx u_2x u_ty u_xy u_2y u_3t u_2tx
u_t2x u_3x u_2ty u_txy u_2xy u_t2y u_x2y u_3y u_4t u_3tx u_2t2x u_t3x u_4x u_3ty
u_2txy u_t2xy u_3xy u_2t2y u_tx2y u_2x2y u_t3y u_x3y u_4y u_5t u_4tx u_3t2x
u_2t3x u_t4x u_5x u_4ty u_3txy u_2t2xy u_t3xy u_4xy u_3t2y u_2tx2y u_t2x2y
u_3x2y u_2t3y u_tx3y u_2x3y u_t4y u_x4y u_5y u_5tx u_4t2x u_3t3x u_2t4x u_t5x
u_6x u_5ty u_4txy u_3t2xy u_2t3xy u_t4xy u_5xy u_4t2y u_3tx2y u_2t2x2y u_t3x2y
u_4x2y u_3t3y u_2tx3y u_t2x3y u_3x3y u_2t4y u_tx4y u_2x4y u_t5y u_x5y u_6y)
% list of odd principal derivatives:
all_principal_odd!*:=(p_6t)
p_6t = (ext 84)
% list of odd parametric derivatives:
all_parametric_odd!*:=(p p_t p_x p_y p_2t p_tx p_2x p_ty p_xy p_2y p_3t p_2tx
p_t2x p_3x p_2ty p_txy p_2xy p_t2y p_x2y p_3y p_4t p_3tx p_2t2x p_t3x p_4x p_3ty
p_2txy p_t2xy p_3xy p_2t2y p_tx2y p_2x2y p_t3y p_x3y p_4y p_5t p_4tx p_3t2x
p_2t3x p_t4x p_5x p_4ty p_3txy p_2t2xy p_t3xy p_4xy p_3t2y p_2tx2y p_t2x2y
p_3x2y p_2t3y p_tx3y p_2x3y p_t4y p_x4y p_5y p_5tx p_4t2x p_3t3x p_2t4x p_t5x
p_6x p_5ty p_4txy p_3t2xy p_2t3xy p_t4xy p_5xy p_4t2y p_3tx2y p_2t2x2y p_t3x2y
p_4x2y p_3t3y p_2tx3y p_t2x3y p_3x3y p_2t4y p_tx4y p_2x4y p_t5y p_x5y p_6y)
p = (ext 1)
p_t = (ext 2)
p_x = (ext 3)
p_y = (ext 4)
...
primary_diffcon_der_tot!*:=((ddt 0 39 u_6t))
primary_diffcon_odd_tot!*:=((ddt 1 36 p_6t))
...
ddt(1,36):=(*sq ((((letop . 1) . 1)) . 1) t)
% component of ddt w.r.t. p_4tx
ddt(1,37):=(*sq (((((ext 57) . 1) . 1)) . 1) t)
% component of ddt w.r.t. p_3t2x
ddt(1,38):=(*sq (((((ext 58) . 1) . 1)) . 1) t)
% component of ddt w.r.t. p_2t3x
ddt(1,39):=(*sq (((((ext 59) . 1) . 1)) . 1) t)
...
ddt(1,42):=(*sq (((((ext 63) . 1) . 1)) . 1) t)
% component of ddt w.r.t. p_3txy
ddt(1,43):=(*sq (((((ext 64) . 1) . 1)) . 1) t)
% component of ddt w.r.t. p_2t2xy
ddt(1,44):=(*sq (((((ext 65) . 1) . 1)) . 1) t)
% component of ddt w.r.t. p_t3xy
ddt(1,45):=(*sq (((((ext 66) . 1) . 1)) . 1) t)
...
ddx(1,36):=(*sq (((((ext 57) . 1) . 1)) . 1) t)
% component of ddx w.r.t. p_4tx
ddx(1,37):=(*sq (((((ext 58) . 1) . 1)) . 1) t)
% component of ddx w.r.t. p_3t2x
ddx(1,38):=(*sq (((((ext 59) . 1) . 1)) . 1) t)
% component of ddx w.r.t. p_2t3x
ddx(1,39):=(*sq (((((ext 60) . 1) . 1)) . 1) t)
...
ddx(1,42):=(*sq (((((ext 64) . 1) . 1)) . 1) t)
% component of ddx w.r.t. p_3txy
ddx(1,43):=(*sq (((((ext 65) . 1) . 1)) . 1) t)
% component of ddx w.r.t. p_2t2xy
ddx(1,44):=(*sq (((((ext 66) . 1) . 1)) . 1) t)
% component of ddx w.r.t. p_t3xy
ddx(1,45):=(*sq (((((ext 67) . 1) . 1)) . 1) t)
