...
kl := {ka, kcd, ki, klid, kr, ligand, pri, prii}$
xl := {x1, x2, x3, x4, x5, x6}$
fl := {
  - ka*ligand*x1*x2 - kcd*x1 - ki*x1 + kr*x4 + kr*x5 + pri,
  - ka*ligand*x1*x2 - kcd*x2 - ki*x2 + kr*x4 + kr*x6 + prii,
  ka*ligand*x1*x2 - kcd*x3 - ki*x3 - klid*x3,
  ki*x3 - kr*x4,
  ki*x1 - kr*x5,
  ki*x2 - kr*x6}$
