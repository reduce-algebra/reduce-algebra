...
\section{Killing Vectors}  \index{Killing Vectors} The command {\tt KILLING\_VECTOR} is provided for calculating the \index{KILLING_VECTOR command} \label{KILLING\_VECTOR} determining system of partial differential equations of Killing vectors for
...
\example (Calculate the determining pde's for a Killing vector of S(2)) \index{EXCALC package ! example}
