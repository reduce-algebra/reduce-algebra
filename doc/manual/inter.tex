...
\texttt{PAUSE};\ttindextype{PAUSE}{command} may be inserted at any point in an input file.  
...
the command \texttt{cont;}\ttindextype{CONT}{COMMAND} to transfer control back to the
