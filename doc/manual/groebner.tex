...
\subsubsection{$groebner$: Calculation of a Gr\"obner Basis}
\begin{description}
\ttindex{groebner}
...
\begin{description}
\ttindexswitch{GROEBOPT}{GROEBNER}
...
\ttindexswitch{GROEBFULLREDUCTION}{GROEBNER}
...
\ttindexswitch{GLTBASIS}{GROEBNER}
...
\begin{description}
\ttindexswitch{GROEBSTAT}{GROEBNER}
...
\subsubsubsection{$glexconvert$: Conversion of an Arbitrary Gr\"obner Basis
...
\subsubsubsection{$groebner$\_$walk$: Conversion of a (General) Total Degree
...
\subsubsubsection{$groebnerf$ Call}
\ttindex{groebnerf}
...
\subsubsubsection*{Additional switches for $groebnerf$:}
\begin{description}

\ttindexswitch{TRGROEBR}{GROEBNER}
...
too. If the switch
\ttindexswitch{GROEBPROT}{GROEBNER}
\begin{center}
$groebprot$
\end{center}
...
\subsubsubsection{$groepostproc$: Postprocessing of a Gr\"obner Basis}
\ttindex{groepostproc}
