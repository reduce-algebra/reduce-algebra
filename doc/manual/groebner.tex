...
\begin{syntax}
  \f{idealquotient} (\{\meta{exp1}, \meta{exp2},\ldots , \meta{expm}\}, \meta{exp});
\end{syntax}
where \{\meta{exp1}, \meta{exp2}, \ldots , \meta{expm}\} is a list of any number of
expressions or equations, \meta{exp} is a single expression or equation.
