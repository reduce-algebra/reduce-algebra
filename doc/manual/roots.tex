...
\begin{description}
\ttindextype{RATROOT}{switch}
\index{Switch ! \texttt{RATROOT}}
\index{Switches by package ! ROOTS package ! \texttt{RATROOT}}
...
\ttindextype{MULTIROOT}{switch}
\index{Switch ! \texttt{MULTIROOT}}
\index{Switches by package ! ROOTS package ! \texttt{MULTIROOT}}
...
\ttindextype{TRROOT}{switch}
\index{Switch ! \texttt{TRROOT}}
\index{Switches by package ! ROOTS package ! \texttt{TRROOT}}
...
\ttindex{ROOTMSG} 
\ttindextype{ROOTMSG}{switch}
\index{Switch ! \texttt{ROOTMSG}}
\index{Switches by package ! ROOTS package ! \texttt{ROOTMSG}}
