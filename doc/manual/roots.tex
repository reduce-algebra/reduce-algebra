...
\ttindex{ISOLATER}\hypertarget{operator:ISOLATER}{}
...
\ttindex{RLROOTNO}\hypertarget{operator:RLROOTNO}{}
...
\ttindex{ROOTS\_AT\_PREC}\hypertarget{operator:ROOTS_AT_PREC}{}
...
\ttindex{ROOT\_VAL}\hypertarget{operator:ROOT_VAL}{}
...
\ttindex{NEARESTROOT}\hypertarget{operator:NEARESTROOT}{}
...
\ttindex{FIRSTROOT}\hypertarget{operator:FIRSTROOT}{}
...
\ttindex{MKPOLY}\hypertarget{operator:MKPOLY}{}
...
\item[\sw{RATROOT}] (Default OFF) If \sw{RATROOT} is on all root equations are
...
\item[\sw{TRROOT}] (Default OFF) If switch \sw{TRROOT} is on, trace messages
