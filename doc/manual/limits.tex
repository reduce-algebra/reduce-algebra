...
\vspace{.1in}
\noindent \texttt{LIMIT!-}(EXPRN:\emph{algebraic}, VAR:\emph{kernel},
LIMPOINT:\emph{algebraic}):\emph{algebraic}
\noindent \texttt{LIMIT0}(EXPRN:\emph{algebraic}, VAR:\emph{kernel},
LIMPOINT:\emph{algebraic}):\emph{algebraic}
\vspace{.1in}
...
\ttindex{LIMIT1}
\vspace{.1in}
\noindent \texttt{LIMIT1}(EXPRN:\emph{algebraic}, VAR:\emph{kernel},
LIMPOINT:\emph{algebraic}):\emph{algebraic}
\vspace{.1in}
...
\begin{quote}
\begin{tabular}{l@{}l}
\texttt{LIMIT2(} & TOP:\emph{algebraic}, \\
&BOT:\emph{algebraic}, \\
&VAR:\emph{kernel}, \\
&LIMPOINT:\emph{algebraic}):\emph{algebraic}
\end{tabular}
