...
$\mathrm{K}(k)$ and $i\mathrm{K}^\prime(k)$ which are complete elliptic
...
$2m\mathrm{K} +2i n\mathrm{K}^\prime$ where $m$ and $n$ are arbitrary integers.

\begin{tabular}{lllll}
  Function & Period1 & Period2 & Zero & Pole\\
$\mathop{\mathrm{sn}}$&$4\mathrm{K}$&$2i\mathrm{K}^\prime$&$0$&$i\mathrm{K}^\prime$\\
$\mathop{\mathrm{ns}}$&$4\mathrm{K}$&$2i\mathrm{K}^\prime$&$i\mathrm{K}^\prime$&$0$\\
$\mathop{\mathrm{cd}}$&$4\mathrm{K}$&$2i\mathrm{K}^\prime$&$\mathrm{K}$&$\mathrm{K}+i\mathrm{K}^\prime$\\  
$\mathop{\mathrm{dc}}$&$4\mathrm{K}$&$2i\mathrm{K}^\prime$&$\mathrm{K}+i\mathrm{K}^\prime$&$\mathrm{K}$\\ 

$\mathop{\mathrm{cn}}$&$4\mathrm{K}$&$2(\mathrm{K}+i\mathrm{K}^\prime)$&$\mathrm{K}$&$i\mathrm{K}^\prime$\\
$\mathop{\mathrm{nc}}$&$4\mathrm{K}$&$2(\mathrm{K}+i\mathrm{K}^\prime)$&$i\mathrm{K}^\prime$&$\mathrm{K}$\\
$\mathop{\mathrm{sd}}$&$4\mathrm{K}$&$2(\mathrm{K}+i\mathrm{K}^\prime)$&$0$&$\mathrm{K}+i\mathrm{K}^\prime$\\
$\mathop{\mathrm{ds}}$&$4\mathrm{K}$&$2(\mathrm{K}+i\mathrm{K}^\prime)$&$\mathrm{K}+i\mathrm{K}^\prime$&$0$\\

$\mathop{\mathrm{dn}}$&$4i\mathrm{K}^\prime$&$2\mathrm{K}$&$\mathrm{K}+i\mathrm{K}^\prime$&$i\mathrm{K}^\prime$\\
$\mathop{\mathrm{nd}}$&$4i\mathrm{K}^\prime$&$2\mathrm{K}$&$i\mathrm{K}^\prime$&$\mathrm{K}+i\mathrm{K}^\prime$\\
$\mathop{\mathrm{sc}}$&$4i\mathrm{K}^\prime$&$2\mathrm{K}$&$0$&$\mathrm{K}$\\
$\mathop{\mathrm{cs}}$&$4i\mathrm{K}^\prime$&$2\mathrm{K}$&$\mathrm{K}$&$0$\\
\end{tabular}
...
Thus, for example, $4i\mathrm{K}^\prime$ is a period of $\mathrm{cn}$ as
\[4i\mathrm{K}^\prime = 2(\mathrm{K}+\mathrm{K}^\prime) -4\mathrm{K}\]
...
two quarter-periods $\mathrm{K}(k)$ and $i\mathrm{K}^\prime(k)$ and finally
...
$iK^\prime(k)$ is the other quarter-period of the Jacobi elliptic functions.
...
$\mathop{\mathrm{arcsn}}$&$\mathrm{K}$&$i\mathrm{K}^\prime$&
$-(p+q)$, $-p+q$,&$2m p+2n q +(-1)^mv$\\
&&&$p+q$, $p-q$.&\\
$\mathop{\mathrm{arccn}}$&$\mathrm{K}$&$\mathrm{K}+i\mathrm{K}^\prime$&
  $0$, $2q$, $2(p+q)$, $2p$.&$4m p +2n q \pm v$\\
$\mathop{\mathrm{arcdn}}$&$i\mathrm{K}^\prime$&$\mathrm{K}$&
  $0$, $2q$, $2(p+q)$, $2p$.&$2m q+4n p \pm v$\\
$\mathop{\mathrm{arcns}}$&$\mathrm{K}$&$i\mathrm{K}^\prime$&
$-(p+q)$, $-p+q$,&$2m p+2n q +(-1)^mv$\\
&&&$p+q$, $p-q$.&\\
$\mathop{\mathrm{arcnc}}$&$\mathrm{K}$&$\mathrm{K}+i\mathrm{K}^\prime$&
  $0$, $2q$, $2(p+q)$, $2p$.&$4m p +2n q \pm v$\\
$\mathop{\mathrm{arcnd}}$&$i\mathrm{K}^\prime$&$\mathrm{K}$&
 $0$, $2q$, $2(p+q)$, $2p$.&$2m q+4n p \pm v$\\
$\mathop{\mathrm{arccd}}$&$\mathrm{K}$&$i\mathrm{K}^\prime$&
 $0$, $2q$, $2(p+q)$, $2p$.&$4m p+2n q \pm v$\\
$\mathop{\mathrm{arcdc}}$&$\mathrm{K}$&$i\mathrm{K}^\prime$&
 $0$, $2q$, $2(p+q)$, $2p$.&$4m p+2n q \pm v$\\
$\mathop{\mathrm{arcsd}}$&$\mathrm{K}$&$\mathrm{K}+i\mathrm{K}^\prime$&
$-(p+q)$, $-p+q$,&$2m p +2n q +(-1)^mv$\\
&&&$p+q$, $p-q$.&\\
$\mathop{\mathrm{arcds}}$&$\mathrm{K}$&$\mathrm{K}+i\mathrm{K}^\prime$&
$-(p+q)$, $-p+q$,&$2m p +2n q +(-1)^mv$\\
&&&$p+q$, $p-q$.&\\
$\mathop{\mathrm{arcsc}}$&$i\mathrm{K}^\prime$&$\mathrm{K}$&
$-(p+q)$, $-p+q$,&$2m q +2n q +(-1)^nv$\\
&&&$p+q$, $p-q$.&\\
$\mathop{\mathrm{arccs}}$&$i\mathrm{K}^\prime$&$\mathrm{K}$&
...
Alternatively the symmetric integral $R_F$ may be evaluated
