...
\hypertarget{command:BYE}{\section{BYE Command}}\ttindex{BYE}
...
The command \texttt{DEFINE}\ttindex{DEFINE} allows a user to supply a new name for
...
prevent \texttt{DEFINE}\ttindex{DEFINE} from being used on them.  To define
