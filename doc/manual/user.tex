...
by the display software.  This package allows REDUCE to input and
output \emph{content} MathML.

Author: Luis Alvarez-Sobreviela\footnote{This package was written when
