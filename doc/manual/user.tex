...
\ttindexswitch{TRINT}{ALGINT} are also supported by this package.  In addition, the
switch \sw{TRA}, \ttindexswitch{TRA}{ALGINT} if on, will give further tracing
...
\ttindexswitch{TRCOMPACT}{COMPACT}
