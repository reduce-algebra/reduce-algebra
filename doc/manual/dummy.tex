...
\ttindex{DUMMY\_BASE}\ttindex{DUMMY\_NAME}
...
\f{SHOW\_DUMMY\_NAMES}:\ttindex{SHOW\_DUMMY\_NAMES}
\begin{verbatim}
...
through the command {\tt SYMTREE}.\ttindex{SYMTREE}
