...
\ttindextype{ODESOLVE}{operator}
\ttindextype{DSOLVE}{operator synonym}
...
\ttindextype{odesolve\_explicit}{switch}
\ttindextype{odesolve\_expand}{switch}
\ttindextype{odesolve\_full}{switch}
\ttindextype{odesolve\_implicit}{switch}
\ttindextype{odesolve\_noint}{switch}
\ttindextype{odesolve\_verbose}{switch}
\ttindextype{odesolve\_basis}{switch}
\ttindextype{trode}{switch}
\ttindextype{odesolve\_fast}{switch}
\ttindextype{odesolve\_check}{switch}
...
switch \texttt{expanddf} locally only.
