...
\ttindextype{+ (plus)}{operator!3-D vectors}
\ttindextype{- (minus)}{operator!3-D vectors}
\ttindextype{/ (quotient)}{operator!3-D vectors}
\ttindextype{* (times)}{operator!3-D vectors}
\ttindextype{"\textasciicircum (expt)}{operator!3-D vectors}
\ttindextype{><}{(cross product) operator!3-D vectors}
\begin{verbatim}  
+, -, /, *, ^, ><
\end{verbatim}
...
after $<$.
The differential operator DOTGRAD is defined in the \ttindextype{DOTGRAD}{operator}
