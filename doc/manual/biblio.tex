...
\bibitem{LIEPDE} T.\,Wolf, An efficiency improved program \texttt{LIEPDE}
...
\bibitem{WoBra} T.\,Wolf, A. Brand, The Computer Algebra Package \texttt{CRACK}
...
\bibitem{GB'98} V.P.Gerdt and Yu.A.Blinkov. \emph{Involutive Bases of Polynomial Ideals}. 
Mathematics and Computers in Simulation, 45, 519--542, 1998; \emph{Minimal Involutive Bases}, ibid. 543--560.
 
\bibitem{Seiler'10} W.M.Seiler. \emph{Involution: The Formal Theory of Differential Equations and its Applications 
in Computer Algebra}. Algorithms and Computation in Mathematics, 24, Springer, 2010.  arXiv:math.AC/0501111

\bibitem{Gerdt'05} Vladimir P. Gerdt. \emph{Involutive Algorithms for Computing Gr\"obner Bases}.
...
\bibitem{Olv2nd} \textsc{P. Olver}, Applications of Lie Groups to Partial
...
\bibitem{red} Obtaining \REDUCE: \url{https://reduce-algebra.sourceforge.io/}.
...
\bibitem{Adamchik:90} V.S. Adamchik and O.I. Marichev, \emph{The 
...
\bibitem{Luke} Yudell L. Luke, \emph{The Special Functions and their
...
\bibitem{matt-normform} Matt Rebbeck: NORMFORM: A {\REDUCE} package for the 
...
\bibitem{LE} L Euler L., \textit{Introductio in analysin infinitorum, Vol 1,
 Chapter 18}, 1748.
...
\bibitem{BronS} Bronstein, I.N. and Semedjajew, K.A.,
