...
\newcommand{\ttindex}[1]{{\renewcommand{\_}{\protect\underscore}%
                          ...
                          \index{#1@\texttt{#1}}}}
\def\ttindextypehelper#1#2\relax{\let\blubber=#1}
...
\newcommand{\ttindexswitch}[2]{{%
       ...
       \renewcommand{\|}{\protect\textbar}%
       \index{#1 switch@\texttt{#1} switch}%
       \index{Switch ! #1@\texttt{#1}}%
       \def\blubber{#2}%
       \ifx\blubber\empty
         \def\blubber{\index{Switches by package ! 000@REDUCE Core ! #1@\texttt{#1}}}%
       \else
         \def\blubber{\index{Switches by package ! #2 package ! #1@\texttt{#1}}}%
       \fi
       \blubber}}
