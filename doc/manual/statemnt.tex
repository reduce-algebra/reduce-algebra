...
\begin{verbatim}
        ...
        unset(mkid(a,j));
\end{verbatim}
clears the value of \texttt{A23}.  In fact, the command \texttt{unset}
is like \hyperlink{reserved:CLEAR}{\texttt{clear}}, except that it
accepts variables constructed using
\hyperlink{operator:MKID}{\texttt{mkid}}, which \texttt{clear} does
not.
