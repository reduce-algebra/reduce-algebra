...
The \ind{module ring} exports among others the following selectors:
\indf{ring\_names}{symbolic procedure}, \indf{ring\_degrees}{symbolic procedure},
\indf{ring\_tag}{symbolic procedure},
\indf{ring\_ecart}{symbolic procedure}, the symbolic mode test function \indf{ring\_isnoetherian}{symbolic procedure} and the
...
\item[]
  ...
  pairs of the form
\{\meta{component}, \meta{associated\ prime}\}.
...
\begin{tabular}{|p{1.2cm}||>{\raggedright}p{4.5cm}|>{\raggedright}p{1.9cm}|p{3.4cm}|}
\hline
