...
\index{Persons!Gr\"abe, Hans-Gert}

\newcommand{\ind}[1]{\emph{#1}\index{#1 (Cali package)@#1 (\textsc{Cali} package)}}
...
\item[]
  ...
  \end{syntax}
\ttindextype{clearcaliprintterms}{operator}
...
The procedure \indf{deleteunits!*}{symbolic procedure} tries explicitely to factor the
