...
\subsection{Abstract}
     ...
     The \package{FIDE}  package performs  automation of  the process of numerical
...
difference  schemes  and  generation  of  numerical  programs.  The \package{FIDE}
...
\end{description}
     Version  1.1  of  the  \package{FIDE}  package  is the result of porting \package{FIDE}
