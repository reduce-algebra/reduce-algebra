...
\ttindextype{QSUMRECURSION\_CERTIFICATE}{switch}
...
\ttindextype{QSUM\_TRACE}{switch}
\ttindextype{QGOSPER\_DOWN}{switch}
\ttindextype{QSUMRECURSION\_DOWN}{switch}
\ttindextype{QSUM\_NULLSPACE}{switch}
\ttindextype{QGOSPER\_SPECIALSOL}{switch}
\ttindextype{QSUMRECURSION\_EXP}{switch}
\ttindextype{QSUMRECURSION\_CERTIFICATE}{switch}
