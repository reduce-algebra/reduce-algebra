...
The four theta functions are defined by the Fourier series:
\begin{eqnarray*}
...
until $b > 0.5$ (i.e.~$|q| < 0.208$). This seems to produce reasonable
...
$\vartheta_4(u,\tau)$ & \f{elliptictheta4(u,tau)}\\[5pt]
\end{tabular}}
\newpage
