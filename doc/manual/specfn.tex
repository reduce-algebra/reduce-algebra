...
The Whittaker M \& W functions with non-numeric arguments are simplified to
expressions involving the Kummer M \& U functions respectively.
\end{itemize}
...
$$S_n^m = \frac{1}{m!}\sum_{k=0}^m )(-1)^{m-k}{m \choose k} k^n$$
