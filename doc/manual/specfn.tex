...
On a GUI that supports calligraphic characters (NB. this now the case with the
...
\begin{itemize}
\item  $\wp(u \parallel g_2, g_3)$ \ --- \ \f{weierstrass1(u,g2,g3)}
\item $\zeta_w(u \parallel g_2, g_3)$ \ --- \ \f{weierstrassZeta1(u,g2,g3)}.
\end{itemize}
...
this  alternative:
\[ \wp^\prime(u \parallel g_2,g_3)^2 = 4\,\wp(u \parallel g_2,g_3)^3
   - g_2\, \wp(u \parallel g_2,g_3) -g_3. \]
...
elliptic function $\wp$. The lattice roots also appears in the numerical
...
degeneratesto an elementary one. The advantage of the invariant
...
$\wp(u \parallel g_2, g_3)$ & \f{weierstrass1(u,g2,g3)}\\
$\zeta_w(u \parallel g_2, g_3)$ & \f{weierstrasszeta1(u,g2,g3)}\\[5pt]
\end{tabular}}
\newpage
