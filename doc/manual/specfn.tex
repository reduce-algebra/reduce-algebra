...
$\mathit{Si}(z)$ & \f{Si(z)}\\
$\mathit{si}(z)$ & \f{s\_i(z)}\\
$\mathit{Ci}(z)$ & \f{Ci(z)}\\
$\mathit{Shi}(z)$ & \f{Shi(z)}\\
$\mathit{Chi}(z)$ & \f{Chi(z)}\\
$\mathit{erf}(z)$ & \f{Erf(z)}\\
$\mathit{erfc}(z)$ & \f{erfc(z)}\\
$\mathit{Ei}(z)$ & \f{Ei(z)}\\
$\mathit{Ei}(\log(z))$ & \f{Li(z)}\\
$C(x)$ & \f{Fresnel\_C(x)}\\
...
\begin{tabular}{r l}
\rule{0pt}{16pt}Function & Operator\\[5pt]
$\mathit{Ai}(z)$ & \f{Airy\_Ai(z)}\\
$\mathit{Bi}(z)$ & \f{Airy\_Bi(z)}\\
$\mathit{Ai}'(z)$ & \f{Airy\_Aiprime(z)}\\
$\mathit{Bi}'(z)$ & \f{Airy\_Biprime(z)}\\
${\bf H}_{\nu}(z)$ & \f{StruveH(nu,z)}\\
${\bf L}_{\nu}(z)$ & \f{StruveL(nu,z)}\\
...
$\mathit{Li}_2(z)$ & \f{dilog(z)}\\
$\mathit{Li}_{n}(z)$ & \f{Polylog(n,z)}\\
...
\begin{tabular}{r l}
\rule{0pt}{16pt}Function & Operator\\[5pt]
$\mathit{sn}(u,k)$ & \f{jacobisn(u,k)}\\
$\mathit{dn}(u,k)$ & \f{jacobidn(u,k)}\\
$\mathit{cn}(u,k)$ & \f{jacobicn(u,k)}\\
$\mathit{cd}(u,k)$ & \f{jacobicd(u,k)}\\
$\mathit{sd}(u,k)$ & \f{jacobisd(u,k)}\\
$\mathit{nd}(u,k)$ & \f{jacobind(u,k)}\\
$\mathit{dc}(u,k)$ & \f{jacobidc(u,k)}\\
$\mathit{nc}(u,k)$ & \f{jacobinc(u,k)}\\
$\mathit{sc}(u,k)$ & \f{jacobisc(u,k)}\\
$\mathit{ns}(u,k)$ & \f{jacobins(u,k)}\\
$\mathit{ds}(u,k)$ & \f{jacobids(u,k)}\\
$\mathit{cs}(u,k)$ & \f{jacobics(u,k)}\\
$\mathit{am}(u,k)$ & \f{jacobiam(u,k)}\\
