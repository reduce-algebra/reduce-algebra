...
\texttt{fargs(\textit{fun}$_i$)} can be used.  If there are no
$\textit{con}_i$ then all equations are solved and the functions in
...
\hyperref[crack-m_7]{\emph{7}}, \hyperref[crack-m_24]{\emph{24}} and
\hyperref[crack-m_25]{\emph{25}}.  Here \hyperref[crack-m_7]{\emph{7}}
encodes an integration of short equations $0=\partial^n f/\partial
x^n$.  \hyperref[crack-m_7]{\emph{7}} has highest priority of the
three integrations.  \hyperref[crack-m_24]{\emph{24}} encodes the
integration of an equation that leads to the substitution of a
function and \hyperref[crack-m_25]{\emph{25}} refers to any
...
\item[\texttt{stop\_batch (38):}] If the first steps to simplify or
  ...
  automatically and afterwards \package{Crack} should switch into
...
If $z^2$ had been replaced in (\ref{crack-sep}) by a third function
