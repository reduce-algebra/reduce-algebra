...
\item A range for a variable: this has the form
  ...
  expressions which evaluate to numbers, and the parentheses are
  optional.  If no range is specified the
  ...
  \end{center}
  where \texttt{<it>} is a positive integer and the parentheses are required;
