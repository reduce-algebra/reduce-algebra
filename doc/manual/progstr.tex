...
\begin{enumerate}
\item Everything from the word \texttt{COMMENT}\ttindextype{COMMENT}{keyword} to the next
...
\index{\% (Precent sign)@\texttt{\%} (Percent sign)} to the end
...
\ttindextype{<}{operator}
\ttindextype{<=}{operator}
\ttindextype{>}{operator}\ttindextype{>=}{operator}
