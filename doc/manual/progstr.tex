...
\item[CATALAN] Catalan's constant, defined as
  ...
  \end{displaymath}
\ttindex{CATALAN}
\index{Reserved variable ! \texttt{CATALAN}}
...
\ttindex{EULER\_GAMMA}
\index{Reserved variable ! \texttt{EULER\_GAMMA}}

\item[GOLDEN\_RATIO] The number $\frac{1+\sqrt{5}}{2}$.
\ttindex{GOLDEN\_RATIO}
\index{Reserved variable ! \texttt{GOLDEN\_RATIO}}

\item[I] Intended to represent the square
\ttindex{I}
\index{Reserved variable ! \texttt{I}}
...
\ttindex{INFINITY}
\index{Reserved variable ! \texttt{INFINITY}}
...
\ttindex{POSITIVE}
\index{Reserved variable ! \texttt{POSITIVE}}

\item[T] Must not be used as a formal
\ttindex{T}
\index{Reserved variable ! \texttt{T}}
