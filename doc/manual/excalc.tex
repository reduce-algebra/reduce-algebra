...
The following examples should illustrate the use of \package{EXCALC}. It is not
...
The examples are on a test file distributed with \package{EXCALC}.
\index{EXCALC package!example}
{\small
\begin{verbatim}
% Problem:
...
% part and the torsion induced part of the connection.
