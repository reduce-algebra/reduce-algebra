...
The \texttt{gosper} operator\ttindextype{GOSPER}{operator} is an implementation of the Gosper algorithm.
\begin{itemize}
\item
...
\ttindextype{EXTENDED\_GOSPER}{operator}
...
\ttindextype{SUMRECURSION}{operator}
...
\ttindextype{EXTENDED\_SUMRECURSION}{operator}
...
\ttindextype{HYPERRECURSION}{operator}\ttindextype{HYPERTERM}{operator}
...
\ttindextype{SUMTOHYPER}{operator}
...
\ttindextype{SIMPLIFY\_GAMMA}{operator}
\ttindextype{simplify\_combinatorial}{operator}
\ttindextype{GAMMATOFACTORIAL}{rule}
\ttindextype{simplify\_gamma2}{operator}
\ttindextype{simplify\_gamman}{operator}
...
\ttindextype{ZB\_F}{internal operator}
\ttindextype{ZB\_SIGMA}{internal operator}
