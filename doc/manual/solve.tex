...
\index{SOLVE operator@\texttt  {SOLVE} operator!ROOT\_MULTIPLICITIES global variable@\texttt{ROOT\_MULTIPLICITIES} global variable}
...
\index{SOLVE operator@\texttt  {SOLVE} operator!REQUIREMENTS variable@\texttt{REQUIREMENTS} shared variable}
...
\index{SOLVE operator@\texttt  {SOLVE} operator!ASSUMPTIONS variable@\texttt{ASSUMPTIONS} variable}
