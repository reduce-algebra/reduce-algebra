...
variable using the domain mechanism of REDUCE.\footnote{This code was written by Alan Barnes and Julian Padget.} This means that power
...
\ttindextype{+ (plus)}{operator!power series}
\ttindextype{- (minus)}{operator!power series}
\ttindextype{/ (quotient)}{operator!power series}
\ttindextype{* (times)}{operator!power series}
\ttindextype{** (expt)}{operator!power series}
\begin{verbatim}
    a*b;
    a/b;
    a**2+b**2;
