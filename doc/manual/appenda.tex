...
\item[Commands] \hyperref[reserved:ALGEBRAIC]{\tt ALGEBRAIC}
\hyperref[reserved:ANTISYMMETRIC]{\tt ANTISYMMETRIC}
\hyperref[reserved:ARRAY]{\tt ARRAY}
\hyperref[reserved:BYE]{\tt BYE}
\hyperref[reserved:CLEAR]{\tt CLEAR} \linebreak
...
SETMOD} {\tt SHARE} {\tt SHOWTIME} {\tt SHUT} {\tt SPUR} \hyperref[reserved:SYMBOLIC]{\tt SYMBOLIC}
\hyperref[reserved:SYMMETRIC]{\tt SYMMETRIC} {\tt VECDIM} {\tt VECTOR} {\tt WEIGHT} {\tt WRITE} {\tt
WTLEVEL}
...
\hyperref[reserved:assignop]{\texttt{:=}} \verb|=| \verb|>=| \verb|>| \verb|<=| \verb|<| \verb|=>|
...
\item[Reserved Variables] {\tt CARD\_NO} {\tt E}
\hyperref[reserved:EVAL_MODE]{\tt EVAL\_MODE}
