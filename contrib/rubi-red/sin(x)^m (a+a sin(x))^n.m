...
{Sin[x]^4/(a + a*Sin[x]), x, 5, -((3*x)/(2*a)) - (4*Cos[x])/a + (4*Cos[x]^3)/(3*a) + (3*Cos[x]*Sin[x])/(2*a) + (Cos[x]*Sin[x]^3)/(a + a*Sin[x])}
{Sin[x]^3/(a + a*Sin[x]), x, 4, (3*x)/(2*a) + (2*Cos[x])/a - (3*Cos[x]*Sin[x])/(2*a) + (Cos[x]*Sin[x]^2)/(a + a*Sin[x])}
{Sin[x]^2/(a + a*Sin[x]), x, 3, -(x/a) - Cos[x]/a - Cos[x]/(a + a*Sin[x])}
{Sin[x]^1/(a + a*Sin[x]), x, 2, x/a + Cos[x]/(a + a*Sin[x])}
{Csc[x]^1/(a + a*Sin[x]), x, 2, -(ArcTanh[Cos[x]]/a) + Cos[x]/(a + a*Sin[x])}
...
{Csc[x]^4/(a + a*Sin[x]), x, 6, (3*ArcTanh[Cos[x]])/(2*a) - (4*Cot[x])/a - (4*Cot[x]^3)/(3*a) + (3*Cot[x]*Csc[x])/(2*a) + (Cot[x]*Csc[x]^2)/(a + a*Sin[x])}
