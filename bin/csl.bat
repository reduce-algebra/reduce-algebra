...
if exist %h%..\cslbuild\x86_64-win64-windows\csl\%n%.com       goto :x64
if exist %h%..\cslbuild\i686-pc-windows\csl\%n%.com         goto :x86
if exist %h%..\cslbuild\x86_64-win64-windows-debug\csl\%n%.com goto :x64d
...
:x64
%h%..\cslbuild\x86_64-win64-windows\csl\%n%.com %*
goto :done
...
:x64d
%h%..\cslbuild\x86_64-win64-windows-debug\csl\%n%.com %*
goto :done
