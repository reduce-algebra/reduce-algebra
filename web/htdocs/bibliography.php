...
<nav class="nav nav-tabs" id="TabbedHeader" role="tablist">
</nav>
...
<script>
 ...
 $("#TabbedContent > dl")
     ...
     .each(function(){
         ...
         $('<a class="nav-item nav-link" id="' + alpha + '-tab" \
          data-toggle="tab" href="#' + alpha + '" role="tab" \
          aria-controls="' + alpha + '" aria-selected="false">' + alpha + '</a>')
