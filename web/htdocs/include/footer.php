<footer class="<?= isset($footer_class) ? $footer_class : 'col-xl-3' ?>">
    <div class="sticky-top">
        ...
        <div style="display: flex; flex-wrap: wrap-reverse; justify-content: space-around;">
            <!-- Begin SF Tag -->
            <div class="sf-root" data-id="248416" data-badge="oss-open-source-excellence-white" data-metadata="achievement=oss-open-source-excellence" style="width:125px">
            ...
            <script>
                (function() {
                    ...
                    sc.async = true;
                    sc.src = 'https://b.sf-syn.com/badge_js?sf_id=248416';
