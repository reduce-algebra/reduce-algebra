...
<p>REDUCE includes considerable documentation, not only for the core system, but also for the many application packages included in the release. (The <a href="/documentation38.php">documentation for REDUCE 3.8</a>, the last commercial version of REDUCE released in 2004, is also still available.)</p>
<p>For all users:</p>
<ul>
  <li>the <strong>REDUCE User's Manual</strong> <small>[ <a href="manual.html">HTML</a> | <a href="manual.pdf">PDF</a> ]</small> provides a comprehensive guide to the REDUCE language and the supported packages;</li>
  <li>the <a href="/switches.php">switch summary</a> provides an overview of the switches that control REDUCE.</li>
</ul>
...
<p id="contributed">The following documents for the user-contributed packages are dynamically generated links into the HTML version of the REDUCE User&#39;s Manual.</p>
END_OF_MAIN_CONTENT
);
