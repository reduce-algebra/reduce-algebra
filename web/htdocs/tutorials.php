...
You can also download individual lesson files this way.
  ...
  <p>Dieter Egger is the author of <a href="https://play.google.com/store/apps/details?id=de.dieteregger.symbolic">Symbolic</a>, a REDUCE app for Android available from Google Play, and some of the scripts available here are those used as demonstrations for Symbolic as shown in the screenshots on Google Play.  Other scripts relate to Dieter&apos;s research in curved space-time.  A brief description of all his scripts, with links to them, is available in either <a href="tutorials/EggerScripts.php">German</a> (his original version) or <a href="tutorials/EggerScripts.en.php">English</a>, although the scripts themselves are all in English.  The whole collection of scripts is also available as a <a href="tutorials/EggerReduceScripts.zip">zip archive</a>.</p>
  <p>The following papers describe the scientific background to some of the scripts:</p>
  <ul>
    <li><a href="tutorials/Metrik.pdf">&Uuml;ber eine spezielle Metrik &ndash; Alternative Kosmologie</a>.  This paper (in German) ends with several REDUCE scripts.</li>
    <li><a href="tutorials/MetricUniverse.pdf">About a Special Metric &ndash; Dark Matter and Dark Energy transmogrified</a>.  This paper (in English) is a longer version of the above paper that references some of the scripts available via the links above.  (The link given at the end of the paper no longer works.)</li>
  </ul>
