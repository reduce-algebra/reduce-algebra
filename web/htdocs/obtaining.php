...
$smarty->assign('page_title', 'Obtain and Run REDUCE');
...
$smarty->assign('header_title', 'How to Obtain and Run REDUCE');
...
<p>
  ...
  download, install and run REDUCE on the most widely-used platforms.
  (Alternative user interfaces such
  as <a href="https://fjwright.github.io/Run-REDUCE/">Run-REDUCE</a>
  or
...
<h3>Using the Files tab</h3>
  <p>
    ...
    source code bundle in the form of
    a <a href="https://en.wikipedia.org/wiki/Tar_(computing)">compressed
    tar file</a>.
  </p>
  <p>
    The distribution for GNU/Linux includes <a>compressed tar
    files</a> as well
    as <a href="https://en.wikipedia.org/wiki/Deb_(file_format)">.deb</a>
    and <a href="https://en.wikipedia.org/wiki/Rpm_(software)">.rpm</a>
    files.  If you don&apos;t find a GNU/Linux distribution here that
    you can use then please check
    the <a href="independent.php">independent distributions</a>.  But
...
<h2 id="windetails">Details of installing and running REDUCE on Windows</h2>
  ...
  <p>
    ...
    permanently via the <em>Advanced</em> tab of the <em>System
    Properties</em> dialogue, which you can find in <em>Control
    Panel</em> or by searching.  In Windows 10, typing
    <em>env</em> with the <em>Start</em> menu open should suffice!
    Click on the
    <em>Environment Variables&hellip;</em> button at the bottom of the
  ...
  <p>
    Now opening a Command Prompt window and
    ...
    with a CLI).  Both CLIs provide input history, and the CSL REDUCE
    CLI provides coloured prompts and input.  The
    commands <code>rfpsl</code> and <code>rfcsl</code> run the
    Redfront versions of, respectively, PSL and CSL REDUCE, which both
    provide the same consistent CLI with input history and blue
    algebraic-mode output.
  </p>
  <p>
    ...
    that under Cygwin the CSL REDUCE GUI uses
    the <a href="https://en.wikipedia.org/wiki/X_Window_System">X
    Window System</a>, so you need to have an
