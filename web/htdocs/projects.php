...
<h2>REDUCE for mobile devices</h2>
  <p>
    Please note that the apps listed below are <strong>not
      supported</strong> by
      ...
      by the REDUCE developers.  These apps may not use the latest
      version of REDUCE and you use them entirely at you own risk!
  </p>
  <ul>
    <li>
      <a href="https://apps.apple.com/us/app/icas/id394637176">iCAS</a>
      is a commercial version of REDUCE packaged for the Apple iPhone
      and iPad.
    </li>
    <li>
    ...
    <li>
      ...
      REDUCE</a> is a GUI version of REDUCE packaged for Android that
      provides only non-programmable calculator-style input with
      limited functionality, which is available for free
      (but <strong>not</strong> from Google Play).  It is essentially
      the original Android version of REDUCE.
    </li>
  </ul>
  <p>
  ...
  <ul>
    ...
    <li>
      ...
      programming language, which has bindings for REDUCE, providing a
      very interesting environment for doing computer-powered
      science.
    </li>
  </ul>
  ...
  <ul>
    ...
    <li>
      ...
      the <a href="http://math.drhuang.com/science/mathematics/software/">Math
