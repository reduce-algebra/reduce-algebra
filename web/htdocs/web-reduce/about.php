...
<p>
    Click the button below to open the Web REDUCE main page
...
<p>
    There are two versions of Web REDUCE: desktop and mobile.
...
<p class="text-center">
    <a id="desktop" class="btn btn-primary btn-lg mb-2" href="/web-reduce">Start desktop Web REDUCE</a>
    <a id="mobile" class="btn btn-primary btn-lg mb-2" href="/web-reduce/?mobile">Start mobile Web REDUCE</a>
</p>
<p>
    Alternatively, by clicking on one of the following links you can explicitly start either
    <a href="/web-reduce">desktop</a> or <a href="/web-reduce/?mobile">mobile</a> Web REDUCE.
</p>
<?php endif; ?>
