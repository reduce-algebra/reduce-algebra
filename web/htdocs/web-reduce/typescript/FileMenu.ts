...
const echoFileInputCheckbox = document.getElementById(
  "EchoFileInputCheckbox"
) as HTMLInputElement;
echoFileInputCheckbox.checked = true;
const fileMenuLink = document.getElementById("FileMenuLink");
echoFileInputCheckbox.addEventListener("change", () =>
  hideMenuLink(fileMenuLink)
);
const outputFileMenuItem = document.getElementById(
  "OutputFileMenuItem"
) as HTMLButtonElement;
const outputHereMenuItem = document.getElementById(
  "OutputHereMenuItem"
) as HTMLButtonElement;
outputHereMenuItem.disabled = true;
const outputOpenMenuItem = document.getElementById(
  "OutputOpenMenuItem"
) as HTMLButtonElement;
outputOpenMenuItem.disabled = true;
const shutFileMenuItem = document.getElementById(
  "ShutFileMenuItem"
) as HTMLButtonElement;
...
document
  .getElementById("InputFileMenuItem")
...
outputFileMenuItem.addEventListener("click", async () => {
  try {
    if (supported) {
      ...
      let filename = prompt(
        "Save output file to downloads location as:",
