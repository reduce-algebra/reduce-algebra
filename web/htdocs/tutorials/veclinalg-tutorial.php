<?php
$header_title = 'Tutorial: Vectors and Linear Algebra';
...
% (d) false (unless n=1)
det(lam*A) = lam*det(A);
if det(lam*A) = lam*det(A) then true else false;</pre>
    </div>
...
rank S;
% S is not a spanning set because it contains only 3 linearly independent vectors.</pre>
    </div>
...
solve(ws, {a2,a1,a0});
% (c) Yes, since precisely one p1 maps to each p2.</pre>
    </div>
...
hp2 := sub(arbcomplex(3)=0, arbcomplex(4)=1, hp);</pre>
    </div>
