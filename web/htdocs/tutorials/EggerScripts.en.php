...
$smarty->assign('header_title', 'Scripts by Dieter Egger');
...
<p>
  Here are some examples of REDUCE scripts.  You can either
  click the links below to read the scripts in a web browser or
  you can download them for later input into REDUCE.  Since the
  scripts often use the same variable, it is advisable to
  restart REDUCE before processing a new script.
</p>
<p>
  Solving equations:
...
<p>
  ...
  <br /> 
  Metric-tensor from the equation of the hypersurface of a hypersphere,
  2-dim:
  ...
  <br /> 
  Riemann, Ricci, Einstein tensors and solution of the field equations, 2-dim:
...
<p>
  Energy of a photon
  (requires <a href="EggerReduceScripts/constants.red">constants.red</a>
