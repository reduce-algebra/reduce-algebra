  ...
  <body>
    <div class="container-fluid">
      ...
      <header class="navbar navbar-expand-md navbar-light">
        ...
        <!-- The following button is hidden on the search page! -->
        <a class="d-none d-md-block" href="/search.php">
          <button id="top-search-button" title="Search the REDUCE web site">
