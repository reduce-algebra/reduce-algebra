...
<footer class="{$class}">
  <div class="sticky-top">
    ...
    <p>
      Page last modified on {page_mod_date}.
    </p>
    <p>
      All information available through this web site is Copyright
      &copy; Anthony C. Hearn and
      the <a href="https://sourceforge.net/p/reduce-algebra/_members/">REDUCE
      developers</a> 2009&ndash;{$smarty.now|date_format:"%Y"}.  All
      Rights Reserved.
    </p>
    <p>
