...
/* end of prologue */
    ...
    env = stack[-2];
    if (v100 == nil) goto v50;
    v150 = stack[0];
    v100 = (Lisp_Object)17; /* 1 */
    popv(3);
    return cons(v150, v100);
...
v50:
    ...
    v100 = stack[-1];
    {
        ...
        return (*qfnn(fn))(qenv(fn), 3, v134, v150, v100);
    }
...
setup_type const u10_setup[] =
{
    ...
    {NULL, (one_args *)"u10", (two_args *)"4249 4741666 4622845", 0}
};
