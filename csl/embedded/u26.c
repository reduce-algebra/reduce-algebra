...
/* $destdir/generated-c\u26.c Machine generated C code */
...
/* end of prologue */
    ...
    env = stack[-13];
    if (!(v69 == nil)) goto v73;
    v69 = elt(env, 1); /* "no matrix in add" */
    fn = elt(env, 7); /* rederr */
    v69 = (*qfn1(fn))(qenv(fn), v69);
    nil = C_nil;
    if (exception_pending()) goto v72;
...
v74:
    ...
    if (exception_pending()) goto v72;
    env = stack[-13];
    if (equal(stack[0], v69)) goto v75;
    v69 = elt(env, 2); /* "wrong dimensions in add" */
    fn = elt(env, 7); /* rederr */
    v69 = (*qfn1(fn))(qenv(fn), v69);
    nil = C_nil;
    if (exception_pending()) goto v72;
...
v99:
    ...
    stack[-1] = v35;
    v35 = stack[-2];
    if (v35 == nil) { Lisp_Object res = stack[-1]; popv(4); return onevalue(res); }
    v35 = stack[0];
    v35 = Levenp(nil, v35);
    env = stack[-3];
    if (!(v35 == nil)) { Lisp_Object res = stack[-1]; popv(4); return onevalue(res); }
...
v97:
    ...
    v35 = stack[0];
    {
        popv(4);
        fn = elt(env, 6); /* exptf */
        return (*qfn2(fn))(qenv(fn), v32, v35);
    }
/* error exit handlers */
v98:
    popv(4);
...
/* end of prologue */
    ...
    if (exception_pending()) goto v96;
    env = stack[-1];
    v74 = elt(env, 3); /* "<OMS cd=""linalg1"" name=""matrix""/>" */
    fn = elt(env, 6); /* printout */
    v74 = (*qfn1(fn))(qenv(fn), v74);
    nil = C_nil;
    if (exception_pending()) goto v96;
...
static Lisp_Object MS_CDECL CC_rewrite(Lisp_Object env, int nargs,
                         Lisp_Object v0, Lisp_Object v1,
                         Lisp_Object v101, Lisp_Object v21, ...)
{
    Lisp_Object nil = C_nil;
...
v144:
    ...
    env = stack[-14];
    v138 = Lminusp(nil, v138);
    env = stack[-14];
    if (v138 == nil) goto v77;
    v138 = stack[-11];
    v139 = add1(v138);
    nil = C_nil;
    if (exception_pending()) goto v145;
    ...
    v138 = qcdr(v138);
    v138 = qcar(v138);
    if (!(equal(v139, v138))) { Lisp_Object res = stack[-12]; popv(15); return onevalue(res); }
    stack[0] = stack[-12];
    v138 = stack[-11];
    v138 = add1(v138);
    nil = C_nil;
    ...
    v138 = (*qfnn(fn))(qenv(fn), 4, v141, v140, v139, v138);
    nil = C_nil;
    if (exception_pending()) goto v145;
...
v148:
    ...
    if (exception_pending()) goto v145;
    env = stack[-14];
    if (equal(stack[-3], v138)) goto v149;
    v138 = stack[-7];
    v138 = qcar(v138);
    v139 = v138;
    v138 = v139;
...
v149:
    ...
    v138 = qvalue(elt(env, 1)); /* nil */
    fn = elt(env, 2); /* letmtr3 */
    v138 = (*qfnn(fn))(qenv(fn), 4, stack[-4], v140, v139, v138);
    nil = C_nil;
    if (exception_pending()) goto v145;
    env = stack[-14];
    v138 = stack[-2];
...
/* end of prologue */
    v74 = v96;
    if (!consp(v74)) goto v100;
    v74 = v96;
    v74 = qcar(v74);
    v74 = Lmemq(nil, v74, v95);
    return onevalue(v74);
...
/* end of prologue */
    v92 = v76;
    v94 = elt(env, 1); /* list */
    if (!consp(v92)) goto v155;
    v92 = qcar(v92);
    if (!(v92 == v94)) goto v155;
    v94 = v76;
    v94 = qcdr(v94);
...
v95:
    v94 = elt(env, 3); /* "list" */
    {
        popv(1);
        fn = elt(env, 5); /* typerr */
        return (*qfn2(fn))(qenv(fn), v92, v94);
    }
...
/* end of prologue */
    ...
    v156 = elt(env, 2); /* revalx */
    qvalue(elt(env, 1)) = v156; /* !*!*a2sfn */
    v156 = v96;
    fn = elt(env, 3); /* formc */
    v156 = (*qfnn(fn))(qenv(fn), 3, v156, v95, v74);
    nil = C_nil;
...
/* copy arguments values to proper place */
    stack[0] = v0;
/* end of prologue */
    v152 = qvalue(elt(env, 1)); /* subfg!* */
    if (v152 == nil) { Lisp_Object res = stack[0]; popv(1); return onevalue(res); }
    v152 = stack[0];
    fn = elt(env, 2); /* subs2f */
    ...
    if (!(v157 == v152)) { Lisp_Object res = stack[0]; popv(1); return onevalue(res); }
    v152 = v158;
    v152 = qcar(v152);
    stack[0] = v152;
...
/* end of prologue */
    ...
    v189 = stack[-8];
    v189 = qcdr(v189);
    if (v189 == nil) goto v119;
    v189 = (Lisp_Object)1; /* 0 */
    stack[-7] = v189;
    goto v91;

v91:
    v189 = qvalue(elt(env, 1)); /* current!-modulus */
    v190 = sub1(v189);
    nil = C_nil;
...
v13:
    ...
    v189 = stack[-8];
    v189 = qcdr(v189);
    v189 = CC_msolveKpolyn(env, v190, v189);
    nil = C_nil;
    if (exception_pending()) goto v192;
    env = stack[-11];
    stack[-3] = v189;
...
v197:
    ...
    v189 = Lminusp(nil, v189);
    env = stack[-11];
    if (!(v189 == nil)) { Lisp_Object res = stack[-6]; popv(12); return onevalue(res); }
    stack[-4] = stack[-5];
    stack[0] = stack[-9];
    v190 = stack[-10];
    v189 = stack[-7];
...
/* end of prologue */
    ...
    v200 = qcar(v199);
    v199 = stack[0];
    if (v200 == v199) goto v119;
    v199 = stack[-1];
    v199 = qcar(v199);
    v200 = qcdr(v199);
    v199 = stack[0];
    stack[-2] = CC_degreef(env, v200, v199);
    nil = C_nil;
    ...
    env = stack[-3];
    {
        ...
        popv(4);
        fn = elt(env, 1); /* max */
        return (*qfn2(fn))(qenv(fn), v201, v199);
    }
...
v203:
    ...
    env = stack[-1];
    if (!(v202 == nil)) { popv(2); return onevalue(v202); }
    v202 = stack[0];
    v202 = qcar(v202);
    v202 = qcdr(v202);
    v202 = CC_noncomexpf(env, v202);
    nil = C_nil;
    if (exception_pending()) goto v204;
    env = stack[-1];
    if (!(v202 == nil)) { popv(2); return onevalue(v202); }
...
/* end of prologue */
    ...
    v96 = elt(env, 2); /* algebraic */
    fn = elt(env, 5); /* formbool */
    v96 = (*qfnn(fn))(qenv(fn), 3, v152, v161, v96);
    nil = C_nil;
    if (exception_pending()) goto v157;
    env = stack[0];
    fn = elt(env, 6); /* eval */
...
/* end of prologue */
    ...
    if (v206 == nil) goto v158;
    v154 = stack[-1];
    v206 = stack[0];
    popv(2);
    return list2(v154, v206);
...
v137:
    v207 = (Lisp_Object)113; /* 7 */
    v99 = stack[0];
    v99 = difference2(v207, v99);
    nil = C_nil;
    if (exception_pending()) goto v93;
    env = stack[-2];
    v99 = Lminusp(nil, v99);
    ...
    v207 = stack[0];
    v99 = (Lisp_Object)1; /* 0 */
    *(Lisp_Object *)((char *)v68 + (CELL-TAG_VECTOR) + ((int32_t)v207/(16/CELL))) = v99;
    v99 = stack[0];
    v99 = add1(v99);
    nil = C_nil;
    if (exception_pending()) goto v93;
...
/* copy arguments values to proper place */
    stack[0] = v0;
/* end of prologue */
    v143 = elt(env, 1); /* "<vector>" */
    fn = elt(env, 4); /* printout */
    v143 = (*qfn1(fn))(qenv(fn), v143);
    nil = C_nil;
    if (exception_pending()) goto v202;
    env = stack[-1];
    v142 = qvalue(elt(env, 2)); /* indent */
    v143 = (Lisp_Object)49; /* 3 */
    v143 = plus2(v142, v143);
    nil = C_nil;
    if (exception_pending()) goto v202;
    env = stack[-1];
    qvalue(elt(env, 2)) = v143; /* indent */
    v143 = stack[0];
    v143 = qcar(v143);
    ...
    v142 = qvalue(elt(env, 2)); /* indent */
    v143 = (Lisp_Object)49; /* 3 */
    v143 = difference2(v142, v143);
    nil = C_nil;
    if (exception_pending()) goto v202;
    env = stack[-1];
    qvalue(elt(env, 2)) = v143; /* indent */
    v143 = elt(env, 3); /* "</vector>" */
    fn = elt(env, 4); /* printout */
    v143 = (*qfn1(fn))(qenv(fn), v143);
    nil = C_nil;
    if (exception_pending()) goto v202;
...
{
    Lisp_Object nil = C_nil;
    Lisp_Object v41, v218, v174, v175;
    Lisp_Object fn;
    CSL_IGNORE(nil);
#ifdef DEBUG
...
v201:
    ...
    v218 = stack[-3];
    v41 = (Lisp_Object)1; /* 0 */
    if (v218 == v41) goto v63;
    v174 = stack[-4];
    v218 = stack[-3];
    v41 = stack[-2];
    v41 = acons(v174, v218, v41);
    nil = C_nil;
    if (exception_pending()) goto v172;
    env = stack[-8];
    stack[-2] = v41;
...
v32:
    ...
    if (exception_pending()) goto v172;
    env = stack[-8];
    if (equal(stack[0], v41)) goto v220;
    v218 = stack[-7];
    v41 = stack[-5];
    v175 = list2(v218, v41);
    nil = C_nil;
    ...
    v41 = (*qfnn(fn))(qenv(fn), 4, v175, v174, v218, v41);
    nil = C_nil;
    if (exception_pending()) goto v172;
    env = stack[-8];
    goto v220;
...
v219:
    ...
    v218 = elt(env, 4); /* sparse */
    v41 = stack[-7];
    v41 = list2(v218, v41);
    nil = C_nil;
    if (exception_pending()) goto v172;
    env = stack[-8];
    v41 = Lputprop(nil, 3, stack[-1], stack[0], v41);
    nil = C_nil;
    if (exception_pending()) goto v172;
    env = stack[-8];
    v41 = stack[-6];
    v174 = qcar(v41);
    v218 = elt(env, 5); /* rtype */
    v41 = elt(env, 4); /* sparse */
    v41 = Lputprop(nil, 3, v174, v218, v41);
    nil = C_nil;
    if (exception_pending()) goto v172;
    v41 = nil;
...
v95:
    ...
    v188 = qcdr(v188);
    {
        ...
        return (*qfn2(fn))(qenv(fn), v93, v188);
    }
/* error exit handlers */
v106:
    popv(3);
...
v100:
    v222 = stack[-1];
    v222 = (is_number(v222) ? lisp_true : nil);
    if (!(v222 == nil)) goto v133;
    v222 = stack[-1];
...
v130:
    v222 = qvalue(elt(env, 1)); /* !*grmod!* */
    if (v222 == nil) goto v91;
    v222 = stack[0];
    v222 = Lmodular_reciprocal(nil, v222);
    nil = C_nil;
    if (exception_pending()) goto v178;
    env = stack[-3];
    v222 = times2(stack[-1], v222);
    nil = C_nil;
    if (exception_pending()) goto v178;
    env = stack[-3];
    {
...
v63:
    ...
    v222 = stack[-2];
    fn = elt(env, 8); /* quotfx */
    stack[-1] = (*qfn2(fn))(qenv(fn), v223, v222);
    nil = C_nil;
    if (exception_pending()) goto v178;
    env = stack[-3];
    v223 = stack[0];
    ...
    if (exception_pending()) goto v178;
    {
        ...
        popv(4);
        return cons(v179, v222);
    }

v183:
    v223 = stack[-1];
    v222 = (Lisp_Object)17; /* 1 */
    if (v223 == v222) goto v76;
    v223 = stack[-1];
    v222 = stack[0];
    popv(4);
...
v133:
    {
        ...
        return (*qfn2(fn))(qenv(fn), v157, v95);
    }
...
/* end of prologue */
    ...
    v156 = (*qfn2(fn))(qenv(fn), v156, v151);
    nil = C_nil;
    if (exception_pending()) goto v95;
    v151 = stack[0];
    popv(1);
    return list2(v156, v151);
/* error exit handlers */
v95:
    popv(1);
    return nil;
...
v203:
    v48 = qvalue(elt(env, 1)); /* sqrtflag */
    if (v48 == nil) { Lisp_Object res = stack[-1]; popv(4); return onevalue(res); }
    v48 = stack[-1];
    if (!consp(v48)) { Lisp_Object res = stack[-1]; popv(4); return onevalue(res); }
    v48 = stack[-1];
    v48 = qcar(v48);
    v48 = qcar(v48);
    v48 = qcar(v48);
    ...
    v46 = qcar(v48);
    v48 = elt(env, 2); /* sqrt */
    if (!(v46 == v48)) goto v135;
    v48 = stack[-1];
    v48 = qcar(v48);
    v48 = qcar(v48);
    v46 = qcdr(v48);
    v48 = (Lisp_Object)17; /* 1 */
    v48 = (Lisp_Object)greaterp2(v46, v48);
    nil = C_nil;
    if (exception_pending()) goto v175;
    v48 = v48 ? lisp_true : nil;
    env = stack[-3];
    if (v48 == nil) goto v135;
    v48 = stack[-1];
    v48 = qcdr(v48);
    stack[0] = CC_squashsqrt(env, v48);
    nil = C_nil;
    if (exception_pending()) goto v175;
    env = stack[-3];
    v48 = stack[-1];
    ...
    v48 = (*qfnn(fn))(qenv(fn), 3, v47, v46, v48);
    nil = C_nil;
    if (exception_pending()) goto v175;
    env = stack[-3];
    {
        ...
        popv(4);
        fn = elt(env, 5); /* addf */
        return (*qfn2(fn))(qenv(fn), v232, v48);
    }
...
v135:
    ...
    env = stack[-3];
    {
        ...
        popv(4);
        fn = elt(env, 5); /* addf */
        return (*qfn2(fn))(qenv(fn), v234, v48);
    }
...
v233:
    ...
    v48 = qcar(v48);
    v48 = qcdr(v48);
    v48 = CC_squashsqrt(env, v48);
    nil = C_nil;
    if (exception_pending()) goto v175;
    env = stack[-3];
    v46 = v48;
    v48 = v46;
    if (v48 == nil) goto v150;
    v48 = stack[-1];
    v48 = qcar(v48);
    stack[-2] = qcar(v48);
    stack[0] = v46;
    ...
    if (exception_pending()) goto v175;
    {
        Lisp_Object v235 = stack[-2];
        Lisp_Object v236 = stack[0];
        popv(4);
        return acons(v235, v236, v48);
    }
...
{
    Lisp_Object nil = C_nil;
    Lisp_Object v205, v204, v206, v154;
    CSL_IGNORE(nil);
#ifdef DEBUG
...
v203:
    v205 = v204;
    if (v205 == nil) goto v116;
    v205 = v206;
    v154 = qcar(v205);
    v205 = v204;
    v205 = qcar(v205);
    v205 = qcar(v205);
    v205 = (equal(v154, v205) ? lisp_true : nil);
    if (!(v205 == nil)) return onevalue(v205);
    v205 = v204;
    v205 = qcdr(v205);
    v204 = v205;
    goto v203;
...
/* end of prologue */
    v154 = stack[-1];
    if (v154 == nil) goto v116;
    v154 = stack[-1];
    v153 = qcar(v154);
    v154 = stack[0];
    fn = elt(env, 1); /* nth */
    stack[-2] = (*qfn2(fn))(qenv(fn), v153, v154);
    nil = C_nil;
    ...
    v153 = qcdr(v154);
    v154 = stack[0];
    v154 = CC_ithlistelem(env, v153, v154);
    nil = C_nil;
    if (exception_pending()) goto v207;
    {
        Lisp_Object v68 = stack[-2];
        popv(4);
        return cons(v68, v154);
    }
...
/* end of prologue */
    v95 = v96;
    v74 = elt(env, 1); /* !:rd!: */
    if (!consp(v95)) goto v36;
    v95 = qcar(v95);
    if (!(v95 == v74)) goto v36;
    v74 = v96;
    v74 = qcdr(v74);
        return Lconsp(nil, v74);
...
{
    Lisp_Object nil = C_nil;
    Lisp_Object v237, v221, v66, v65, v199;
    CSL_IGNORE(nil);
#ifdef DEBUG
...
v100:
    v237 = v65;
    if (!(v237 == nil)) goto v212;
    v237 = v66;
    if (!(v237 == nil)) goto v212;
    v237 = qvalue(elt(env, 1)); /* t */
    return onevalue(v237);

v212:
    v237 = v65;
    if (v237 == nil) goto v107;
    v237 = v66;
    if (v237 == nil) goto v156;
    v199 = (Lisp_Object)1; /* 0 */
    v237 = v65;
    v221 = qcar(v237);
    v237 = v66;
    v237 = qcar(v237);
    v237 = (Lisp_Object)(int32_t)((int32_t)v221 - (int32_t)v237 + TAG_FIXNUM);
    if (v199 == v237) goto v143;
...
/* end of prologue */
    ...
    stack[0] = v211;
    v209 = stack[-1];
    v211 = elt(env, 1); /* minus */
    if (!consp(v209)) goto v204;
    v209 = qcar(v209);
    if (!(v209 == v211)) goto v204;
    v211 = stack[-1];
    v211 = qcdr(v211);
    v211 = qcar(v211);
    stack[-1] = v211;
...
v204:
    v209 = stack[0];
    v211 = elt(env, 1); /* minus */
    if (!consp(v209)) goto v142;
    v209 = qcar(v209);
    if (!(v209 == v211)) goto v142;
    v211 = stack[0];
    v211 = qcdr(v211);
    v211 = qcar(v211);
    stack[0] = v211;
...
v142:
    v211 = stack[-1];
    if (!(!consp(v211))) goto v194;
    v211 = stack[-1];
    v211 = Lfloat(nil, v211);
    nil = C_nil;
    if (exception_pending()) goto v229;
    env = stack[-3];
...
v240:
    v209 = stack[-2];
    v211 = (Lisp_Object)1; /* 0 */
    if (v209 == v211) goto v64;
    v209 = stack[-2];
    v211 = (Lisp_Object)49; /* 3 */
    if (v209 == v211) goto v185;
    v209 = stack[-2];
    v211 = (Lisp_Object)33; /* 2 */
    if (v209 == v211) goto v59;
    v209 = stack[0];
    v211 = stack[-1];
    {
        popv(4);
        fn = elt(env, 4); /* rd!:difference */
        return (*qfn2(fn))(qenv(fn), v209, v211);
    }
...
v185:
    ...
    v211 = (*qfn2(fn))(qenv(fn), v209, v211);
    nil = C_nil;
    if (exception_pending()) goto v229;
    {
        Lisp_Object v233 = stack[-2];
        popv(4);
        return list2(v233, v211);
    }
...
/* end of prologue */
    ...
    v241 = (Lisp_Object)lessp2(v45, v241);
    nil = C_nil;
    if (exception_pending()) goto v88;
    v241 = v241 ? lisp_true : nil;
    env = stack[-3];
    if (v241 == nil) goto v137;
    v241 = elt(env, 0); /* divide!-by!-power!-of!-ten */
    {
        popv(4);
...
v155:
    v45 = stack[0];
    v241 = (Lisp_Object)1; /* 0 */
    v241 = (Lisp_Object)greaterp2(v45, v241);
    nil = C_nil;
    if (exception_pending()) goto v88;
    v241 = v241 ? lisp_true : nil;
    env = stack[-3];
    if (v241 == nil) { Lisp_Object res = stack[-1]; popv(4); return onevalue(res); }
    v241 = stack[0];
    v241 = Levenp(nil, v241);
    env = stack[-3];
    if (!(v241 == nil)) goto v199;
    v50 = stack[-1];
    v45 = stack[-2];
    v241 = qvalue(elt(env, 3)); /* !:bprec!: */
    fn = elt(env, 5); /* divide!: */
    v241 = (*qfnn(fn))(qenv(fn), 3, v50, v45, v241);
    nil = C_nil;
    if (exception_pending()) goto v88;
    env = stack[-3];
...
v199:
    ...
    v241 = stack[-2];
    fn = elt(env, 7); /* times!: */
    v45 = (*qfn2(fn))(qenv(fn), v45, v241);
    nil = C_nil;
    if (exception_pending()) goto v88;
    env = stack[-3];
    v241 = qvalue(elt(env, 3)); /* !:bprec!: */
    fn = elt(env, 8); /* cut!:mt */
    v241 = (*qfn2(fn))(qenv(fn), v45, v241);
    nil = C_nil;
    if (exception_pending()) goto v88;
    env = stack[-3];
    fn = elt(env, 6); /* csl_normbf */
...
/* end of prologue */
    stack[-1] = v135;
    v186 = qvalue(elt(env, 1)); /* indxl!* */
    v135 = qvalue(elt(env, 2)); /* nosuml!* */
    fn = elt(env, 5); /* union */
    v135 = (*qfn2(fn))(qenv(fn), v186, v135);
    nil = C_nil;
...
v116:
    v135 = stack[-1];
    if (v135 == nil) goto v151;
    v135 = stack[-1];
    v135 = qcar(v135);
    if (!consp(v135)) goto v206;
    v135 = stack[-1];
    v135 = qcar(v135);
    v135 = qcdr(v135);
    v135 = qcar(v135);
    if (is_number(v135)) goto v194;
    v135 = stack[-1];
    v135 = qcar(v135);
    v135 = qcdr(v135);
    v135 = qcar(v135);
...
v142:
    v135 = stack[0];
    v135 = Lmemq(nil, v186, v135);
    if (v135 == nil) goto v152;
    v135 = stack[-1];
    v135 = qcdr(v135);
    stack[-1] = v135;
    goto v116;
...
/* end of prologue */
    v221 = stack[-1];
    if (v221 == nil) goto v100;
    v221 = stack[-1];
    v66 = qcar(v221);
    v221 = stack[0];
    fn = elt(env, 1); /* calc_world */
    v221 = (*qfn2(fn))(qenv(fn), v66, v221);
    nil = C_nil;
    ...
    if (v66 == v221) goto v152;
    stack[-2] = v65;
    v221 = stack[-1];
    v66 = qcdr(v221);
    v221 = stack[0];
    v221 = CC_calc_coeff(env, v66, v221);
    nil = C_nil;
    if (exception_pending()) goto v13;
    {
        Lisp_Object v35 = stack[-2];
        popv(4);
        return cons(v35, v221);
    }
...
v188:
    v90 = stack[-5];
    v87 = (Lisp_Object)1; /* 0 */
    v87 = (Lisp_Object)lesseq2(v90, v87);
    nil = C_nil;
    if (exception_pending()) goto v262;
...
v68:
    ...
    v87 = qcar(v87);
    fn = elt(env, 3); /* ordop */
    v87 = (*qfn2(fn))(qenv(fn), v90, v87);
    nil = C_nil;
    if (exception_pending()) goto v262;
    env = stack[-9];
    if (v87 == nil) goto v263;
    v90 = stack[-5];
    v87 = stack[-8];
    v87 = plus2(v90, v87);
    nil = C_nil;
    ...
    v90 = stack[-6];
    v87 = stack[-5];
    v87 = CC_xremf(env, 3, v261, v90, v87);
    nil = C_nil;
    if (exception_pending()) goto v262;
    env = stack[-9];
    stack[-3] = v87;
    ...
    env = stack[-9];
    fn = elt(env, 5); /* addf */
    v87 = (*qfn2(fn))(qenv(fn), stack[-1], v87);
    nil = C_nil;
    if (exception_pending()) goto v262;
    env = stack[-9];
    stack[-1] = v87;
...
v132:
    ...
    v87 = qcar(v87);
    v87 = qcdr(v87);
    v90 = difference2(v90, v87);
    nil = C_nil;
    if (exception_pending()) goto v262;
    env = stack[-9];
    stack[-4] = v90;
    v87 = (Lisp_Object)1; /* 0 */
    v87 = (Lisp_Object)lessp2(v90, v87);
    nil = C_nil;
    if (exception_pending()) goto v262;
    v87 = v87 ? lisp_true : nil;
    env = stack[-9];
...
v58:
    ...
    v87 = stack[-3];
    v87 = qcar(v87);
    if (v87 == nil) goto v235;
    stack[0] = stack[-7];
    v90 = stack[-4];
    v87 = (Lisp_Object)1; /* 0 */
    if (v90 == v87) goto v170;
    v87 = stack[-7];
    v87 = qcar(v87);
    v87 = qcar(v87);
    v90 = qcar(v87);
...
v264:
    ...
    env = stack[-9];
    fn = elt(env, 4); /* multf */
    v87 = (*qfn2(fn))(qenv(fn), stack[-4], v87);
    nil = C_nil;
    if (exception_pending()) goto v262;
    env = stack[-9];
    fn = elt(env, 5); /* addf */
...
/* end of prologue */
    ...
    env = stack[-1];
    {
        ...
        popv(2);
        fn = elt(env, 2); /* apply */
        return (*qfn2(fn))(qenv(fn), v130, v113);
    }
/* error exit handlers */
v119:
    popv(2);
...
{
    Lisp_Object nil = C_nil;
    Lisp_Object v106, v183, v75, v196, v194;
    Lisp_Object fn;
    CSL_IGNORE(nil);
...
v116:
    v106 = v75;
    if (v106 == nil) goto v212;
    v183 = v194;
    v106 = v75;
    v106 = qcar(v106);
    if (v183 == v106) goto v142;
    v106 = v196;
    v106 = qcdr(v106);
    v196 = v106;
    v106 = v75;
...
v212:
    v106 = elt(env, 1); /* "Valuecoefft - no value" */
    {
        fn = elt(env, 3); /* interr */
...
/* copy arguments values to proper place */
    stack[0] = v0;
/* end of prologue */
    v187 = qvalue(elt(env, 1)); /* !*mcd */
    if (!(v187 == nil)) goto v152;
    v187 = stack[0];
    v63 = qcdr(v187);
    v187 = (Lisp_Object)17; /* 1 */
    if (v63 == v187) goto v152;
    v187 = stack[0];
    v63 = qcar(v187);
    v187 = (Lisp_Object)17; /* 1 */
    stack[-1] = cons(v63, v187);
    nil = C_nil;
    ...
    env = stack[-2];
    fn = elt(env, 2); /* mk!*sq */
    v63 = (*qfn1(fn))(qenv(fn), v187);
    nil = C_nil;
    if (exception_pending()) goto v241;
    env = stack[-2];
    v187 = (Lisp_Object)-15; /* -1 */
    v187 = list2(v63, v187);
    nil = C_nil;
    if (exception_pending()) goto v241;
    env = stack[-2];
    ...
    env = stack[-2];
    {
        ...
        popv(3);
        fn = elt(env, 4); /* multsq */
        return (*qfn2(fn))(qenv(fn), v45, v187);
    }
...
v152:
    ...
    env = stack[-2];
    {
        ...
        popv(3);
        fn = elt(env, 4); /* multsq */
        return (*qfn2(fn))(qenv(fn), v50, v187);
    }
/* error exit handlers */
v241:
    popv(3);
...
v202:
    ...
    env = stack[-5];
    fn = elt(env, 3); /* addf */
    v131 = (*qfn2(fn))(qenv(fn), stack[-1], v131);
    nil = C_nil;
    if (exception_pending()) goto v61;
    env = stack[-5];
    stack[-2] = v131;
    ...
    v132 = qvalue(elt(env, 1)); /* nil */
    {
        ...
        popv(6);
        return list2star(v62, v131, v132);
    }
/* error exit handlers */
v61:
    popv(6);
...
/* end of prologue */
    ...
    v207 = elt(env, 2); /* (c i) */
    if (equal(v68, v207)) goto v157;
    v207 = qvalue(elt(env, 1)); /* char */
    v68 = Lcompress(nil, v207);
    nil = C_nil;
    if (exception_pending()) goto v188;
    env = stack[-1];
    v207 = (Lisp_Object)321; /* 20 */
    fn = elt(env, 4); /* errorml */
    v207 = (*qfn2(fn))(qenv(fn), v68, v207);
    nil = C_nil;
    if (exception_pending()) goto v188;
    env = stack[-1];
    goto v116;
...
/* end of prologue */
    ...
    v156 = stack[0];
    fn = elt(env, 1); /* dm!-gt */
    v156 = (*qfn2(fn))(qenv(fn), v74, v156);
    nil = C_nil;
    if (exception_pending()) goto v161;
    if (v156 == nil) { Lisp_Object res = stack[-1]; popv(2); return onevalue(res); }
...
v116:
    ...
    v94 = (*qfn2(fn))(qenv(fn), v92, v94);
    nil = C_nil;
    if (exception_pending()) goto v196;
    env = stack[-4];
    if (v94 == nil) goto v151;
    v94 = qvalue(elt(env, 2)); /* mcount!* */
    v94 = add1(v94);
    nil = C_nil;
    if (exception_pending()) goto v196;
    env = stack[-4];
    qvalue(elt(env, 2)) = v94; /* mcount!* */
    v92 = stack[0];
    v94 = stack[-1];
...
/* end of prologue */
    v88 = stack[0];
    v79 = (Lisp_Object)1; /* 0 */
    v79 = (Lisp_Object)lessp2(v88, v79);
    nil = C_nil;
    if (exception_pending()) goto v265;
    v79 = v79 ? lisp_true : nil;
    env = stack[-3];
    if (v79 == nil) goto v137;
    v79 = elt(env, 0); /* multiply!-by!-power!-of!-ten */
    {
        popv(4);
        fn = elt(env, 4); /* bflerrmsg */
...
v155:
    v88 = stack[0];
    v79 = (Lisp_Object)1; /* 0 */
    v79 = (Lisp_Object)greaterp2(v88, v79);
    nil = C_nil;
    if (exception_pending()) goto v265;
    v79 = v79 ? lisp_true : nil;
    env = stack[-3];
    ...
    v79 = Levenp(nil, v79);
    env = stack[-3];
    if (!(v79 == nil)) goto v221;
    v88 = stack[-1];
    v79 = stack[-2];
    fn = elt(env, 5); /* times!: */
    v79 = (*qfn2(fn))(qenv(fn), v88, v79);
    nil = C_nil;
    if (exception_pending()) goto v265;
    env = stack[-3];
    fn = elt(env, 6); /* csl_normbf */
...
v221:
    ...
    v79 = stack[-2];
    fn = elt(env, 5); /* times!: */
    v88 = (*qfn2(fn))(qenv(fn), v88, v79);
    nil = C_nil;
    if (exception_pending()) goto v265;
    env = stack[-3];
    v79 = qvalue(elt(env, 3)); /* !:bprec!: */
    fn = elt(env, 7); /* cut!:mt */
    v79 = (*qfn2(fn))(qenv(fn), v88, v79);
    nil = C_nil;
    if (exception_pending()) goto v265;
...
/* end of prologue */
    ...
    v74 = qvalue(elt(env, 1)); /* nil */
    fn = elt(env, 3); /* apply */
    v95 = (*qfn2(fn))(qenv(fn), v95, v74);
    nil = C_nil;
    if (exception_pending()) goto v96;
    env = stack[0];
    v74 = v95;
    v95 = integerp(v95);
    if (!(v95 == nil)) { popv(1); return onevalue(v74); }
    v74 = elt(env, 2); /* "randpoly expons function must return an integer" 
*/
    {
        popv(1);
        fn = elt(env, 4); /* rederr */
...
/* end of prologue */
    ...
    {
        fn = elt(env, 2); /* sf2mv1 */
        return (*qfnn(fn))(qenv(fn), 3, v97, v107, v130);
    }
}
...
/* copy arguments values to proper place */
    stack[0] = v0;
/* end of prologue */
    v64 = qvalue(elt(env, 1)); /* simpcount!* */
    v193 = add1(v64);
    nil = C_nil;
    if (exception_pending()) goto v50;
    env = stack[-1];
    qvalue(elt(env, 1)) = v193; /* simpcount!* */
    v64 = qvalue(elt(env, 2)); /* simplimit!* */
    v64 = (Lisp_Object)greaterp2(v193, v64);
    nil = C_nil;
    if (exception_pending()) goto v50;
    v64 = v64 ? lisp_true : nil;
    env = stack[-1];
    if (v64 == nil) goto v116;
    v64 = (Lisp_Object)1; /* 0 */
    qvalue(elt(env, 1)) = v64; /* simpcount!* */
    v241 = elt(env, 3); /* rlisp */
    v193 = (Lisp_Object)321; /* 20 */
    v64 = elt(env, 4); /* "Simplification recursion too deep" */
    fn = elt(env, 7); /* rerror */
    v64 = (*qfnn(fn))(qenv(fn), 3, v241, v193, v64);
    nil = C_nil;
    if (exception_pending()) goto v50;
    env = stack[-1];
    goto v116;
...
v116:
    v64 = stack[0];
    if (!(symbolp(v64))) goto v205;
    v193 = stack[0];
    v64 = elt(env, 5); /* share */
    v64 = Lflagp(nil, v193, v64);
    env = stack[-1];
    if (v64 == nil) goto v66;
    v64 = stack[0];
    fn = elt(env, 8); /* eval */
...
/* end of prologue */
    ...
    env = stack[-4];
    v126 = stack[0];
    v228 = elt(env, 3); /* vectorml */
    if (!(v126 == v228)) goto v142;
    v228 = elt(env, 4); /* vector */
    stack[0] = v228;
    goto v142;

v142:
    v126 = stack[0];
    v228 = qvalue(elt(env, 5)); /* valid_om!* */
    v228 = Lassoc(nil, v126, v228);
    v228 = qcdr(v228);
    v228 = qcar(v228);
    stack[-3] = v228;
    v228 = stack[-2];
    ...
    v228 = qcdr(v228);
    v228 = qcar(v228);
    v126 = Lintern(nil, v228);
    nil = C_nil;
    if (exception_pending()) goto v55;
    env = stack[-4];
    v228 = elt(env, 7); /* multiset */
    if (!(v126 == v228)) goto v147;
    v228 = elt(env, 8); /* multiset1 */
    stack[-3] = v228;
    goto v147;
...
v147:
    ...
    v126 = qcar(v228);
    v228 = elt(env, 3); /* vectorml */
    if (!(v126 == v228)) goto v266;
    v228 = elt(env, 10); /* "vector" */
    stack[0] = v228;
    goto v266;
...
v266:
    ...
    v126 = qcar(v228);
    v228 = elt(env, 3); /* vectorml */
    if (!(v126 == v228)) goto v79;
    v126 = elt(env, 4); /* vector */
    v228 = stack[-2];
    v228 = qcdr(v228);
    v228 = cons(v126, v228);
    nil = C_nil;
...
v75:
    ...
    env = stack[-10];
    if (!(v209 == nil)) { Lisp_Object res = stack[0]; popv(11); return onevalue(res); }
    v210 = stack[-8];
    v209 = stack[-6];
    v210 = difference2(v210, v209);
    nil = C_nil;
    ...
    env = stack[-10];
    v209 = stack[-4];
    v209 = (Lisp_Object)geq2(v210, v209);
    nil = C_nil;
    if (exception_pending()) goto v51;
    v209 = v209 ? lisp_true : nil;
    env = stack[-10];
    if (v209 == nil) goto v13;
    stack[-2] = stack[0];
    stack[0] = stack[-9];
    v210 = stack[-3];
    v209 = stack[-6];
    v209 = plus2(v210, v209);
    nil = C_nil;
    if (exception_pending()) goto v51;
    env = stack[-10];
    fn = elt(env, 4); /* ps!:evaluate */
    stack[-1] = (*qfn2(fn))(qenv(fn), stack[0], v209);
    nil = C_nil;
    if (exception_pending()) goto v51;
    env = stack[-10];
    stack[0] = stack[-7];
    ...
    env = stack[-10];
    fn = elt(env, 6); /* addsq */
    v209 = (*qfn2(fn))(qenv(fn), stack[-2], v209);
    nil = C_nil;
    if (exception_pending()) goto v51;
    env = stack[-10];
    stack[0] = v209;
...
/* end of prologue */
    ...
    v154 = qcar(v154);
    if (!consp(v154)) goto v157;
    v154 = elt(env, 2); /* " Invalid coefficient " */
    v206 = list2(v154, v206);
    nil = C_nil;
...
v116:
    v205 = stack[0];
    if (v205 == nil) goto v212;
    v206 = stack[-1];
    v205 = stack[0];
    v205 = qcar(v205);
    if (equal(v206, v205)) { popv(3); return onevalue(v204); }
    v205 = stack[0];
    v205 = qcdr(v205);
    stack[0] = v205;
    v205 = v204;
...
v212:
    v205 = elt(env, 1); /* "index not found" */
    {
        popv(3);
        fn = elt(env, 2); /* rederr */
...
/* copy arguments values to proper place */
    ...
    stack[0] = v0;
/* end of prologue */
    v114 = qvalue(elt(env, 2)); /* !*!*roundbf */
    if (!(v114 == nil)) goto v94;
    v114 = stack[0];
    v114 = qcdr(v114);
    if (!(!consp(v114))) goto v94;
    v114 = stack[-2];
    v114 = qcdr(v114);
    if (!(!consp(v114))) goto v94;
    v114 = stack[0];
...
v94:
    ...
    env = stack[-4];
    stack[-3] = v114;
    v114 = qvalue(elt(env, 4)); /* yy!! */
    stack[-2] = v114;
    v114 = stack[-3];
    if (!consp(v114)) goto v186;
    v115 = stack[-3];
    v114 = stack[-2];
    fn = elt(env, 8); /* difbf */
    v114 = (*qfn2(fn))(qenv(fn), v115, v114);
...
v235:
    ...
    v114 = (*qfnn(fn))(qenv(fn), 3, stack[0], stack[-1], v114);
    nil = C_nil;
    if (exception_pending()) goto v275;
    env = stack[-4];
    {
        popv(5);
        fn = elt(env, 11); /* mkround */
...
v186:
    ...
    v114 = stack[-3];
    stack[0] = Lmkquote(nil, v114);
    nil = C_nil;
    if (exception_pending()) goto v275;
    env = stack[-4];
    v114 = stack[-2];
    v114 = Lmkquote(nil, v114);
    nil = C_nil;
    if (exception_pending()) goto v275;
    env = stack[-4];
    v115 = list3(stack[-1], stack[0], v114);
    nil = C_nil;
    if (exception_pending()) goto v275;
    env = stack[-4];
    ...
    if (exception_pending()) goto v275;
    env = stack[-4];
    if (v114 == nil) goto v259;
    fn = elt(env, 14); /* rndbfon */
    v114 = (*qfnn(fn))(qenv(fn), 0);
    nil = C_nil;
    if (exception_pending()) goto v275;
    env = stack[-4];
    v114 = stack[-3];
    v114 = Lfloatp(nil, v114);
    env = stack[-4];
    if (v114 == nil) goto v223;
    v114 = stack[-3];
    fn = elt(env, 15); /* fl2bf */
    v114 = (*qfn1(fn))(qenv(fn), v114);
    nil = C_nil;
...
v123:
    v114 = stack[-2];
    if (!consp(v114)) goto v52;
    v114 = stack[-2];
    goto v227;

v227:
    fn = elt(env, 16); /* csl_normbf */
    v114 = (*qfn1(fn))(qenv(fn), v114);
    nil = C_nil;
    if (exception_pending()) goto v275;
    env = stack[-4];
...
v133:
    v276 = stack[-1];
    if (v276 == nil) goto v130;
    v276 = stack[0];
    if (v276 == nil) goto v204;
    v77 = stack[-2];
    v276 = stack[-1];
    v276 = qcar(v276);
    fn = elt(env, 1); /* split!-road */
    v77 = (*qfn2(fn))(qenv(fn), v77, v276);
    nil = C_nil;
...
v204:
    ...
    env = stack[-4];
    {
        ...
        return (*qfn2(fn))(qenv(fn), v135, v276);
    }
...
v130:
    ...
    env = stack[-4];
    {
        ...
        popv(5);
        fn = elt(env, 3); /* nreverse */
        return (*qfn2(fn))(qenv(fn), v186, v276);
    }
/* error exit handlers */
v134:
    popv(5);
...
{
    Lisp_Object nil = C_nil;
    Lisp_Object v240, v277, v134, v135, v186, v147, v187, v63;
    CSL_IGNORE(nil);
...
v107:
    v240 = v187;
    v277 = (Lisp_Object)((int32_t)(v240) - 0x10);
    v240 = v63;
    v240 = (Lisp_Object)(int32_t)((int32_t)v277 - (int32_t)v240 + TAG_FIXNUM);
    v240 = ((intptr_t)(v240) < 0 ? lisp_true : nil);
    if (v240 == nil) goto v158;
    v134 = v147;
    v277 = v187;
    v240 = (Lisp_Object)17; /* 1 */
    *(Lisp_Object *)((char *)v134 + (CELL-TAG_VECTOR) + ((int32_t)v277/(16/CELL))) = v240;
    v240 = v147;
    v277 = v187;
    return cons(v240, v277);
...
v158:
    ...
    v277 = v186;
    v240 = v63;
    v277 = *(Lisp_Object *)((char *)v277 + (CELL-TAG_VECTOR) + ((int32_t)v240/(16/CELL)));
    v240 = v187;
    v240 = *(Lisp_Object *)((char *)v277 + (CELL-TAG_VECTOR) + ((int32_t)v240/(16/CELL)));
    *(Lisp_Object *)((char *)v135 + (CELL-TAG_VECTOR) + ((int32_t)v134/(16/CELL))) = v240;
    v240 = v63;
...
setup_type const u26_setup[] =
{
    ...
    {NULL, (one_args *)"u26", (two_args *)"7741 6927611 4462766", 0}
};
