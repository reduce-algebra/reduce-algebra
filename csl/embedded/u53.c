...
/* $destdir/generated-c\u53.c Machine generated C code */
...
/* end of prologue */
    stack[-11] = nil;
    v1215 = stack[-10];
    if (v1215 == nil) goto v1217;
    v1215 = stack[-10];
    v1215 = qcdr(v1215);
    if (v1215 == nil) { Lisp_Object res = stack[-10]; popv(13); return onevalue(res); }
    v1215 = stack[-10];
    v1215 = qcar(v1215);
    v1215 = qcar(v1215);
    stack[0] = v1215;
...
v1218:
    v1215 = stack[0];
    v1216 = Llength(nil, v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = (Lisp_Object)17; /* 1 */
    if (v1216 == v1215) goto v1069;
    v1216 = stack[-11];
    v1215 = stack[-10];
    popv(13);
    return cons(v1216, v1215);
...
v1069:
    ...
    v1215 = (*qfn1(fn))(qenv(fn), v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    if (v1215 == nil) goto v1219;
    stack[-1] = stack[-11];
    v1215 = stack[-10];
    stack[0] = qcdr(v1215);
    v1215 = stack[-9];
    ...
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = *(Lisp_Object *)((char *)stack[0] + (CELL-TAG_VECTOR) + ((int32_t)v1215/(16/CELL)));
    v1215 = qcar(v1215);
    v1215 = qcar(v1215);
    v1215 = ncons(v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = Lappend(nil, stack[-1], v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    stack[-11] = v1215;
    ...
    v1215 = qcar(v1215);
    v1215 = qcdr(v1215);
    if (v1215 == nil) goto v1220;
    v1216 = stack[-10];
    v1215 = stack[-10];
    v1215 = qcar(v1215);
    v1215 = qcdr(v1215);
    v1215 = Lrplaca(nil, v1216, v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = stack[-10];
    ...
    stack[-8] = v1215;
    v1215 = stack[-8];
    if (v1215 == nil) goto v1115;
    v1215 = stack[-8];
    v1215 = qcar(v1215);
    stack[-4] = v1215;
    v1215 = stack[-4];
    if (v1215 == nil) goto v1221;
    v1215 = stack[-4];
    v1215 = qcar(v1215);
    stack[0] = v1215;
    v1216 = stack[0];
    v1215 = stack[-9];
    v1215 = (Lisp_Object)greaterp2(v1216, v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    v1215 = v1215 ? lisp_true : nil;
    env = stack[-12];
    if (v1215 == nil) goto v1222;
    v1215 = stack[0];
    v1215 = sub1(v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
...
v1227:
    ...
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = Lrplacd(nil, stack[-1], v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = stack[-2];
...
v1229:
    ...
    stack[-8] = v1215;
    v1215 = stack[-8];
    if (v1215 == nil) goto v1039;
    stack[-5] = stack[-6];
    v1215 = stack[-8];
    v1215 = qcar(v1215);
    stack[-4] = v1215;
    v1215 = stack[-4];
    if (v1215 == nil) goto v1230;
    v1215 = stack[-4];
    v1215 = qcar(v1215);
    stack[0] = v1215;
    v1216 = stack[0];
...
v1235:
    ...
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = Lrplacd(nil, stack[-5], v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = stack[-6];
...
v1237:
    v1215 = stack[-4];
    fn = elt(env, 3); /* upbve */
    v1216 = (*qfn1(fn))(qenv(fn), v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = stack[-3];
    v1215 = difference2(v1216, v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = Lminusp(nil, v1215);
    env = stack[-12];
    if (v1215 == nil) goto v1238;
    v1216 = stack[-10];
    v1215 = stack[-5];
    v1215 = Lrplaca(nil, v1216, v1215);
    nil = C_nil;
...
v1238:
    v1216 = stack[-3];
    v1215 = stack[-9];
    v1215 = (Lisp_Object)geq2(v1216, v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    v1215 = v1215 ? lisp_true : nil;
    env = stack[-12];
    if (v1215 == nil) goto v1000;
    stack[-2] = stack[-4];
    v1215 = stack[-3];
    stack[-1] = sub1(v1215);
    nil = C_nil;
    ...
    env = stack[-12];
    v1215 = *(Lisp_Object *)((char *)stack[0] + (CELL-TAG_VECTOR) + ((int32_t)v1215/(16/CELL)));
    *(Lisp_Object *)((char *)stack[-2] + (CELL-TAG_VECTOR) + ((int32_t)stack[-1]/(16/CELL))) = v1215;
    goto v1239;
...
v1219:
    ...
    v1215 = (*qfn2(fn))(qenv(fn), v1216, v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = qcdr(v1215);
    v1215 = CC_pst_reduce(env, v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    stack[-1] = v1215;
    v1215 = stack[-1];
    v1215 = qcar(v1215);
    if (v1215 == nil) goto v1109;
    v1216 = stack[-11];
    v1215 = stack[-1];
    v1215 = qcar(v1215);
    v1215 = Lappend(nil, v1216, v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    stack[-11] = v1215;
    ...
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1215 = Lrplaca(nil, stack[0], v1215);
    nil = C_nil;
    if (exception_pending()) goto v880;
    env = stack[-12];
    v1216 = stack[-2];
...
v1240:
    ...
    stack[-8] = v1215;
    v1215 = stack[-8];
    if (v1215 == nil) goto v1241;
    v1215 = stack[-8];
    v1215 = qcar(v1215);
    stack[-4] = v1215;
    v1215 = stack[-4];
    if (v1215 == nil) goto v1242;
    v1215 = stack[-4];
    v1215 = qcar(v1215);
    stack[0] = v1215;
    v1216 = stack[0];
...
v954:
    ...
    stack[-8] = v1215;
    v1215 = stack[-8];
    if (v1215 == nil) goto v1248;
    stack[-5] = stack[-6];
    v1215 = stack[-8];
    v1215 = qcar(v1215);
    stack[-4] = v1215;
    v1215 = stack[-4];
    if (v1215 == nil) goto v1249;
    v1215 = stack[-4];
    v1215 = qcar(v1215);
    stack[0] = v1215;
    v1216 = stack[0];
...
/* end of prologue */
    ...
    v1258 = ncons(v1258);
    nil = C_nil;
    if (exception_pending()) goto v1259;
    env = stack[-1];
    {
        Lisp_Object v1260 = stack[0];
        popv(2);
        fn = elt(env, 2); /* apply */
        return (*qfn2(fn))(qenv(fn), v1260, v1258);
    }
/* error exit handlers */
v1259:
    popv(2);
...
static Lisp_Object CC_checku1(Lisp_Object env,
                         Lisp_Object v964, Lisp_Object v75)
{
    Lisp_Object nil = C_nil;
    Lisp_Object v1264, v1265;
    Lisp_Object fn;
    CSL_IGNORE(nil);
#ifdef DEBUG
...
/* end of prologue */
    ...
    qvalue(elt(env, 1)) = v1264; /* rhs!* */
    goto v261;

v261:
    v1264 = qvalue(elt(env, 1)); /* rhs!* */
    if (v1264 == nil) goto v1259;
    v1265 = stack[0];
    v1264 = qvalue(elt(env, 1)); /* rhs!* */
    v1264 = qcar(v1264);
    v1264 = qcar(v1264);
    fn = elt(env, 4); /* negind */
    v1264 = (*qfn2(fn))(qenv(fn), v1265, v1264);
    nil = C_nil;
    if (exception_pending()) goto v1266;
    env = stack[-2];
    if (v1264 == nil) goto v1267;
    v1264 = qvalue(elt(env, 1)); /* rhs!* */
    v1264 = qcar(v1264);
    v1264 = qcdr(v1264);
    v1265 = qcar(v1264);
    ...
    env = stack[-2];
    if (v1264 == nil) goto v1267;
    v1264 = qvalue(elt(env, 3)); /* t */
    goto v132;

v132:
    qvalue(elt(env, 1)) = stack[-1]; /* rhs!* */
    { popv(3); return onevalue(v1264); }
...
/* end of prologue */
    v1277 = v1279;
    if (!consp(v1277)) goto v411;
    v1277 = v1279;
    v1278 = qcar(v1277);
    v1277 = elt(env, 2); /* list */
    if (v1278 == v1277) goto v45;
    v1277 = v1279;
    v1278 = qcar(v1277);
    v1277 = elt(env, 3); /* replaceby */
    if (v1278 == v1277) { popv(5); return onevalue(v1279); }
    v1277 = v1279;
    v1278 = qcar(v1277);
    v1277 = elt(env, 4); /* equal */
    if (v1278 == v1277) goto v1200;
    v1277 = qvalue(elt(env, 1)); /* nil */
    { popv(5); return onevalue(v1277); }
...
v1200:
    ...
    v1278 = qcdr(v1278);
    popv(5);
    return cons(v1277, v1278);

v45:
    v1277 = v1279;
    v1277 = qcdr(v1277);
    if (v1277 == nil) goto v1280;
    v1277 = v1279;
    v1277 = qcdr(v1277);
    stack[-3] = v1277;
    v1277 = stack[-3];
    if (v1277 == nil) goto v1218;
    v1277 = stack[-3];
    v1277 = qcar(v1277);
    v1277 = CC_validrule1(env, v1277);
    nil = C_nil;
    if (exception_pending()) goto v1117;
    env = stack[-4];
    v1277 = ncons(v1277);
    nil = C_nil;
    if (exception_pending()) goto v1117;
...
v1281:
    ...
    stack[-3] = v1277;
    v1277 = stack[-3];
    if (v1277 == nil) { Lisp_Object res = stack[-2]; popv(5); return onevalue(res); }
    stack[0] = stack[-1];
    v1277 = stack[-3];
    v1277 = qcar(v1277);
    v1277 = CC_validrule1(env, v1277);
    ...
    if (exception_pending()) goto v1117;
    env = stack[-4];
    v1277 = Lrplacd(nil, stack[0], v1277);
    nil = C_nil;
    if (exception_pending()) goto v1117;
    env = stack[-4];
    v1277 = stack[-1];
...
static Lisp_Object CC_gtraversopairsdiscard1(Lisp_Object env,
                         Lisp_Object v1118, Lisp_Object v964)
{
    Lisp_Object nil = C_nil;
    Lisp_Object v1270, v1046;
    Lisp_Object fn;
    CSL_IGNORE(nil);
#ifdef DEBUG
...
v1290:
    v1270 = stack[-1];
    if (v1270 == nil) { Lisp_Object res = stack[-3]; popv(7); return onevalue(res); }
    v1270 = stack[-1];
    v1270 = qcar(v1270);
    stack[0] = v1270;
    v1270 = stack[0];
    ...
    v1270 = qcar(v1270);
    fn = elt(env, 2); /* vevlcm */
    v1046 = (*qfn2(fn))(qenv(fn), v1046, v1270);
    nil = C_nil;
    if (exception_pending()) goto v1269;
    env = stack[-6];
    v1270 = stack[-2];
    fn = elt(env, 3); /* vevstrictlydivides!? */
    v1270 = (*qfn2(fn))(qenv(fn), v1046, v1270);
    nil = C_nil;
    if (exception_pending()) goto v1269;
    env = stack[-6];
    if (v1270 == nil) goto v1070;
    v1270 = stack[-5];
    v1270 = qcdr(v1270);
    v1046 = qcar(v1270);
    v1270 = stack[-4];
...
setup_type const u53_setup[] =
{
    ...
    {NULL, (one_args *)"u53", (two_args *)"21535 6453521 5097625", 0}
};
