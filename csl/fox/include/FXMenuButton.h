...
public:
  ...
  /// Constructor
  FXMenuButton(FXComposite* p,const FXString& text,FXIcon* ic=NULL,FXPopup* pup=NULL,
      FXuint opts=(FXuint)JUSTIFY_NORMAL|(FXuint)ICON_BEFORE_TEXT|(FXuint)MENUBUTTON_DOWN,
