// See FXMathText.cpp for an explanation of the status of this file.
// basically it starts off as just a copy of FXText.h but it is being
// edited to support maths display within the text window.

// Note that because this is not in the main source of FOX the FOX additional
// rights do not apply - this code is ONLY available under LGPL 2.1 and
// not any addendum.
...
#if 0
// The following are here for clarity, but the REAL definitions are
// in FXText.h, and since these are global rather than class-scope
// names there is no need to redefine them here.
