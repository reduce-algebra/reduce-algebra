...
enum {
  ...
  TAB_TOP_NORMAL   = (FXuint)JUSTIFY_NORMAL|(FXuint)ICON_BEFORE_TEXT|(FXuint)TAB_TOP|(FXuint)FRAME_RAISED|(FXuint)FRAME_THICK,
  TAB_BOTTOM_NORMAL= (FXuint)JUSTIFY_NORMAL|(FXuint)ICON_BEFORE_TEXT|(FXuint)TAB_BOTTOM|(FXuint)FRAME_RAISED|(FXuint)FRAME_THICK,
  TAB_LEFT_NORMAL  = (FXuint)JUSTIFY_LEFT|(FXuint)JUSTIFY_CENTER_Y|(FXuint)ICON_BEFORE_TEXT|(FXuint)TAB_LEFT|(FXuint)FRAME_RAISED|(FXuint)FRAME_THICK,
  TAB_RIGHT_NORMAL = (FXuint)JUSTIFY_LEFT|(FXuint)JUSTIFY_CENTER_Y|(FXuint)ICON_BEFORE_TEXT|(FXuint)TAB_RIGHT|(FXuint)FRAME_RAISED|(FXuint)FRAME_THICK
  };
