...
/* $srcdir/../csl-c\u01.c Machine generated C code */
...
v12:
    ...
    v55 = stack[-1];
    v55 = qcar(v55);
    v55 = *(Lisp_Object *)((char *)v65 + (CELL-TAG_VECTOR) + ((int32)v55/(16/CELL)));
    stack[-2] = v55;
    v55 = stack[-1];
    v55 = qcdr(v55);
    stack[-1] = v55;
...
v83:
    ...
    v199 = stack[-1];
    v199 = (Lisp_Object)(int32)((int32)v227 + (int32)v199 - TAG_FIXNUM);
    stack[-3] = v199;
    v199 = nil;
...
v214:
    v227 = qvalue(elt(env, 11)); /* posn!* */
    v199 = stack[-1];
    v227 = (Lisp_Object)(int32)((int32)v227 + (int32)v199 - TAG_FIXNUM);
    stack[-3] = v227;
    v199 = stack[0];
    v199 = (Lisp_Object)lesseq2(v227, v199);
    nil = C_nil;
...
v124:
    ...
    v227 = (Lisp_Object)((int32)(v199) + 0x10);
    v199 = stack[0];
    v199 = (Lisp_Object)((int32)(v199) - 0x10);
    {
        popv(5);
