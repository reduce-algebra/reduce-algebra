...
/* $srcdir/../csl-c\u03.c Machine generated C code */
...
v42:
    ...
    if (exception_pending()) goto v106;
    env = stack[-7];
    *(Lisp_Object *)((char *)stack[-1] + (CELL-TAG_VECTOR) + ((int32)stack[0]/(16/CELL))) = v58;
    v58 = stack[-2];
    v58 = add1(v58);
    nil = C_nil;
    if (exception_pending()) goto v106;
...
v45:
    ...
    v86 = stack[-2];
    v86 = qcar(v86);
    v86 = *(Lisp_Object *)((char *)v104 + (CELL-TAG_VECTOR) + ((int32)v86/(16/CELL)));
    stack[-3] = v86;
    v86 = stack[-2];
    v86 = qcdr(v86);
    stack[-2] = v86;
...
v69:
    ...
    v104 = qcar(v86);
    v86 = stack[-1];
    *(Lisp_Object *)((char *)v107 + (CELL-TAG_VECTOR) + ((int32)v104/(16/CELL))) = v86;
