% Generated using doxtract Sat Oct 18 11:14:38 2025
...
% Generating section 01 [options] with 54 subsections
...
\item [{\ttfamily --gc-error}] \index{{\ttfamily --gc-error}}
...
\item [{\ttfamily --kmax}] \index{{\ttfamily --kmax}}
...
\item [{\ttfamily --lisp}] \index{{\ttfamily --lisp}}
