...
% build everything else, but during development or debugging if that full
...
<< initreduce();
   date!* := "First stage bootstrap version";
   preserve('begin, "REDUCE") >>;

% "preserve" should cause CSL to exit...
