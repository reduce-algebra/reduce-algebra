...
// end of prologue
    ...
    stack[-4] = v_35;
    v_35 = stack[0];
    v_35 = (LispObject)((std::intptr_t)(v_35) - 0x10);
    stack[-1] = v_35;
v_15:
    v_35 = stack[-1];
    v_35 = ((std::intptr_t)(v_35) < 0 ? lisp_true : nil);
...
v_84:
    ...
    v_145 = nil;
v_67:
    {   LispObject fn = basic_elt(env, 4); // pasf_lnegrel
...
// end of prologue
    ...
    env = stack[-5];
    v_53 = (LispObject)(std::intptr_t)((std::intptr_t)stack[0] + (std::intptr_t)v_53 - TAG_FIXNUM);
    stack[-1] = v_53;
    v_53 = stack[-2];
    {   LispObject fn = basic_elt(env, 3); // gsugar
    stack[0] = (*qfn1(fn))(fn, v_53);
...
setup_type const u49_setup[] =
{
    ...
    {NULL, (no_args *)"u49", (one_arg *)"66875 4723005 7614699",
        NULL, NULL, NULL}
};
