...
v_7593:
    ...
    v_7617 = (*qfn2(fn))(fn, v_7617, v_7618);
    env = stack[-3];
    v_7618 = v_7617;
    v_7617 = stack[-2];
    v_7617 = qcdr(v_7617);
...
v_7573:
    ...
    v_7617 = (*qfn2(fn))(fn, v_7618, v_7617);
    env = stack[-3];
    if (v_7617 == nil) goto v_7567;
    else goto v_7568;
v_7567:
    v_7617 = lisp_true;
    goto v_7566;
...
{
    env = qenv(env);
    LispObject v_7568, v_7569, v_7570;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_7560:
    ...
    goto v_7561;
v_7562:
    v_7568 = (LispObject)-16+TAG_FIXNUM; // -1
    goto v_7563;
v_7564:
    goto v_7558;
v_7559:
...
v_7563:
    ...
    v_7568 = (*qfnn(fn))(fn, 3, v_7570, v_7569, v_7568);
    env = stack[0];
    {
        fn = elt(env, 2); // talp_rnf1
        return (*qfn1(fn))(fn, v_7568);
    }
}
...
v_7561:
    ...
    v_7594 = (*qfn2(fn))(fn, v_7595, v_7594);
    env = stack[-3];
    stack[-2] = v_7594;
    goto v_7575;
v_7571:
...
v_7572:
    goto v_7573;
v_7574:
    v_7594 = Lmemq(nil, v_7595, v_7594);
    if (v_7594 == nil) goto v_7570;
    else goto v_7568;
v_7570:
    v_7594 = stack[-1];
    fn = elt(env, 3); // qqe_op
    v_7594 = (*qfn1(fn))(fn, v_7594);
    env = stack[-3];
    fn = elt(env, 4); // qqe_rqopp
    v_7594 = (*qfn1(fn))(fn, v_7594);
    env = stack[-3];
    if (v_7594 == nil) goto v_7579;
    else goto v_7568;
v_7579:
    goto v_7569;
v_7568:
...
v_7590:
    {
        ...
        return (*qfn2(fn))(fn, v_7595, v_7594);
    }
    v_7594 = nil;
v_7567:
    return onevalue(v_7594);
}
...
v_7594:
    goto v_7595;
v_7596:
    v_7607 = Lrplacd(nil, stack[0], v_7607);
    env = stack[-5];
    v_7607 = stack[-1];
    v_7607 = qcdr(v_7607);
    stack[-1] = v_7607;
...
v_7560:
    {
        LispObject v_7614 = stack[-4];
        return cons(v_7614, v_7607);
    }
}
...
{
    env = qenv(env);
    LispObject v_7592, v_7593, v_7594;
#ifdef CHECK_STACK
    if_check_stack;
#endif
// copy arguments values to proper place
...
v_7566:
    goto v_7567;
v_7568:
    if (!consp(v_7592)) goto v_7563;
    v_7592 = qcar(v_7592);
    if (v_7592 == v_7594) goto v_7562;
    else goto v_7563;
v_7562:
    v_7592 = v_7593;
    v_7592 = qcdr(v_7592);
    v_7592 = (consp(v_7592) ? nil : lisp_true);
    v_7592 = (v_7592 == nil ? lisp_true : nil);
    goto v_7561;
v_7563:
    v_7592 = nil;
    goto v_7561;
...
v_7580:
    ...
    goto v_7581;
v_7582:
    v_7592 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_7583;
v_7584:
    goto v_7580;
v_7581:
    goto v_7582;
v_7583:
        return Llessp(nil, v_7593, v_7592);
v_7559:
    v_7592 = nil;
    goto v_7557;
    v_7592 = nil;
v_7557:
    return onevalue(v_7592);
}
...
// copy arguments values to proper place
    stack[0] = v_7554;
// end of prologue
    v_7593 = elt(env, 1); // implicit! 
    v_7593 = Lexplode(nil, v_7593);
    env = stack[-2];
    stack[-1] = v_7593;
    v_7593 = stack[0];
    v_7593 = Lexplode(nil, v_7593);
...
v_7579:
    goto v_7580;
v_7581:
    v_7593 = (equal(v_7595, v_7593) ? lisp_true : nil);
    v_7595 = v_7593;
    v_7593 = stack[-1];
    v_7593 = qcdr(v_7593);
    stack[-1] = v_7593;
...
{
    env = qenv(env);
    LispObject v_7583, v_7584, v_7585;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
// end of prologue
    v_7583 = v_7585;
    if (is_number(v_7583)) goto v_7561;
    else goto v_7560;
v_7561:
    v_7583 = v_7584;
    if (is_number(v_7583)) goto v_7563;
    else goto v_7560;
v_7563:
    goto v_7570;
v_7566:
...
v_7567:
    goto v_7568;
v_7569:
        return Llessp(nil, v_7583, v_7584);
v_7560:
    goto v_7580;
v_7576:
    v_7583 = v_7585;
...
v_7579:
    {
        fn = elt(env, 1); // ordp
        return (*qfn2(fn))(fn, v_7583, v_7584);
    }
    v_7583 = nil;
...
{
    env = qenv(env);
    LispObject v_7747, v_7748, v_7749;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_7567:
    v_7747 = stack[-3];
    if (!symbolp(v_7747)) v_7748 = nil;
    else { v_7748 = qfastgets(v_7747);
           if (v_7748 != nil) { v_7748 = elt(v_7748, 18); // phystype
#ifdef RECORD_GET
...
v_7568:
    goto v_7569;
v_7570:
    v_7747 = (v_7748 == v_7747 ? lisp_true : nil);
    goto v_7560;
    v_7747 = nil;
v_7560:
    if (v_7747 == nil) goto v_7558;
    else goto v_7557;
v_7558:
    v_7747 = stack[-3];
    if (!consp(v_7747)) goto v_7579;
    goto v_7589;
v_7585:
    v_7747 = stack[-3];
    v_7747 = qcar(v_7747);
...
v_7639:
    goto v_7640;
v_7641:
    v_7747 = (LispObject)geq2(v_7749, v_7747);
    v_7747 = v_7747 ? lisp_true : nil;
    env = stack[-5];
    if (v_7747 == nil) goto v_7635;
    else goto v_7636;
v_7635:
    v_7747 = nil;
    goto v_7634;
v_7636:
    v_7747 = (LispObject)16+TAG_FIXNUM; // 1
    stack[-4] = v_7747;
    goto v_7676;
v_7672:
    goto v_7682;
...
v_7673:
    goto v_7674;
v_7675:
    v_7747 = difference2(v_7748, v_7747);
    env = stack[-5];
    v_7747 = Lminusp(nil, v_7747);
    env = stack[-5];
    if (v_7747 == nil) goto v_7669;
    v_7747 = nil;
    goto v_7663;
v_7669:
    goto v_7694;
...
v_7693:
    fn = elt(env, 6); // nth
    v_7747 = (*qfn2(fn))(fn, v_7748, v_7747);
    env = stack[-5];
    v_7747 = ncons(v_7747);
    env = stack[-5];
    stack[-1] = v_7747;
...
v_7724:
    goto v_7725;
v_7726:
    v_7747 = Lrplacd(nil, stack[0], v_7747);
    env = stack[-5];
    v_7747 = stack[-1];
    v_7747 = qcdr(v_7747);
    stack[-1] = v_7747;
...
v_7566:
    v_7615 = stack[0];
    v_7615 = qcar(v_7615);
    v_7615 = (consp(v_7615) ? nil : lisp_true);
    goto v_7564;
    v_7615 = nil;
v_7564:
    if (v_7615 == nil) goto v_7562;
    v_7615 = stack[0];
    if (v_7615 == nil) goto v_7576;
    else goto v_7577;
v_7576:
    v_7615 = elt(env, 1); // tsq
    goto v_7557;
v_7577:
    v_7615 = stack[0];
    fn = elt(env, 3); // minusf
    v_7615 = (*qfn1(fn))(fn, v_7615);
    env = stack[-1];
    if (v_7615 == nil) goto v_7580;
    else goto v_7581;
v_7580:
    v_7615 = elt(env, 2); // stsq
    goto v_7557;
v_7581:
    v_7615 = nil;
    goto v_7557;
...
v_7562:
    ...
    v_7615 = qcar(v_7615);
    v_7615 = qcdr(v_7615);
    v_7615 = Levenp(nil, v_7615);
    env = stack[-1];
    if (v_7615 == nil) goto v_7593;
    v_7615 = stack[0];
    v_7615 = qcar(v_7615);
    v_7615 = qcdr(v_7615);
    v_7615 = CC_sfto_tsqsumf(elt(env, 0), v_7615);
    env = stack[-1];
    if (v_7615 == nil) goto v_7602;
    v_7615 = stack[0];
    v_7615 = qcdr(v_7615);
    stack[0] = v_7615;
    goto v_7558;
...
setup_type const u14_setup[] =
{
    ...
    {NULL, (one_args *)"u14", (two_args *)"108779 5686220 4723292", 0}
};
