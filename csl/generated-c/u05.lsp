...
(c!:install "u05" 18074 76569 1377681)

(c!:install 'kernord!-sort '(kernord!-sort maxdeg delallasc) 
4668489427632091701)

(c!:install 'ibalp_getupl '(ibalp_getupl) 6674772533828101402)
...
(c!:install 'safe!-fp!-plus '(safe!-fp!-plus 0.0 !!minnorm !!minnegnorm
0.00195312) 3090864426889406171)
...
(c!:install 'ibalp_minclnr '(ibalp_minclnr) 3420793893730633435)
...
(c!:install 'ibalp_csat '(ibalp_csat) 2872578297608437953)
...
(c!:install 'prepf1a_reversed '(prepf1a_reversed plus k!* prepd exchk
retimes) 9141067811768450838)
...
(c!:install 'fkern '(fkern exlist!* kprops!* klist ordad union) 
8320750765232779990)
