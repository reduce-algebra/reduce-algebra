...
(c!:install 'dv_null_first_kern '(dv_null_first_kern nil g_sc_ve !- t
pa_vect2list upbve) 1822321577279861184)

(c!:install 'msolve!-result '(msolve!-result failed list nil equal) 
913880958848052418)

(c!:install 'monic!-mod!-p '(monic!-mod!-p nil
"LC NOT NUMERIC IN MONIC-MOD-P" errorf multiply!-by!-constant!-mod!-p) 
2051621529702549793)
...
(c!:install 'spjordan_block '(spjordan_block spm !*protfg
"Error in spjordan_block(second argument): should be an integer." nil
