...
v_11:
    v_40 = stack[-4];
    v_41 = (LispObject)((intptr_t)(v_40) - 0x10);
    v_40 = stack[-5];
    v_40 = (LispObject)(intptr_t)((intptr_t)v_41 - (intptr_t)v_40 + TAG_FIXNUM);
    v_40 = ((intptr_t)(v_40) < 0 ? lisp_true : nil);
...
v_11:
    v_52 = v_53;
    v_53 = basic_elt(env, 1); // realvalued
...
v_7:
    ...
    v_54 = qcar(v_52);
    stack[0] = v_54;
    v_52 = basic_elt(env, 2); // alwaysrealvalued
    v_52 = Lflagp(nil, v_54, v_52);
    env = stack[-1];
...
v_25:
    v_54 = stack[0];
    v_52 = basic_elt(env, 1); // realvalued
    v_52 = Lflagp(nil, v_54, v_52);
    env = stack[-1];
    ...
    v_52 = qcdr(v_52);
    fn = basic_elt(env, 4); // realvaluedlist
...
v_35:
    v_52 = stack[0];
    v_53 = basic_elt(env, 3); // !:rd!:
    v_52 = (v_52 == v_53 ? lisp_true : nil);
v_34:
    goto v_23;
    v_52 = nil;
v_23:
...
setup_type const u28_setup[] =
{
    ...
    {NULL, (no_args *)"u28", (one_arg *)"90787 8397022 5527953",
        NULL, NULL, NULL}
};
