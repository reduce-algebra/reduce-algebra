...
v_1873:
    {
        fn = elt(env, 1); // nreverse
        return (*qfn2(fn))(fn, v_2024, v_2023);
    }
v_1867:
    v_2023 = stack[-1];
    if (v_2023 == nil) goto v_1877;
    else goto v_1878;
v_1877:
    goto v_1885;
v_1881:
...
v_1893:
    v_2023 = stack[-2];
    v_2023 = qcar(v_2023);
    v_2023 = (consp(v_2023) ? nil : lisp_true);
    goto v_1891;
    v_2023 = nil;
v_1891:
    if (v_2023 == nil) goto v_1889;
    goto v_1906;
v_1902:
    stack[0] = stack[-3];
    goto v_1903;
...
v_1912:
    fn = elt(env, 2); // addd
    v_2023 = (*qfn2(fn))(fn, v_2024, v_2023);
    env = stack[-4];
    goto v_1905;
v_1906:
    goto v_1902;
...
v_1905:
    {
        LispObject v_2029 = stack[0];
        fn = elt(env, 1); // nreverse
        return (*qfn2(fn))(fn, v_2029, v_2023);
    }
v_1889:
    v_2023 = stack[-1];
    if (!consp(v_2023)) goto v_1920;
    else goto v_1921;
v_1920:
    v_2023 = lisp_true;
    goto v_1919;
...
v_1933:
    {
        LispObject v_2030 = stack[0];
        fn = elt(env, 1); // nreverse
        return (*qfn2(fn))(fn, v_2030, v_2023);
    }
v_1917:
    goto v_1950;
v_1946:
...
v_1947:
    goto v_1948;
v_1949:
    if (equal(v_2024, v_2023)) goto v_1944;
    else goto v_1945;
v_1944:
    goto v_1964;
v_1958:
...
v_1970:
    goto v_1971;
v_1972:
    v_2024 = CC_raddf(elt(env, 0), v_2024, v_2023);
    env = stack[-4];
    goto v_1961;
v_1962:
    v_2023 = stack[-3];
...
v_1961:
    goto v_1962;
v_1963:
    v_2023 = acons(stack[0], v_2024, v_2023);
    env = stack[-4];
    stack[-3] = v_2023;
    v_2023 = stack[-2];
    v_2023 = qcdr(v_2023);
...
v_1872:
    goto v_1873;
v_1874:
    v_1923 = Latsoc(nil, stack[-2], v_1923);
    if (v_1923 == nil) goto v_1869;
    else goto v_1870;
v_1869:
    goto v_1884;
v_1880:
...
v_1883:
    {
        ...
        return (*qfn2(fn))(fn, v_1924, v_1923);
    }
v_1870:
    v_1923 = nil;
    goto v_1861;
...
v_1863:
    ...
    v_1923 = (*qfn1(fn))(fn, v_1923);
    env = stack[-3];
    stack[-1] = v_1923;
v_1893:
    v_1923 = stack[-1];
    if (v_1923 == nil) goto v_1898;
    else goto v_1899;
v_1898:
    goto v_1892;
v_1899:
...
v_1913:
    goto v_1914;
v_1915:
    v_1924 = CC_talp_varlt1(elt(env, 0), v_1924, v_1923);
    env = stack[-3];
    goto v_1907;
v_1908:
    v_1923 = stack[0];
...
v_1909:
    fn = elt(env, 4); // union
    v_1923 = (*qfn2(fn))(fn, v_1924, v_1923);
    env = stack[-3];
    stack[0] = v_1923;
    v_1923 = stack[-1];
    v_1923 = qcdr(v_1923);
...
// end of prologue
    ...
    v_1870 = (*qfn1(fn))(fn, v_1870);
    env = stack[-1];
    if (v_1870 == nil) goto v_1861;
    else goto v_1862;
v_1861:
    v_1870 = stack[0];
    goto v_1860;
...
{
    env = qenv(env);
    LispObject v_1915, v_1916, v_1917, v_1918;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_1865:
    goto v_1866;
v_1867:
    if (equal(v_1916, v_1915)) goto v_1862;
    else goto v_1863;
v_1862:
    v_1915 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_1861;
v_1863:
    v_1915 = qvalue(elt(env, 1)); // dmode!*
    if (!symbolp(v_1915)) v_1915 = nil;
    else { v_1915 = qfastgets(v_1915);
           if (v_1915 != nil) { v_1915 = elt(v_1915, 3); // field
#ifdef RECORD_GET
             if (v_1915 == SPID_NOPROP)
                record_get(elt(fastget_names, 3), 0),
                v_1915 = nil;
             else record_get(elt(fastget_names, 3), 1),
                v_1915 = lisp_true; }
...
#else
             if (v_1915 == SPID_NOPROP) v_1915 = nil; else v_1915 = lisp_true; }}
#endif
    if (v_1915 == nil) goto v_1873;
    goto v_1881;
v_1877:
    v_1915 = v_1918;
    goto v_1878;
...
v_1880:
    {
        fn = elt(env, 2); // divd
        return (*qfn2(fn))(fn, v_1915, v_1916);
    }
v_1873:
    v_1915 = v_1918;
    if (!consp(v_1915)) goto v_1888;
    else goto v_1889;
v_1888:
    v_1915 = lisp_true;
    goto v_1887;
v_1889:
    v_1915 = v_1918;
    v_1915 = qcar(v_1915);
    v_1915 = (consp(v_1915) ? nil : lisp_true);
    goto v_1887;
    v_1915 = nil;
v_1887:
    if (v_1915 == nil) goto v_1885;
    goto v_1902;
v_1898:
    v_1915 = v_1918;
    goto v_1899;
...
v_1866:
    ...
    v_1872 = (*qfn2(fn))(fn, v_1873, v_1872);
    env = stack[-2];
    v_1872 = stack[-1];
    {
        fn = elt(env, 3); // inshisto
        return (*qfn1(fn))(fn, v_1872);
    }
}
...
v_1856:
    v_1877 = stack[0];
    if (!consp(v_1877)) goto v_1861;
    else goto v_1862;
v_1861:
    v_1877 = stack[0];
    {
        fn = elt(env, 1); // pm!:free
        return (*qfn1(fn))(fn, v_1877);
    }
v_1862:
    v_1877 = stack[0];
    v_1877 = qcar(v_1877);
    v_1877 = CC_freexp(elt(env, 0), v_1877);
    env = stack[-1];
    if (v_1877 == nil) goto v_1870;
    else goto v_1869;
v_1870:
    v_1877 = stack[0];
    v_1877 = qcdr(v_1877);
...
setup_type const u06_setup[] =
{
    ...
    {NULL, (one_args *)"u06", (two_args *)"104010 6600098 2135947", 0}
};
