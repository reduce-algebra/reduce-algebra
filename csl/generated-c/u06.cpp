...
// end of prologue
    v_2018 = elt(env, 1); // "=== LALR ITEMSET COLLECTION ==="
    v_2018 = Lprinc(nil, v_2018);
    env = stack[-6];
    v_2018 = Lterpri(nil, 0);
    env = stack[-6];
    v_2018 = qvalue(elt(env, 2)); // itemset_collection
    v_2018 = Lreverse(nil, v_2018);
    env = stack[-6];
    stack[-5] = v_2018;
v_1867:
    v_2018 = stack[-5];
    if (v_2018 == nil) goto v_1872;
    else goto v_1873;
v_1872:
    goto v_1866;
v_1873:
    ...
    v_2018 = qcar(v_2018);
    stack[-4] = v_2018;
    v_2018 = elt(env, 3); // "Itemset "
    v_2018 = Lprinc(nil, v_2018);
    env = stack[-6];
    v_2018 = stack[-4];
    v_2018 = qcdr(v_2018);
    v_2018 = Lprin(nil, v_2018);
    env = stack[-6];
    v_2018 = Lterpri(nil, 0);
    env = stack[-6];
    goto v_1894;
...
v_1893:
    fn = elt(env, 13); // sort
    v_2018 = (*qfn2(fn))(fn, v_2019, v_2018);
    env = stack[-6];
    stack[-3] = v_2018;
v_1888:
    v_2018 = stack[-3];
    if (v_2018 == nil) goto v_1900;
    else goto v_1901;
v_1900:
    goto v_1887;
v_1901:
...
v_1958:
    v_2018 = stack[0];
    v_2019 = Llength(nil, v_2018);
    env = stack[-6];
    goto v_1959;
v_1960:
    v_2018 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_1961;
v_1962:
    goto v_1958;
v_1959:
...
v_1941:
    ...
    goto v_1888;
v_1887:
    v_2018 = qvalue(elt(env, 10)); // symbols
    stack[-1] = v_2018;
v_1980:
    v_2018 = stack[-1];
    if (v_2018 == nil) goto v_1984;
    else goto v_1985;
v_1984:
    goto v_1979;
v_1985:
...
v_1999:
    ...
    env = stack[-6];
    stack[-2] = v_2018;
    if (v_2018 == nil) goto v_1994;
    v_2018 = elt(env, 11); // "GOTO("
    v_2018 = Lprinc(nil, v_2018);
    env = stack[-6];
    v_2018 = stack[0];
    fn = elt(env, 14); // lalr_prin_symbol
...
// end of prologue
    v_1863 = stack[0];
    v_1863 = Lprinc(nil, v_1863);
    env = stack[-1];
    v_1863 = Lterpri(nil, 0);
    v_1863 = stack[0];
    return onevalue(v_1863);
}
...
{
    env = qenv(env);
    LispObject v_1893, v_1894, v_1895;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_1862:
    v_1893 = v_1895;
    v_1893 = qcar(v_1893);
    if (!symbolp(v_1893)) v_1893 = nil;
    else { v_1893 = qfastgets(v_1893);
           if (v_1893 != nil) { v_1893 = elt(v_1893, 44); // prepfn2
#ifdef RECORD_GET
             if (v_1893 != SPID_NOPROP)
                record_get(elt(fastget_names, 44), 1);
             else record_get(elt(fastget_names, 44), 0),
                v_1893 = nil; }
           else record_get(elt(fastget_names, 44), 0); }
#else
             if (v_1893 == SPID_NOPROP) v_1893 = nil; }}
#endif
    v_1894 = v_1893;
    v_1893 = v_1894;
    if (v_1893 == nil) goto v_1874;
    goto v_1881;
v_1877:
    v_1893 = v_1894;
    goto v_1878;
...
v_1878:
    goto v_1879;
v_1880:
        return Lapply1(nil, v_1893, v_1894);
v_1874:
    v_1893 = v_1895;
    v_1893 = qcar(v_1893);
    if (!consp(v_1893)) goto v_1884;
    else goto v_1885;
v_1884:
    v_1893 = v_1895;
    goto v_1872;
...
// copy arguments values to proper place
    v_1871 = v_1857;
// end of prologue
    v_1870 = qvalue(elt(env, 1)); // !*rlsusi
    if (v_1870 == nil) goto v_1862;
    v_1870 = v_1871;
    {
        fn = elt(env, 2); // cl_susicpknowl
        return (*qfn1(fn))(fn, v_1870);
    }
v_1862:
    v_1870 = v_1871;
    {
...
// end of prologue
    goto v_1863;
v_1859:
    if (!symbolp(v_1868)) v_1868 = nil;
    else { v_1868 = qfastgets(v_1868);
           if (v_1868 != nil) { v_1868 = elt(v_1868, 10); // idtype
#ifdef RECORD_GET
             if (v_1868 != SPID_NOPROP)
                record_get(elt(fastget_names, 10), 1);
             else record_get(elt(fastget_names, 10), 0),
                v_1868 = nil; }
           else record_get(elt(fastget_names, 10), 0); }
#else
             if (v_1868 == SPID_NOPROP) v_1868 = nil; }}
#endif
    goto v_1860;
v_1861:
    v_1869 = elt(env, 1); // qt
...
v_1860:
    goto v_1861;
v_1862:
    v_1868 = (v_1868 == v_1869 ? lisp_true : nil);
    return onevalue(v_1868);
}
...
v_1865:
    {
        LispObject v_1879 = stack[-1];
        return list2star(v_1879, v_1876, v_1875);
    }
}
...
v_1862:
    v_1879 = stack[0];
    fn = elt(env, 1); // opmtch
    v_1879 = (*qfn1(fn))(fn, v_1879);
    v_1880 = v_1879;
    v_1879 = v_1880;
    if (v_1879 == nil) goto v_1873;
    v_1879 = v_1880;
    goto v_1871;
v_1873:
    v_1879 = stack[0];
...
{
    env = qenv(env);
    LispObject v_2347, v_2348, v_2349;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
// copy arguments values to proper place
    ...
    stack[-2] = v_1857;
// end of prologue
    v_2347 = qvalue(elt(env, 1)); // !*revalp
    if (v_2347 == nil) goto v_1862;
    else goto v_1863;
v_1862:
    v_2347 = stack[-2];
    goto v_1861;
v_1863:
    v_2347 = qvalue(elt(env, 2)); // varstack!*
// Binding varstack!*
// FLUIDBIND: reloadenv=4 litvec-offset=2 saveloc=3
{   bind_fluid_stack bind_fluid_var(-4, 2, -3);
    qvalue(elt(env, 2)) = v_2347; // varstack!*
    v_2347 = stack[-2];
    if (v_2347 == nil) goto v_1876;
    else goto v_1877;
v_1876:
    v_2347 = nil;
    goto v_1873;
v_1877:
    v_2347 = stack[-2];
    v_2347 = Lstringp(nil, v_2347);
    env = stack[-4];
    if (v_2347 == nil) goto v_1881;
    v_2347 = stack[-2];
    goto v_1873;
v_1881:
    v_2347 = stack[-2];
    v_2347 = integerp(v_2347);
    if (v_2347 == nil) goto v_1886;
    v_2347 = qvalue(elt(env, 3)); // dmode!*
    if (!symbolp(v_2347)) v_2347 = nil;
    else { v_2347 = qfastgets(v_2347);
           if (v_2347 != nil) { v_2347 = elt(v_2347, 5); // convert
#ifdef RECORD_GET
             if (v_2347 == SPID_NOPROP)
...
#else
             if (v_2347 == SPID_NOPROP) v_2347 = nil; else v_2347 = lisp_true; }}
#endif
    if (v_2347 == nil) goto v_1892;
    goto v_1900;
v_1896:
    v_2348 = stack[-2];
    goto v_1897;
...
v_1899:
    ...
    v_2347 = (*qfn2(fn))(fn, v_2348, v_2347);
    goto v_1890;
v_1892:
    v_2347 = stack[-2];
    goto v_1890;
...
v_1886:
    v_2347 = stack[-2];
    if (!consp(v_2347)) goto v_1906;
    else goto v_1907;
v_1906:
    v_2347 = qvalue(elt(env, 4)); // subfg!*
    if (v_2347 == nil) goto v_1911;
    else goto v_1912;
v_1911:
    v_2347 = stack[-2];
    goto v_1873;
v_1912:
    v_2347 = stack[-2];
    if (symbolp(v_2347)) goto v_1917;
    else goto v_1916;
v_1917:
    v_2347 = stack[-2];
    if (!symbolp(v_2347)) v_2347 = nil;
    else { v_2347 = qfastgets(v_2347);
           if (v_2347 != nil) { v_2347 = elt(v_2347, 4); // avalue
#ifdef RECORD_GET
             if (v_2347 != SPID_NOPROP)
...
#else
             if (v_2347 == SPID_NOPROP) v_2347 = nil; }}
#endif
    stack[0] = v_2347;
    if (v_2347 == nil) goto v_1916;
    goto v_1930;
v_1926:
    v_2348 = stack[-2];
    goto v_1927;
...
v_1927:
    goto v_1928;
v_1929:
    v_2347 = Lmemq(nil, v_2348, v_2347);
    if (v_2347 == nil) goto v_1925;
    v_2347 = stack[-2];
    fn = elt(env, 20); // recursiveerror
    v_2347 = (*qfn1(fn))(fn, v_2347);
    env = stack[-4];
    goto v_1923;
v_1925:
    goto v_1943;
...
v_1952:
    goto v_1953;
v_1954:
    v_2347 = get(v_2348, v_2347);
    env = stack[-4];
    v_2349 = v_2347;
    if (v_2347 == nil) goto v_1949;
    goto v_1966;
v_1960:
    goto v_1961;
v_1962:
...
v_1963:
    goto v_1964;
v_1965:
    v_2347 = Lapply2(nil, 3, v_2349, v_2348, v_2347);
    goto v_1947;
v_1949:
    goto v_1977;
v_1973:
...
v_1974:
    goto v_1975;
v_1976:
    v_2347 = CC_reval1(elt(env, 0), v_2348, v_2347);
    goto v_1947;
    v_2347 = nil;
v_1947:
    goto v_1873;
...
v_2007:
    fn = elt(env, 21); // apply
    v_2347 = (*qfn2(fn))(fn, stack[0], v_2347);
    goto v_1873;
v_1992:
    goto v_2019;
v_2015:
...
v_2022:
    ...
    v_2347 = qcdr(v_2347);
    v_2347 = qcar(v_2347);
    if (v_2347 == nil) goto v_2035;
    v_2347 = qvalue(elt(env, 8)); // !*resimp
    if (v_2347 == nil) goto v_2041;
    else goto v_2035;
v_2041:
    v_2347 = stack[-1];
    if (v_2347 == nil) goto v_2045;
    else goto v_2046;
v_2045:
    v_2347 = stack[-2];
    goto v_2044;
...
v_2023:
    ...
    if (!symbolp(v_2347)) v_2347 = nil;
           ...
           if (v_2347 != nil) { v_2347 = elt(v_2347, 39); // remember
#ifdef RECORD_GET
             if (v_2347 == SPID_NOPROP)
...
v_2066:
    ...
    if (!symbolp(v_2347)) v_2347 = nil;
           ...
           if (v_2347 != nil) { v_2347 = elt(v_2347, 59); // opfn
#ifdef RECORD_GET
             if (v_2347 == SPID_NOPROP)
             ...
             if (v_2347 == SPID_NOPROP) v_2347 = nil; else v_2347 = lisp_true; }}
#endif
    if (v_2347 == nil) goto v_2079;
    goto v_2088;
v_2084:
    v_2347 = stack[-2];
    fn = elt(env, 25); // opfneval
    v_2348 = (*qfn1(fn))(fn, v_2347);
    env = stack[-4];
    goto v_2085;
v_2086:
    v_2347 = stack[-1];
...
v_2079:
    ...
    if (!symbolp(v_2347)) v_2347 = nil;
           ...
           if (v_2347 != nil) { v_2347 = elt(v_2347, 45); // psopfn
#ifdef RECORD_GET
             if (v_2347 != SPID_NOPROP)
...
v_2099:
    goto v_2100;
v_2101:
    v_2347 = Lapply1(nil, v_2348, v_2347);
    env = stack[-4];
    stack[-2] = v_2347;
    goto v_2115;
v_2111:
...
v_2180:
    goto v_2190;
v_2186:
    v_2348 = elt(env, 11); // "Missing evaluation for type"
    goto v_2187;
v_2188:
    v_2347 = stack[0];
    goto v_2189;
...
v_2181:
    ...
    v_2347 = (*qfnn(fn))(fn, 3, stack[-2], stack[-1], v_2347);
    goto v_2151;
    v_2347 = nil;
v_2151:
    goto v_2145;
v_2147:
    v_2347 = stack[-2];
    if (!consp(v_2347)) goto v_2198;
    v_2347 = stack[-2];
    v_2347 = qcdr(v_2347);
    if (!consp(v_2347)) goto v_2203;
    v_2347 = stack[-2];
    v_2347 = qcdr(v_2347);
    v_2347 = qcar(v_2347);
    fn = elt(env, 28); // getrtype
...
v_2273:
    goto v_2274;
v_2275:
    v_2347 = Lflagp(nil, v_2348, v_2347);
    env = stack[-4];
    goto v_2258;
    v_2347 = nil;
v_2258:
    if (v_2347 == nil) goto v_2256;
    goto v_2289;
v_2285:
    v_2347 = stack[-2];
    v_2348 = qcar(v_2347);
...
v_2288:
    v_2347 = Lflagp(nil, v_2348, v_2347);
    env = stack[-4];
    if (v_2347 == nil) goto v_2282;
    else goto v_2283;
v_2282:
    v_2347 = qvalue(elt(env, 17)); // !*listargs
    if (v_2347 == nil) goto v_2295;
    else goto v_2296;
v_2295:
    goto v_2303;
v_2299:
...
v_2302:
    v_2347 = Lflagp(nil, v_2348, v_2347);
    env = stack[-4];
    v_2347 = (v_2347 == nil ? lisp_true : nil);
    goto v_2294;
v_2296:
    v_2347 = nil;
    goto v_2294;
...
// end of prologue
    ...
    stack[-1] = v_1981;
    v_1981 = stack[-2];
    if (!consp(v_1981)) goto v_1870;
    v_1981 = stack[-2];
    v_1981 = CC_anform1(elt(env, 0), v_1981);
    env = stack[-3];
    v_1981 = stack[-1];
    {
        fn = elt(env, 7); // anforml
        return (*qfn1(fn))(fn, v_1981);
    }
v_1870:
    v_1981 = stack[-2];
    if (symbolp(v_1981)) goto v_1879;
    v_1981 = nil;
    goto v_1862;
v_1879:
    goto v_1889;
...
v_1886:
    goto v_1887;
v_1888:
    v_1981 = Lflagp(nil, v_1982, v_1981);
    env = stack[-3];
    if (v_1981 == nil) goto v_1883;
    goto v_1901;
v_1897:
    v_1982 = stack[-2];
    goto v_1898;
v_1899:
    v_1981 = elt(env, 2); // glb2rf
    goto v_1900;
v_1901:
    goto v_1897;
v_1898:
...
v_1906:
    goto v_1907;
v_1908:
    v_1981 = Lflag(nil, v_1982, v_1981);
    env = stack[-3];
    goto v_1918;
v_1914:
    v_1982 = stack[-2];
...
v_1915:
    goto v_1916;
v_1917:
    v_1981 = cons(v_1982, v_1981);
    env = stack[-3];
    qvalue(elt(env, 3)) = v_1981; // globs!*
    goto v_1893;
v_1895:
v_1893:
    v_1981 = stack[-1];
...
v_1926:
    goto v_1927;
v_1928:
    v_1981 = Lassoc(nil, v_1982, v_1981);
    if (v_1981 == nil) goto v_1924;
    v_1981 = stack[-1];
    {
        fn = elt(env, 7); // anforml
        return (*qfn1(fn))(fn, v_1981);
...
v_1941:
    ...
    v_1981 = (*qfn2(fn))(fn, stack[0], v_1981);
    env = stack[-3];
    goto v_1955;
v_1951:
    v_1982 = stack[-2];
...
v_1963:
    goto v_1964;
v_1965:
    v_1981 = get(v_1982, v_1981);
    env = stack[-3];
    v_1982 = v_1981;
    if (v_1981 == nil) goto v_1960;
    goto v_1974;
v_1970:
    goto v_1971;
v_1972:
...
v_1971:
    goto v_1972;
v_1973:
    v_1981 = Lapply1(nil, v_1982, v_1981);
    goto v_1947;
v_1960:
    v_1981 = stack[-1];
    fn = elt(env, 7); // anforml
...
{
    env = qenv(env);
    LispObject v_1913, v_1914, v_1915;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_1868:
    ...
    goto v_1869;
v_1870:
    v_1913 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_1871;
v_1872:
    goto v_1868;
v_1869:
...
v_1881:
    v_1913 = v_1914;
    v_1913 = qcar(v_1913);
    v_1913 = (consp(v_1913) ? nil : lisp_true);
    goto v_1879;
    v_1913 = nil;
v_1879:
    if (v_1913 == nil) goto v_1877;
    goto v_1894;
v_1890:
    v_1913 = v_1914;
    fn = elt(env, 1); // absf
    v_1914 = (*qfn1(fn))(fn, v_1913);
    env = stack[-2];
    goto v_1891;
v_1892:
    v_1913 = stack[0];
...
v_1893:
    {
        ...
        return (*qfn2(fn))(fn, v_1914, v_1913);
    }
v_1877:
    v_1913 = v_1914;
    v_1913 = qcdr(v_1913);
...
v_1904:
    goto v_1905;
v_1906:
    v_1913 = CC_sfto_dcontentf1(elt(env, 0), v_1914, v_1913);
    env = stack[-2];
    stack[0] = v_1913;
    v_1913 = stack[-1];
    v_1914 = v_1913;
...
{
    env = qenv(env);
    LispObject v_1921, v_1922, v_1923, v_1924;
#ifdef CHECK_STACK
    if_check_stack;
#endif
    if (stack >= stacklimit)
...
v_1881:
    goto v_1882;
v_1883:
    if (!consp(v_1924)) goto v_1878;
    v_1924 = qcar(v_1924);
    if (v_1924 == v_1921) goto v_1877;
    else goto v_1878;
v_1877:
    v_1921 = lisp_true;
    goto v_1876;
...
v_1897:
    goto v_1898;
v_1899:
    if (!consp(v_1924)) goto v_1894;
    v_1924 = qcar(v_1924);
    if (v_1924 == v_1921) goto v_1893;
    else goto v_1894;
v_1893:
    goto v_1908;
v_1904:
...
v_1905:
    goto v_1906;
v_1907:
    v_1921 = Leqcar(nil, v_1924, v_1921);
    env = stack[0];
    goto v_1892;
v_1894:
    v_1921 = nil;
...
v_1862:
    v_1912 = stack[-1];
    if (v_1912 == nil) goto v_1865;
    else goto v_1866;
v_1865:
    v_1912 = stack[-2];
    {
        fn = elt(env, 1); // nreverse
        return (*qfn1(fn))(fn, v_1912);
    }
v_1866:
    v_1912 = stack[-1];
    if (!consp(v_1912)) goto v_1874;
    else goto v_1875;
v_1874:
    v_1912 = lisp_true;
    goto v_1873;
v_1875:
    v_1912 = stack[-1];
    v_1912 = qcar(v_1912);
    v_1912 = (consp(v_1912) ? nil : lisp_true);
    goto v_1873;
    v_1912 = nil;
v_1873:
    if (v_1912 == nil) goto v_1871;
    goto v_1888;
v_1884:
    v_1913 = stack[-2];
    goto v_1885;
v_1886:
    v_1912 = stack[-1];
    {   intptr_t w = int_of_fixnum(v_1912);
        if (w != 0) w = current_modulus - w;
        v_1912 = fixnum_of_int(w);
    }
    goto v_1887;
v_1888:
    goto v_1884;
...
v_1887:
    {
        fn = elt(env, 1); // nreverse
        return (*qfn2(fn))(fn, v_1913, v_1912);
    }
v_1871:
    goto v_1901;
v_1895:
...
v_1897:
    ...
    v_1912 = qcar(v_1912);
    v_1912 = qcdr(v_1912);
    v_1913 = CC_minusKmodKp(elt(env, 0), v_1912);
    env = stack[-3];
    goto v_1898;
v_1899:
    v_1912 = stack[-2];
...
v_1898:
    goto v_1899;
v_1900:
    v_1912 = acons(stack[0], v_1913, v_1912);
    env = stack[-3];
    stack[-2] = v_1912;
    v_1912 = stack[-1];
    v_1912 = qcdr(v_1912);
...
static LispObject CC_eolcheck(LispObject env, int nargs, ...)
{
    ...
    stack_popper stack_popper_var(1);
// end of prologue
    v_1896 = qvalue(elt(env, 1)); // !*eoldelimp
    if (v_1896 == nil) goto v_1860;
    else goto v_1861;
v_1860:
    v_1896 = nil;
    goto v_1859;
...
v_1868:
    goto v_1877;
v_1873:
    v_1897 = qvalue(elt(env, 2)); // nxtsym!*
    goto v_1874;
v_1875:
    v_1896 = qvalue(elt(env, 3)); // !$eol!$
    goto v_1876;
v_1877:
    goto v_1873;
v_1874:
    goto v_1875;
v_1876:
    if (v_1897 == v_1896) goto v_1872;
    v_1896 = nil;
    goto v_1867;
v_1872:
    goto v_1889;
v_1885:
    v_1897 = qvalue(elt(env, 4)); // cursym!*
    goto v_1886;
v_1887:
    v_1896 = elt(env, 5); // end
    goto v_1888;
v_1889:
    goto v_1885;
v_1886:
...
v_1884:
    ...
    v_1896 = nil;
v_1882:
    qvalue(elt(env, 2)) = v_1896; // nxtsym!*
    goto v_1868;
v_1867:
    goto v_1859;
    v_1896 = nil;
v_1859:
    return onevalue(v_1896);
}
...
setup_type const u06_setup[] =
{
    ...
    {NULL, (one_args *)"u06", (two_args *)"93320 8048271 4458856", 0}
};
