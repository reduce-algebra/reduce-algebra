...
// end of prologue
    ...
    env = stack[-3];
    if (((std::intptr_t)(stack[-2])) > ((std::intptr_t)(v_29))) goto v_7;
    else goto v_8;
v_7:
...
v_8:
    ...
    v_29 = Llength(nil, v_29);
    env = stack[-3];
    if (((std::intptr_t)(stack[-2])) > ((std::intptr_t)(v_29))) goto v_14;
    else goto v_15;
v_14:
    v_29 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_6;
...
v_15:
    ...
    if (!car_legal(v_38)) v_38 = carerror(v_38); else
    v_38 = car(v_38);
    {   LispObject fn = basic_elt(env, 1); // ibalp_commonlenisone
...
v_14:
    ...
    v_57 = car(v_57);
    if (((std::intptr_t)(v_58)) > ((std::intptr_t)(v_57))) goto v_23;
    else goto v_24;
v_23:
    v_57 = stack[-1];
    if (!car_legal(v_57)) v_57 = carerror(v_57); else
...
v_44:
    ...
    env = stack[-4];
    v_73 = (LispObject)(std::intptr_t)((std::intptr_t)stack[0] - (std::intptr_t)v_73 + TAG_FIXNUM);
    v_73 = ((std::intptr_t)stack[-1] < (std::intptr_t)v_73) ? lisp_true : nil;
...
v_41:
    ...
    v_73 = (LispObject)(std::intptr_t)((std::intptr_t)v_73 - (std::intptr_t)v_74 + TAG_FIXNUM);
    if (((std::intptr_t)(stack[0])) < ((std::intptr_t)(v_73))) goto v_60;
