...
{
    env = qenv(env);
    LispObject v_7178, v_7179, v_7180, v_7181;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_7074:
    goto v_7075;
v_7076:
    stack[-2] = difference2(v_7179, v_7178);
    env = stack[-3];
    goto v_7093;
v_7089:
    v_7178 = stack[-1];
...
v_7113:
    goto v_7114;
v_7115:
        return Llessp(nil, v_7179, v_7178);
v_7103:
    goto v_7125;
v_7121:
    v_7179 = v_7180;
...
v_7148:
    ...
    stack[-1] = (*qfn2(fn))(fn, v_7179, v_7178);
    env = stack[-3];
    goto v_7140;
v_7141:
    goto v_7160;
...
v_7142:
    {
        LispObject v_7185 = stack[-1];
        return Llessp(nil, v_7185, v_7178);
    }
    v_7178 = nil;
    goto v_7068;
v_7070:
...
v_7080:
    ...
    v_7127 = qcar(v_7127);
    stack[-2] = v_7127;
    v_7127 = (LispObject)0+TAG_FIXNUM; // 0
    v_7128 = v_7127;
v_7089:
    v_7127 = stack[-2];
    if (v_7127 == nil) goto v_7095;
    else goto v_7096;
v_7095:
    v_7127 = v_7128;
    v_7128 = v_7127;
...
v_7103:
    ...
    v_7127 = (*qfn2(fn))(fn, v_7127, v_7128);
    env = stack[-3];
    v_7128 = v_7127;
    v_7127 = stack[-2];
    v_7127 = qcdr(v_7127);
...
v_7083:
    ...
    v_7127 = (*qfn2(fn))(fn, v_7128, v_7127);
    env = stack[-3];
    if (v_7127 == nil) goto v_7077;
    else goto v_7078;
v_7077:
    v_7127 = lisp_true;
    goto v_7076;
...
v_7070:
    ...
    goto v_7071;
v_7072:
    v_7078 = (LispObject)-16+TAG_FIXNUM; // -1
    goto v_7073;
v_7074:
    goto v_7068;
v_7069:
...
v_7073:
    ...
    v_7078 = (*qfnn(fn))(fn, 3, v_7080, v_7079, v_7078);
    env = stack[0];
    {
...
v_7071:
    ...
    v_7104 = (*qfn2(fn))(fn, v_7105, v_7104);
    env = stack[-3];
    stack[-2] = v_7104;
    goto v_7085;
v_7081:
...
v_7082:
    goto v_7083;
v_7084:
    v_7104 = Lmemq(nil, v_7105, v_7104);
    if (v_7104 == nil) goto v_7080;
    else goto v_7078;
v_7080:
    v_7104 = stack[-1];
    fn = elt(env, 3); // qqe_op
    v_7104 = (*qfn1(fn))(fn, v_7104);
    env = stack[-3];
    fn = elt(env, 4); // qqe_rqopp
    v_7104 = (*qfn1(fn))(fn, v_7104);
    env = stack[-3];
    if (v_7104 == nil) goto v_7089;
    else goto v_7078;
v_7089:
    goto v_7079;
v_7078:
...
v_7100:
    {
        ...
        return (*qfn2(fn))(fn, v_7105, v_7104);
    }
    v_7104 = nil;
v_7077:
    return onevalue(v_7104);
}
...
v_7104:
    goto v_7105;
v_7106:
    v_7117 = Lrplacd(nil, stack[0], v_7117);
    env = stack[-5];
    v_7117 = stack[-1];
    v_7117 = qcdr(v_7117);
    stack[-1] = v_7117;
...
v_7070:
    {
        LispObject v_7124 = stack[-4];
        return cons(v_7124, v_7117);
    }
}
...
v_7076:
    goto v_7077;
v_7078:
    if (!consp(v_7102)) goto v_7073;
    v_7102 = qcar(v_7102);
    if (v_7102 == v_7104) goto v_7072;
    else goto v_7073;
v_7072:
    v_7102 = v_7103;
    v_7102 = qcdr(v_7102);
    v_7102 = (consp(v_7102) ? nil : lisp_true);
    v_7102 = (v_7102 == nil ? lisp_true : nil);
    goto v_7071;
v_7073:
    v_7102 = nil;
    goto v_7071;
...
v_7090:
    ...
    goto v_7091;
v_7092:
    v_7102 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_7093;
v_7094:
    goto v_7090;
v_7091:
    goto v_7092;
v_7093:
        return Llessp(nil, v_7103, v_7102);
v_7069:
    v_7102 = nil;
    goto v_7067;
    v_7102 = nil;
...
// copy arguments values to proper place
    stack[0] = v_7064;
// end of prologue
    v_7103 = elt(env, 1); // implicit! 
    v_7103 = Lexplode(nil, v_7103);
    env = stack[-2];
    stack[-1] = v_7103;
    v_7103 = stack[0];
    v_7103 = Lexplode(nil, v_7103);
...
v_7089:
    goto v_7090;
v_7091:
    v_7103 = (equal(v_7105, v_7103) ? lisp_true : nil);
    v_7105 = v_7103;
    v_7103 = stack[-1];
    v_7103 = qcdr(v_7103);
    stack[-1] = v_7103;
...
{
    env = qenv(env);
    LispObject v_7093, v_7094, v_7095;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
// end of prologue
    v_7093 = v_7095;
    if (is_number(v_7093)) goto v_7071;
    else goto v_7070;
v_7071:
    v_7093 = v_7094;
    if (is_number(v_7093)) goto v_7073;
    else goto v_7070;
v_7073:
    goto v_7080;
v_7076:
...
v_7077:
    goto v_7078;
v_7079:
        return Llessp(nil, v_7093, v_7094);
v_7070:
    goto v_7090;
v_7086:
    v_7093 = v_7095;
...
v_7089:
    {
        fn = elt(env, 1); // ordp
        return (*qfn2(fn))(fn, v_7093, v_7094);
    }
    v_7093 = nil;
    return onevalue(v_7093);
}
...
{
    env = qenv(env);
    LispObject v_7257, v_7258, v_7259;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_7077:
    v_7257 = stack[-3];
    if (!symbolp(v_7257)) v_7258 = nil;
    else { v_7258 = qfastgets(v_7257);
           if (v_7258 != nil) { v_7258 = elt(v_7258, 18); // phystype
#ifdef RECORD_GET
             if (v_7258 != SPID_NOPROP)
                record_get(elt(fastget_names, 18), 1);
             else record_get(elt(fastget_names, 18), 0),
                v_7258 = nil; }
           else record_get(elt(fastget_names, 18), 0); }
#else
             if (v_7258 == SPID_NOPROP) v_7258 = nil; }}
#endif
    goto v_7078;
v_7079:
    v_7257 = elt(env, 1); // scalar
    goto v_7080;
v_7081:
    goto v_7077;
v_7078:
    goto v_7079;
v_7080:
    v_7257 = (v_7258 == v_7257 ? lisp_true : nil);
    goto v_7070;
    v_7257 = nil;
v_7070:
    if (v_7257 == nil) goto v_7068;
    else goto v_7067;
v_7068:
    v_7257 = stack[-3];
    if (!consp(v_7257)) goto v_7089;
    goto v_7099;
v_7095:
    v_7257 = stack[-3];
    v_7257 = qcar(v_7257);
...
v_7149:
    goto v_7150;
v_7151:
    v_7257 = (LispObject)geq2(v_7259, v_7257);
    v_7257 = v_7257 ? lisp_true : nil;
    env = stack[-5];
    if (v_7257 == nil) goto v_7145;
    else goto v_7146;
v_7145:
    v_7257 = nil;
    goto v_7144;
v_7146:
    v_7257 = (LispObject)16+TAG_FIXNUM; // 1
    stack[-4] = v_7257;
    goto v_7186;
v_7182:
    goto v_7192;
...
v_7183:
    goto v_7184;
v_7185:
    v_7257 = difference2(v_7258, v_7257);
    env = stack[-5];
    v_7257 = Lminusp(nil, v_7257);
    env = stack[-5];
    if (v_7257 == nil) goto v_7179;
    v_7257 = nil;
    goto v_7173;
v_7179:
    goto v_7204;
...
v_7203:
    fn = elt(env, 6); // nth
    v_7257 = (*qfn2(fn))(fn, v_7258, v_7257);
    env = stack[-5];
    v_7257 = ncons(v_7257);
    env = stack[-5];
    stack[-1] = v_7257;
...
v_7234:
    goto v_7235;
v_7236:
    v_7257 = Lrplacd(nil, stack[0], v_7257);
    env = stack[-5];
    v_7257 = stack[-1];
    v_7257 = qcdr(v_7257);
    stack[-1] = v_7257;
...
setup_type const u13_setup[] =
{
    ...
    {NULL, (one_args *)"u13", (two_args *)"103817 7299068 970137", 0}
};
