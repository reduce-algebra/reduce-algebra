...
v_60:
    ...
    env = stack[-9];
    v_161 = (LispObject)(std::intptr_t)((std::intptr_t)stack[0] - (std::intptr_t)v_161 + TAG_FIXNUM);
    goto v_59;
v_61:
    v_161 = stack[-8];
    {   LispObject fn = basic_elt(env, 4); // ibalp_arg2l
...
v_9:
    ...
    v_49 = (LispObject)((std::intptr_t)(v_49) + 0x10);
    setvalue(basic_elt(env, 1), v_49); // unidev_next!*
    goto v_7;
v_7:
...
v_18:
    ...
    env = stack[-1];
    v_49 = (LispObject)(std::intptr_t)((std::intptr_t)stack[0] - (std::intptr_t)v_49 + TAG_FIXNUM);
    stack[0] = v_49;
    v_49 = stack[0];
    v_49 = ((std::intptr_t)(v_49) < 0 ? lisp_true : nil);
    if (v_49 == nil) goto v_38;
    v_50 = stack[0];
    v_49 = qvalue(basic_elt(env, 4)); // randommodulus!*
    v_49 = (LispObject)(std::intptr_t)((std::intptr_t)v_50 + (std::intptr_t)v_49 - TAG_FIXNUM);
    stack[0] = v_49;
    goto v_36;
v_38:
v_36:
...
v_7:
    ...
    v_35 = car(v_35);
    if (((std::intptr_t)(v_38)) < ((std::intptr_t)(v_35))) goto v_19;
    v_35 = v_37;
...
v_23:
    ...
    if (v_241 == nil) goto v_34;
    v_241 = stack[-1];
    {   LispObject fn = basic_elt(env, 1); // ibalp_getnewwl
...
setup_type const u19_setup[] =
{
    ...
    {NULL, (no_args *)"u19", (one_arg *)"6207 9669746 4282776",
        NULL, NULL, NULL}
};
