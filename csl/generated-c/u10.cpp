...
{
    env = qenv(env);
    LispObject v_5194, v_5195, v_5196;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_5143:
    ...
    v_5194 = (*qfn2(fn))(fn, stack[0], v_5194);
    env = stack[-2];
    goto v_5135;
v_5137:
v_5135:
    v_5195 = v_5194;
    if (symbolp(v_5195)) goto v_5150;
    else goto v_5151;
v_5150:
    v_5195 = v_5194;
    goto v_5149;
...
v_5174:
    goto v_5175;
v_5176:
    v_5195 = Lassoc(nil, v_5195, v_5194);
    v_5194 = v_5195;
    if (v_5195 == nil) goto v_5172;
    v_5194 = qcdr(v_5194);
    goto v_5133;
v_5172:
    goto v_5189;
...
v_5186:
    goto v_5187;
v_5188:
    v_5194 = Lassoc(nil, v_5194, v_5195);
    v_5194 = qcdr(v_5194);
    goto v_5133;
    v_5194 = nil;
v_5133:
    return onevalue(v_5194);
}
...
{
    env = qenv(env);
    LispObject v_5332, v_5333, v_5334;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_5143:
    v_5332 = stack[-2];
    v_5332 = qcar(v_5332);
    v_5332 = (consp(v_5332) ? nil : lisp_true);
    goto v_5141;
    v_5332 = nil;
v_5141:
    if (v_5332 == nil) goto v_5139;
    goto v_5156;
v_5152:
    v_5333 = stack[-2];
    goto v_5153;
v_5154:
    v_5332 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_5155;
v_5156:
    goto v_5152;
v_5153:
...
v_5178:
    goto v_5179;
v_5180:
    if (equal(v_5333, v_5332)) goto v_5176;
    goto v_5191;
v_5187:
    v_5332 = stack[-1];
    v_5332 = qcar(v_5332);
...
v_5190:
    fn = elt(env, 1); // ordop
    v_5332 = (*qfn2(fn))(fn, v_5333, v_5332);
    env = stack[-4];
    goto v_5174;
v_5176:
    v_5332 = nil;
...
v_5217:
    goto v_5218;
v_5219:
    v_5332 = CC_sfto_qsub1(elt(env, 0), v_5333, v_5332);
    env = stack[-4];
    stack[-3] = v_5332;
    goto v_5232;
v_5228:
...
v_5271:
    fn = elt(env, 3); // multsq
    v_5333 = (*qfn2(fn))(fn, v_5333, v_5332);
    env = stack[-4];
    goto v_5263;
v_5264:
    v_5332 = stack[-3];
...
v_5265:
    {
        fn = elt(env, 4); // addsq
        return (*qfn2(fn))(fn, v_5333, v_5332);
    }
v_5227:
    goto v_5281;
v_5277:
...
v_5290:
    goto v_5291;
v_5292:
    v_5332 = acons(v_5334, v_5333, v_5332);
    env = stack[-4];
    goto v_5322;
v_5318:
    goto v_5328;
...
setup_type const u10_setup[] =
{
    ...
    {NULL, (one_args *)"u10", (two_args *)"36520 1607368 1902195", 0}
};
