...
v_8:
    ...
    env = stack[-2];
    qvalue(basic_elt(env, 5)) = v_56; // pline!*
    v_56 = stack[0];
    qvalue(basic_elt(env, 3)) = v_56; // posn!*
    goto v_6;
    v_56 = nil;
v_6:
...
// end of prologue
    ...
    v_86 = add1(v_85);
    env = stack[-5];
    qvalue(basic_elt(env, 1)) = v_86; // simpcount!*
    ...
    qvalue(basic_elt(env, 1)) = v_85; // simpcount!*
...
v_42:
    ...
    v_58 = cons(v_59, v_58);
    env = stack[-1];
    qvalue(basic_elt(env, 4)) = v_58; // globs!*
    goto v_41;
v_43:
    v_58 = nil;
v_41:
