...
v_35:
    ...
    v_101 = car(v_100);
    v_100 = stack[-5];
    v_102 = (LispObject)(std::intptr_t)((std::intptr_t)v_101 + (std::intptr_t)v_100 - TAG_FIXNUM);
    v_100 = stack[0];
    if (!car_legal(v_100)) v_100 = carerror(v_100); else
    v_100 = car(v_100);
    if (!car_legal(v_100)) v_100 = carerror(v_100); else
    ...
    v_101 = cdr(v_100);
    v_100 = stack[-5];
    v_100 = (LispObject)(std::intptr_t)((std::intptr_t)v_101 + (std::intptr_t)v_100 - TAG_FIXNUM);
    ...
    v_101 = cdr(v_100);
    v_100 = stack[-4];
    v_101 = (LispObject)(std::intptr_t)((std::intptr_t)v_101 + (std::intptr_t)v_100 - TAG_FIXNUM);
    v_100 = stack[0];
...
v_14:
    ...
    if (!car_legal(v_43)) v_43 = carerror(v_43); else
    v_43 = car(v_43);
    v_43 = (LispObject)(std::intptr_t)((std::intptr_t)v_44 + (std::intptr_t)v_43 - TAG_FIXNUM);
    v_44 = v_45;
    v_43 = cons(v_43, v_44);
    env = stack[-2];
    v_45 = v_43;
...
v_15:
    ...
    if (!car_legal(v_35)) v_35 = carerror(v_35); else
    v_35 = car(v_35);
    if (((std::intptr_t)(v_34)) < ((std::intptr_t)(v_35))) goto v_24;
    else goto v_25;
v_24:
...
v_9:
    ...
    if (((std::intptr_t)(v_38)) < ((std::intptr_t)(v_37))) goto v_18;
    else goto v_19;
v_18:
    v_37 = nil;
    goto v_8;
...
setup_type const u04_setup[] =
{
    ...
    {NULL, (no_args *)"u04", (one_arg *)"149921 2758918 4609330",
        NULL, NULL, NULL}
};
