...
{
    env = qenv(env);
    LispObject v_1254, v_1255, v_1256;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_1123:
    v_1254 = stack[0];
    if (!consp(v_1254)) goto v_1126;
    else goto v_1127;
v_1126:
    v_1254 = stack[0];
    if (symbolp(v_1254)) goto v_1132;
    v_1254 = stack[0];
    if (is_number(v_1254)) goto v_1137;
    v_1254 = stack[0];
    {
        fn = elt(env, 5); // getrtype1
        return (*qfn1(fn))(fn, v_1254);
    }
v_1137:
    v_1254 = nil;
    goto v_1135;
...
v_1132:
    v_1254 = stack[0];
    if (!symbolp(v_1254)) v_1254 = nil;
    else { v_1254 = qfastgets(v_1254);
           if (v_1254 != nil) { v_1254 = elt(v_1254, 17); // share
#ifdef RECORD_GET
             if (v_1254 == SPID_NOPROP)
...
#else
             if (v_1254 == SPID_NOPROP) v_1254 = nil; else v_1254 = lisp_true; }}
#endif
    if (v_1254 == nil) goto v_1145;
    goto v_1156;
v_1152:
    v_1254 = stack[0];
    fn = elt(env, 6); // eval
    v_1255 = (*qfn1(fn))(fn, v_1254);
    env = stack[-1];
    v_1256 = v_1255;
    goto v_1153;
v_1154:
...
v_1145:
    ...
    if (!symbolp(v_1254)) v_1254 = nil;
           ...
           if (v_1254 != nil) { v_1254 = elt(v_1254, 4); // avalue
#ifdef RECORD_GET
             if (v_1254 != SPID_NOPROP)
...
#else
             if (v_1254 == SPID_NOPROP) v_1254 = nil; }}
#endif
    v_1256 = v_1254;
    if (v_1254 == nil) goto v_1167;
    goto v_1176;
v_1172:
    v_1254 = v_1256;
    v_1255 = qcar(v_1254);
    goto v_1173;
v_1174:
    v_1254 = elt(env, 1); // (scalar generic)
    goto v_1175;
v_1176:
    goto v_1172;
v_1173:
    goto v_1174;
v_1175:
    v_1254 = Lmemq(nil, v_1255, v_1254);
    if (v_1254 == nil) goto v_1171;
    else goto v_1167;
v_1171:
    goto v_1165;
v_1167:
    ...
    if (!symbolp(v_1254)) v_1254 = nil;
           ...
           if (v_1254 != nil) { v_1254 = elt(v_1254, 2); // rtype
#ifdef RECORD_GET
             if (v_1254 != SPID_NOPROP)
...
v_1165:
    ...
    if (!symbolp(v_1254)) v_1254 = nil;
           ...
           if (v_1254 != nil) { v_1254 = elt(v_1254, 19); // rtypefn
#ifdef RECORD_GET
             if (v_1254 != SPID_NOPROP)
...
v_1197:
    goto v_1198;
v_1199:
        return Lapply1(nil, v_1255, v_1254);
v_1191:
    v_1254 = v_1256;
    v_1254 = qcar(v_1254);
    goto v_1189;
...
v_1127:
    v_1254 = stack[0];
    v_1254 = qcar(v_1254);
    if (symbolp(v_1254)) goto v_1211;
    v_1254 = nil;
    goto v_1121;
v_1211:
    v_1254 = stack[0];
    fn = elt(env, 7); // physopp!*
    v_1254 = (*qfn1(fn))(fn, v_1254);
    env = stack[-1];
    if (v_1254 == nil) goto v_1216;
    v_1254 = elt(env, 2); // physop
    goto v_1121;
v_1216:
    v_1254 = stack[0];
    v_1254 = qcar(v_1254);
...
v_1242:
    goto v_1243;
v_1244:
    if (v_1255 == v_1254) goto v_1239;
    else goto v_1240;
v_1239:
    v_1254 = elt(env, 4); // yetunknowntype
    goto v_1121;
v_1240:
    v_1254 = stack[0];
    {
...
{
    env = qenv(env);
    LispObject v_1336, v_1337, v_1338;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_1138:
    ...
    goto v_1139;
v_1140:
    v_1336 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_1141;
v_1142:
    goto v_1138;
v_1139:
    goto v_1140;
v_1141:
    v_1338 = *(LispObject *)((char *)v_1337 + (CELL-TAG_VECTOR) + (((intptr_t)v_1336-TAG_FIXNUM)/(16/CELL)));
    goto v_1134;
v_1135:
    goto v_1150;
v_1146:
...
v_1147:
    goto v_1148;
v_1149:
    v_1336 = *(LispObject *)((char *)v_1337 + (CELL-TAG_VECTOR) + (((intptr_t)v_1336-TAG_FIXNUM)/(16/CELL)));
    goto v_1136;
v_1137:
    goto v_1133;
v_1134:
    goto v_1135;
v_1136:
    if (equal(v_1338, v_1336)) goto v_1131;
    else goto v_1132;
v_1131:
    goto v_1159;
v_1155:
...
v_1160:
    ...
    goto v_1161;
v_1162:
    v_1336 = (LispObject)32+TAG_FIXNUM; // 2
    goto v_1163;
v_1164:
    goto v_1160;
v_1161:
...
v_1158:
    ...
    v_1336 = (*qfn2(fn))(fn, v_1338, v_1336);
    env = stack[-4];
    goto v_1130;
v_1132:
    v_1336 = nil;
...
v_1188:
    ...
    goto v_1189;
v_1190:
    v_1336 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_1191;
v_1192:
    goto v_1188;
v_1189:
...
v_1216:
    ...
    goto v_1217;
v_1218:
    v_1336 = (LispObject)48+TAG_FIXNUM; // 3
    goto v_1219;
v_1220:
    goto v_1216;
v_1217:
...
v_1232:
    ...
    goto v_1233;
v_1234:
    v_1337 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_1235;
v_1236:
    goto v_1237;
v_1238:
...
v_1235:
    goto v_1236;
v_1237:
    *(LispObject *)((char *)v_1338 + (CELL-TAG_VECTOR) + (((intptr_t)v_1337-TAG_FIXNUM)/(16/CELL))) = v_1336;
    goto v_1248;
v_1242:
    stack[-3] = stack[-2];
    goto v_1243;
...
v_1253:
    goto v_1254;
v_1255:
    v_1336 = CC_fsTplus(elt(env, 0), v_1338, v_1336);
    goto v_1247;
v_1248:
    goto v_1242;
v_1243:
...
v_1245:
    goto v_1246;
v_1247:
    *(LispObject *)((char *)stack[-3] + (CELL-TAG_VECTOR) + (((intptr_t)stack[0]-TAG_FIXNUM)/(16/CELL))) = v_1336;
    v_1336 = stack[-2];
    goto v_1118;
v_1128:
    goto v_1281;
...
v_1280:
    ...
    v_1336 = (*qfn2(fn))(fn, v_1337, v_1336);
    env = stack[-4];
    if (v_1336 == nil) goto v_1275;
    goto v_1290;
v_1284:
    stack[-3] = stack[-2];
    goto v_1285;
...
v_1300:
    goto v_1301;
v_1302:
    v_1337 = *(LispObject *)((char *)v_1337 + (CELL-TAG_VECTOR) + (((intptr_t)v_1336-TAG_FIXNUM)/(16/CELL)));
    goto v_1295;
v_1296:
    v_1336 = stack[-1];
    goto v_1297;
...
v_1295:
    goto v_1296;
v_1297:
    v_1336 = CC_fsTplus(elt(env, 0), v_1337, v_1336);
    goto v_1289;
v_1290:
    goto v_1284;
v_1285:
...
v_1121:
    fn = elt(env, 1); // mo!=sum
    v_1138 = (*qfn2(fn))(fn, v_1139, v_1138);
    env = stack[-2];
    stack[-1] = v_1138;
    goto v_1133;
v_1129:
    ...
    stack[0] = (*qfn1(fn))(fn, v_1138);
    env = stack[-2];
    goto v_1130;
v_1131:
    v_1138 = stack[-1];
    fn = elt(env, 3); // mo!=deglist
    v_1138 = (*qfn1(fn))(fn, v_1138);
    goto v_1132;
v_1133:
    goto v_1129;
v_1130:
...
v_1132:
    {
        LispObject v_1142 = stack[0];
        return cons(v_1142, v_1138);
    }
}
...
setup_type const u04_setup[] =
{
    ...
    {NULL, (one_args *)"u04", (two_args *)"152425 6439266 1550391", 0}
};
