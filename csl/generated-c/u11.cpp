...
v_5422:
    v_5537 = stack[0];
    v_5537 = integerp(v_5537);
    if (v_5537 == nil) goto v_5425;
    else goto v_5426;
v_5425:
    goto v_5434;
v_5430:
...
v_5433:
    {
        fn = elt(env, 6); // typerr
        return (*qfn2(fn))(fn, v_5538, v_5537);
    }
v_5426:
    goto v_5444;
v_5440:
    ...
    goto v_5441;
v_5442:
    v_5537 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_5443;
v_5444:
    goto v_5440;
v_5441:
    goto v_5442;
v_5443:
    v_5537 = (LispObject)lessp2(v_5538, v_5537);
    v_5537 = v_5537 ? lisp_true : nil;
    env = stack[-2];
    if (v_5537 == nil) goto v_5438;
    v_5537 = stack[0];
    v_5537 = negate(v_5537);
    env = stack[-2];
    stack[0] = v_5537;
    goto v_5422;
v_5438:
...
v_5451:
    ...
    goto v_5452;
v_5453:
    v_5537 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_5454;
v_5455:
    goto v_5451;
v_5452:
...
v_5462:
    ...
    goto v_5463;
v_5464:
    v_5537 = qvalue(elt(env, 2)); // !*last!-prime!-in!-list!*
    goto v_5465;
v_5466:
    goto v_5462;
v_5463:
    goto v_5464;
v_5465:
    v_5537 = (LispObject)lesseq2(v_5538, v_5537);
    v_5537 = v_5537 ? lisp_true : nil;
    env = stack[-2];
    if (v_5537 == nil) goto v_5460;
    goto v_5473;
v_5469:
    v_5537 = stack[0];
    goto v_5470;
v_5471:
    v_5538 = qvalue(elt(env, 3)); // !*primelist!*
    goto v_5472;
v_5473:
    goto v_5469;
v_5470:
    goto v_5471;
v_5472:
    v_5537 = Lmember(nil, v_5537, v_5538);
    goto v_5421;
v_5460:
    goto v_5484;
v_5480:
    ...
    goto v_5481;
v_5482:
    v_5537 = qvalue(elt(env, 4)); // !*last!-prime!-squared!*
    goto v_5483;
v_5484:
    goto v_5480;
v_5481:
...
v_5483:
    ...
    v_5537 = v_5537 ? lisp_true : nil;
    env = stack[-2];
    if (v_5537 == nil) goto v_5478;
    v_5537 = qvalue(elt(env, 3)); // !*primelist!*
    stack[-1] = v_5537;
v_5493:
    v_5537 = stack[-1];
    if (v_5537 == nil) goto v_5496;
    goto v_5505;
v_5501:
    goto v_5511;
v_5507:
...
v_5508:
    goto v_5509;
v_5510:
    v_5538 = Cremainder(v_5538, v_5537);
    env = stack[-2];
    goto v_5502;
v_5503:
    v_5537 = (LispObject)0+TAG_FIXNUM; // 0
...
v_5492:
    v_5537 = stack[-1];
    v_5537 = (v_5537 == nil ? lisp_true : nil);
    goto v_5421;
v_5478:
    goto v_5528;
v_5524:
    ...
    goto v_5525;
v_5526:
    v_5537 = qvalue(elt(env, 5)); // largest!-small!-modulus
    goto v_5527;
v_5528:
    goto v_5524;
v_5525:
    goto v_5526;
v_5527:
    v_5537 = (LispObject)greaterp2(v_5538, v_5537);
    v_5537 = v_5537 ? lisp_true : nil;
    env = stack[-2];
    if (v_5537 == nil) goto v_5522;
    v_5537 = stack[0];
    {
        fn = elt(env, 7); // general!-primep
        return (*qfn1(fn))(fn, v_5537);
    }
v_5522:
    v_5537 = stack[0];
    {
...
v_5478:
    goto v_5479;
v_5480:
    v_5555 = list2star(stack[-2], v_5556, v_5555);
    goto v_5429;
v_5455:
    goto v_5499;
v_5495:
    v_5556 = qvalue(elt(env, 1)); // d
    goto v_5496;
v_5497:
    v_5555 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_5498;
...
v_5506:
    goto v_5507;
v_5508:
    v_5555 = list2star(stack[-4], v_5556, v_5555);
    goto v_5429;
v_5493:
    goto v_5536;
v_5530:
...
setup_type const u11_setup[] =
{
    ...
    {NULL, (one_args *)"u11", (two_args *)"123008 1657306 12680", 0}
};
