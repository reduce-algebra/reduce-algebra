...
v_142:
    ...
    if (!car_legal(v_165)) v_166 = carerror(v_165); else
    v_166 = car(v_165);
    v_165 = (LispObject)0+TAG_FIXNUM; // 0
    {   LispObject fn = basic_elt(env, 0); // ioto_form2str1
    v_165 = (*qfn3(fn))(fn, v_167, v_166, v_165);
    }
    env = stack[-7];
...
v_77:
    ...
    env = stack[-11];
    if (((std::intptr_t)(stack[-4])) < ((std::intptr_t)(v_210))) goto v_84;
    else goto v_80;
v_84:
    goto v_81;
v_80:
...
v_177:
    v_210 = stack[0];
    v_210 = (LispObject)((std::intptr_t)(v_210) + 0x10);
    stack[0] = v_210;
    v_210 = stack[-8];
    if (!car_legal(v_210)) v_211 = cdrerror(v_210); else
    v_211 = cdr(v_210);
...
v_34:
    ...
    v_210 = stack[0];
    v_210 = (LispObject)(std::intptr_t)((std::intptr_t)v_211 + (std::intptr_t)v_210 - TAG_FIXNUM);
...
setup_type const u27_setup[] =
{
    ...
    {NULL, (no_args *)"u27", (one_arg *)"91454 2881423 1711328",
        NULL, NULL, NULL}
};
