...
v_9:
    ...
    if (!car_legal(v_24)) v_24 = cdrerror(v_24); else
    v_24 = cdr(v_24);
    v_26 = (LispObject)((std::intptr_t)(v_26) + 0x10);
...
v_90:
    ...
    v_234 = stack[-6];
    v_233 = stack[-5];
    v_233 = (LispObject)(std::intptr_t)((std::intptr_t)v_234 - (std::intptr_t)v_233 + TAG_FIXNUM);
    stack[0] = v_233;
    v_234 = stack[0];
...
v_130:
    ...
    v_233 = stack[0];
    v_233 = (LispObject)(std::intptr_t)((std::intptr_t)v_234 - (std::intptr_t)v_233 + TAG_FIXNUM);
    v_233 = (LispObject)((std::intptr_t)(v_233) - 0x10);
