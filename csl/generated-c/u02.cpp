...
// end of prologue
    ...
    v_472 = stack[-3];
    fn = elt(env, 1); // unpkp
    v_472 = (*qfn1(fn))(fn, v_472);
    env = stack[-5];
    stack[-3] = v_472;
v_425:
    v_472 = stack[-3];
    if (v_472 == nil) goto v_428;
    else goto v_429;
v_428:
    goto v_424;
v_429:
    v_472 = stack[-2];
    stack[-1] = v_472;
    v_472 = (LispObject)16+TAG_FIXNUM; // 1
    stack[0] = v_472;
v_436:
    goto v_448;
v_444:
...
v_445:
    goto v_446;
v_447:
    v_472 = difference2(v_473, v_472);
    env = stack[-5];
    v_472 = Lminusp(nil, v_472);
    env = stack[-5];
    if (v_472 == nil) goto v_441;
    goto v_435;
v_441:
    v_472 = stack[-1];
    v_472 = qcdr(v_472);
...
v_424:
    v_472 = stack[-4];
        return Lnreverse(nil, v_472);
    return onevalue(v_472);
}
...
v_418:
    ...
    goto v_419;
v_420:
    v_432 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_421;
v_422:
    goto v_418;
v_419:
...
v_426:
    goto v_427;
v_428:
    v_455 = times2(v_455, v_454);
    env = stack[-1];
    goto v_420;
v_421:
    v_454 = qvalue(elt(env, 1)); // current!-modulus
    goto v_422;
v_423:
    goto v_419;
v_420:
...
v_438:
    ...
    goto v_439;
v_440:
    v_454 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_441;
v_442:
    goto v_438;
v_439:
    goto v_440;
v_441:
    v_454 = (LispObject)lessp2(v_455, v_454);
    v_454 = v_454 ? lisp_true : nil;
    env = stack[-1];
    if (v_454 == nil) goto v_436;
    goto v_450;
v_446:
    v_455 = stack[0];
    goto v_447;
...
v_418:
    v_497 = stack[-1];
    if (v_497 == nil) goto v_421;
    else goto v_422;
v_421:
    v_497 = stack[-3];
    {
        fn = elt(env, 1); // nreverse
        return (*qfn1(fn))(fn, v_497);
    }
v_422:
    goto v_432;
v_428:
    ...
    goto v_429;
v_430:
    v_497 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_431;
v_432:
    goto v_428;
v_429:
...
v_439:
    {
        fn = elt(env, 1); // nreverse
        return (*qfn2(fn))(fn, v_498, v_497);
    }
v_427:
    v_497 = stack[-1];
    if (!consp(v_497)) goto v_447;
    else goto v_448;
v_447:
    v_497 = lisp_true;
    goto v_446;
v_448:
    v_497 = stack[-1];
    v_497 = qcar(v_497);
    v_497 = (consp(v_497) ? nil : lisp_true);
    goto v_446;
    v_497 = nil;
v_446:
    if (v_497 == nil) goto v_444;
    goto v_461;
v_457:
    stack[0] = stack[-3];
    goto v_458;
...
v_460:
    {
        LispObject v_503 = stack[0];
        fn = elt(env, 1); // nreverse
        return (*qfn2(fn))(fn, v_503, v_497);
    }
v_444:
    goto v_480;
v_474:
...
v_486:
    goto v_487;
v_488:
    v_498 = CC_multd(elt(env, 0), v_498, v_497);
    env = stack[-4];
    goto v_477;
v_478:
    v_497 = stack[-3];
...
v_477:
    goto v_478;
v_479:
    v_497 = acons(stack[0], v_498, v_497);
    env = stack[-4];
    stack[-3] = v_497;
    v_497 = stack[-1];
    v_497 = qcdr(v_497);
...
v_455:
    goto v_456;
v_457:
    if (equal(v_498, v_497)) goto v_453;
    else goto v_449;
v_453:
    goto v_450;
v_449:
...
v_467:
    goto v_468;
v_469:
    v_497 = list2star(v_499, v_498, v_497);
    env = stack[-3];
    stack[-1] = v_497;
v_478:
    v_497 = stack[-2];
    if (v_497 == nil) goto v_481;
    else goto v_482;
v_481:
    goto v_477;
v_482:
...
v_416:
    goto v_417;
v_418:
    v_422 = cons(v_423, v_422);
    env = stack[0];
    qvalue(elt(env, 1)) = v_422; // outl!*
    return onevalue(v_422);
}
...
v_428:
    v_476 = stack[-1];
    v_476 = qcar(v_476);
    v_476 = (consp(v_476) ? nil : lisp_true);
    goto v_426;
    v_476 = nil;
v_426:
    if (v_476 == nil) goto v_424;
    goto v_419;
v_424:
    goto v_441;
v_437:
...
v_445:
    ...
    v_476 = qcar(v_476);
    v_476 = qcdr(v_476);
    v_476 = CC_reorder(elt(env, 0), v_476);
    env = stack[-3];
    goto v_446;
v_447:
    goto v_443;
...
v_446:
    ...
    v_477 = (*qfn2(fn))(fn, stack[0], v_476);
    env = stack[-3];
    goto v_438;
v_439:
    v_476 = stack[-2];
...
v_429:
    ...
    goto v_430;
v_431:
    v_457 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_432;
v_433:
    goto v_429;
v_430:
...
v_425:
    goto v_426;
v_427:
    if (v_490 == v_489) goto v_422;
    else goto v_423;
v_422:
    v_489 = elt(env, 1); // (!:rd!: 0 . 0)
    goto v_418;
v_423:
    goto v_443;
v_439:
...
v_440:
    goto v_441;
v_442:
    v_489 = (LispObject)lessp2(v_490, v_489);
    v_489 = v_489 ? lisp_true : nil;
    env = stack[-4];
    if (v_489 == nil) goto v_437;
    v_489 = stack[0];
    v_489 = negate(v_489);
    env = stack[-4];
    stack[0] = v_489;
...
v_456:
    fn = elt(env, 4); // lshift
    v_489 = (*qfn2(fn))(fn, stack[0], v_489);
    env = stack[-4];
    stack[0] = v_489;
    v_489 = stack[-3];
    if (v_489 == nil) goto v_464;
    v_489 = stack[0];
    v_489 = negate(v_489);
    env = stack[-4];
    stack[0] = v_489;
...
v_482:
    goto v_483;
v_484:
    return list2star(v_491, v_490, v_489);
v_418:
...
setup_type const u02_setup[] =
{
    ...
    {NULL, (one_args *)"u02", (two_args *)"55344 6244243 3559147", 0}
};
