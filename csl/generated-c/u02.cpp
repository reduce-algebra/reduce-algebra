...
// copy arguments values to proper place
    stack[-2] = v_412;
// end of prologue
    v_518 = qvalue(elt(env, 1)); // !*mcd
    if (v_518 == nil) goto v_417;
    v_518 = stack[-2];
    v_518 = qcar(v_518);
    v_518 = qcar(v_518);
    v_518 = qcdr(v_518);
...
v_453:
    goto v_454;
v_455:
    return difference2(v_519, v_518);
v_448:
    v_518 = stack[-2];
    v_518 = qcdr(v_518);
    stack[-2] = v_518;
...
v_474:
    fn = elt(env, 2); // degr
    v_519 = (*qfn2(fn))(fn, v_519, v_518);
    env = stack[-4];
    goto v_466;
v_467:
    v_518 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_468;
v_469:
    goto v_465;
v_466:
...
v_485:
    goto v_486;
v_487:
    v_518 = (LispObject)lessp2(v_519, v_518);
    v_518 = v_518 ? lisp_true : nil;
    env = stack[-4];
    if (v_518 == nil) goto v_482;
    goto v_500;
v_496:
    v_519 = stack[-1];
    goto v_497;
...
setup_type const u02_setup[] =
{
    ...
    {NULL, (one_args *)"u02", (two_args *)"179582 2818616 7961136", 0}
};
