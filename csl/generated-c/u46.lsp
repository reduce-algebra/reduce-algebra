...
(c!:install "u46" 5808 2688661 8897023)
...
(c!:install 'ps!:minus!-erule '(ps!:minus!-erule ps!:evaluate negf) 
2176247472939113788)
...
(c!:install 'monic '(monic varlist nil pnth) 724382444468420389)
...
(c!:install 'spreadvar '(spreadvar t nil) 1315793914099604026)
...
(c!:install '!*addsq '(!*addsq nil addf gcdf quotf !*multf minusf negf) 
1765611115389057262)
...
(c!:install 'ldf!-pow!-var '(ldf!-pow!-var nil x t u kernels1 makeset
prlist) 1362853555100136610)
...
(c!:install 'declared!-as!-float '(declared!-as!-float nil (real real!*8
real!*16 double! precision double float) symtabget) 196461025176138892)
...
(logical equation scalar slprog) avalue true t false "unbound id" typerr
rl_gettype rl_simp1 eval) 2023465486567624943)

(c!:install 'deleteq '(deleteq nreverse) 359739596230945015)

(c!:install 'ioto_tprin2 '(ioto_tprin2 t nil ioto_prin21) 
990400564676560741)

(c!:install 'qqe_length!-graph!-neighbors '(qqe_length!-graph!-neighbors
neighbors) 2099577505291858263)

(c!:install 'iv_cutn '(iv_cutn iv_cut) 1989136692138295685)

(c!:install 'bc_dcont '(bc_dcont sfto_dcontentf) 756698739986786000)

(c!:install 'subeval '(subeval sublist!* sub psopfn subeval0 t errmsg!*
!*protfg errorset2 lprie) 1920205474576675819)
...
(c!:install 'contain_edge '(contain_edge nil) 793679443988243505)
...
(c!:install 'legendre!-symbol '(legendre!-symbol general!-modular!-expt)
 2147372502581689754)

(c!:install 'flatten '(flatten nreverse) 2068086728564921560)
