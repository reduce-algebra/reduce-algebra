...
(c!:install 'pasf_varlat '(pasf_varlat nil (cong ncong) kernels1) 
535608604285588988)

(c!:install 'cl_qb '(cl_qb ex t all nil) 572864694906074195)

(c!:install 'reln '(reln "<reln>" "<" "/>" indent "</reln>" printout
multi_elem) 598879977148421573)

(c!:install 'ps!:expansion!-point '(ps!:expansion!-point t !:ps!: dname
...
(c!:install 'powers4 '(powers4 nil ordop nreverse) 1447856910578025462)
...
(c!:install 'horner!-rule!-mod!-p '(horner!-rule!-mod!-p t expt!-mod!-p
times!-mod!-p plus!-mod!-p) 1740900463840102401)
...
(c!:install 'makeset '(makeset nreverse) 1884329122636588725)
...
(c!:install 'mkfortterpri '(mkfortterpri fortterpri) 2152033502534402473
)

(c!:install 'can_be_proved '(can_be_proved t nil can_be_p) 
1823554227941724129)

(c!:install 'assert_stat1 '(assert_stat1 !*lpar!* !*protfg
"expecting '(' in assert but found" cursym!* !*rpar!* nil !*comma!*
"expecting ',' or ')' in assert but found" scan lprie) 
432448490698844953)
