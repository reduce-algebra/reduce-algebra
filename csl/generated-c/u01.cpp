...
// copy arguments values to proper place
    ...
    stack[-1] = v_2;
// end of prologue
    v_79 = qvalue(elt(env, 1)); // !*rlsetequalqhash
...
v_34:
    goto v_35;
v_36:
    fn = elt(env, 3); // lto_equallengthp
    v_79 = (*qfn2(fn))(fn, v_80, v_79);
    goto v_18;
    v_79 = nil;
v_18:
    if (v_79 == nil) goto v_42;
    else goto v_43;
v_42:
    v_79 = nil;
    goto v_14;
...
v_66:
    goto v_67;
v_68:
    v_79 = Lmemq(nil, v_80, v_79);
    if (v_79 == nil) goto v_64;
    v_79 = stack[-1];
    v_79 = qcdr(v_79);
    stack[-1] = v_79;
    goto v_62;
...
v_37:
    ...
    env = stack[-5];
    v_62 = Lminusp(nil, v_62);
    env = stack[-5];
    if (v_62 == nil) goto v_31;
    goto v_25;
v_31:
    v_62 = stack[-1];
    v_62 = qcdr(v_62);
...
v_16:
    goto v_17;
v_18:
    v_45 = times2(v_45, v_44);
    env = stack[-1];
    goto v_10;
v_11:
    v_44 = qvalue(elt(env, 1)); // current!-modulus
    goto v_12;
v_13:
    goto v_9;
v_10:
...
v_29:
    goto v_30;
v_31:
    v_44 = (LispObject)lessp2(v_45, v_44);
    v_44 = v_44 ? lisp_true : nil;
    env = stack[-1];
    if (v_44 == nil) goto v_26;
    goto v_40;
v_36:
    v_45 = stack[0];
    goto v_37;
...
v_76:
    goto v_77;
v_78:
    v_88 = CC_multd(elt(env, 0), v_88, v_87);
    env = stack[-4];
    goto v_67;
v_68:
    v_87 = stack[-3];
...
v_35:
    ...
    v_66 = qcar(v_66);
    v_66 = qcdr(v_66);
    v_66 = CC_reorder(elt(env, 0), v_66);
    env = stack[-3];
    goto v_36;
v_37:
    goto v_33;
...
setup_type const u01_setup[] =
{
    ...
    {NULL, (one_args *)"u01", (two_args *)"60914 2431971 2153094", 0}
};
