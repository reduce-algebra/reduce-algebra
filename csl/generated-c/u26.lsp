...
(c!:install "u26" 19719 7347039 459492)

(c!:install 'even_action_sf '(even_action_sf nil t even_action_term
addsq) 1824923948319438346)
...
(c!:install 'gfplusn '(gfplusn plus!:) 1600263449506618359)
...
(c!:install 'xlcm '(xlcm t nreverse factorordp) 2249153980709617199)
...
union simp!-prop!-condense) 1194067773474340257)

(c!:install '!*di2q '(!*di2q varlist nil !*di2q0) 1525698544202413776)

(c!:install 'nonlnr '(nonlnr t nil freeofl) 1293286386168903876)
...
(c!:install 'degreef '(degreef t max) 775700285368193366)

(c!:install 'delyzz '(delyzz nreverse) 1011952312596623885)

(c!:install 'evgradlexcomp '(evgradlexcomp (0) evtdeg) 
714003899625466099)

(c!:install 'xriterion_1 '(xriterion_1 nil spoly_pair t !*trxideal
"criterion 1 hit" last xval xdiv make_spoly_pair find_item eval assgnpri
) 276277123200283767)
...
(c!:install 'reduce!-eival!-powers '(reduce!-eival!-powers t
reduce!-eival!-powers1) 1004571763845761581)

(c!:install 'sfto_pdecf '(sfto_pdecf t sfto_ucontentf quotf sfto_updecf
multf) 262023120864465302)
...
(c!:install 'groebbuchcrit4t '(groebbuchcrit4t t nil) 
1891561699459897791)
...
(c!:install 'simp!-prop!-condense '(simp!-prop!-condense lambda_lqlbvd_6
nil sort subsetp ordn) 1204953500892987875)

(c!:install 'lambda_lqlbvd_6 '(lambda_lqlbvd_6) 307878790741860357)
