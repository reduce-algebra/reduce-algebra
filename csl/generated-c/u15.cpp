...
v_7997:
    fn = elt(env, 1); // setcar
    v_8191 = (*qfn2(fn))(fn, stack[0], v_8191);
    env = stack[-6];
    goto v_8016;
v_8012:
    v_8191 = stack[-1];
...
v_8133:
    fn = elt(env, 3); // delq
    v_8191 = (*qfn2(fn))(fn, v_8192, v_8191);
    env = stack[-6];
    goto v_8116;
v_8117:
    goto v_8113;
...
static LispObject CC_ofsf_pow2q(LispObject env,
                         LispObject v_7952, LispObject v_7953)
{
    env = qenv(env);
    LispObject v_7984, v_7985, v_7986;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_7977:
    fn = elt(env, 2); // to
    v_7985 = (*qfn2(fn))(fn, v_7985, v_7984);
    env = stack[-1];
    goto v_7969;
v_7970:
    v_7984 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_7971;
v_7972:
    goto v_7968;
v_7969:
...
v_7963:
    goto v_7964;
v_7965:
    v_7984 = acons(v_7986, v_7985, v_7984);
...
// end of prologue
    fn = elt(env, 3); // dm!-abs
    v_8178 = (*qfn1(fn))(fn, v_8178);
    env = stack[-6];
    fn = elt(env, 4); // !:onep
    v_8178 = (*qfn1(fn))(fn, v_8178);
    env = stack[-6];
    if (v_8178 == nil) goto v_7956;
    else goto v_7957;
v_7956:
    goto v_7967;
v_7961:
...
v_7970:
    goto v_7979;
v_7975:
    v_8179 = qvalue(elt(env, 2)); // maxvar
    goto v_7976;
v_7977:
    v_8178 = stack[-4];
    goto v_7978;
...
v_7969:
    goto v_7970;
v_7971:
    stack[-5] = *(LispObject *)((char *)stack[0] + (CELL-TAG_VECTOR) + (((intptr_t)v_8178-TAG_FIXNUM)/(16/CELL)));
    goto v_7962;
v_7963:
...
v_7999:
    goto v_8000;
v_8001:
    v_8179 = *(LispObject *)((char *)stack[0] + (CELL-TAG_VECTOR) + (((intptr_t)v_8178-TAG_FIXNUM)/(16/CELL)));
    goto v_7994;
v_7995:
    v_8178 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_7996;
v_7997:
    goto v_7993;
v_7994:
    goto v_7995;
v_7996:
    v_8178 = *(LispObject *)((char *)v_8179 + (CELL-TAG_VECTOR) + (((intptr_t)v_8178-TAG_FIXNUM)/(16/CELL)));
    v_8178 = qcar(v_8178);
    v_8178 = qcar(v_8178);
    stack[-2] = sub1(v_8178);
    env = stack[-6];
...
v_8051:
    ...
    goto v_8044;
v_8045:
    v_8178 = (LispObject)64+TAG_FIXNUM; // 4
    goto v_8046;
v_8047:
    goto v_8043;
v_8044:
    goto v_8045;
v_8046:
    v_8178 = difference2(v_8179, v_8178);
    env = stack[-6];
    goto v_7990;
v_7991:
    goto v_7985;
...
v_7988:
    goto v_7989;
v_7990:
    v_8178 = acons(stack[-2], stack[-1], v_8178);
    goto v_7966;
v_7967:
    goto v_7961;
v_7962:
...
v_7964:
    goto v_7965;
v_7966:
    *(LispObject *)((char *)stack[-5] + (CELL-TAG_VECTOR) + (((intptr_t)stack[-3]-TAG_FIXNUM)/(16/CELL))) = v_8178;
    goto v_7955;
v_7957:
    goto v_8080;
v_8074:
...
v_7956:
    v_7995 = stack[0];
    if (is_number(v_7995)) goto v_7959;
    else goto v_7960;
v_7959:
    goto v_7968;
v_7964:
    ...
    goto v_7965;
v_7966:
    v_7995 = (LispObject)32+TAG_FIXNUM; // 2
    goto v_7967;
v_7968:
    goto v_7964;
v_7965:
...
v_7967:
    fn = elt(env, 1); // qremd
    v_7995 = (*qfn2(fn))(fn, v_7996, v_7995);
    env = stack[-2];
    v_7995 = qcdr(v_7995);
    {
        fn = elt(env, 2); // absf
        return (*qfn1(fn))(fn, v_7995);
    }
v_7960:
    goto v_7979;
v_7975:
...
v_7985:
    ...
    v_7995 = qcdr(v_7995);
    fn = elt(env, 2); // absf
    stack[-1] = (*qfn1(fn))(fn, v_7995);
    env = stack[-2];
    goto v_7976;
v_7977:
    v_7995 = stack[0];
    v_7995 = qcdr(v_7995);
    v_7995 = CC_evenfree(elt(env, 0), v_7995);
    env = stack[-2];
    goto v_7978;
v_7979:
    goto v_7975;
...
v_7978:
    {
        LispObject v_7999 = stack[-1];
        fn = elt(env, 3); // addf
        return (*qfn2(fn))(fn, v_7999, v_7995);
    }
    v_7995 = nil;
v_7954:
...
v_7957:
    ...
    goto v_7958;
v_7959:
    v_7965 = elt(env, 1); // !*fortranprecedence!*
    goto v_7960;
v_7961:
    goto v_7957;
v_7958:
    goto v_7959;
v_7960:
    v_7965 = get(v_7966, v_7965);
    if (v_7965 == nil) goto v_7955;
    else goto v_7954;
v_7955:
    v_7965 = (LispObject)144+TAG_FIXNUM; // 9
v_7954:
    return onevalue(v_7965);
}
...
v_7961:
    {
        LispObject v_7968 = stack[0];
        return cons(v_7968, v_7966);
    }
}
...
v_7957:
    goto v_7966;
v_7962:
    if (!symbolp(v_7975)) v_7975 = nil;
    else { v_7975 = qfastgets(v_7975);
           if (v_7975 != nil) { v_7975 = elt(v_7975, 32); // dummy
#ifdef RECORD_GET
             if (v_7975 != SPID_NOPROP)
                record_get(elt(fastget_names, 32), 1);
             else record_get(elt(fastget_names, 32), 0),
                v_7975 = nil; }
           else record_get(elt(fastget_names, 32), 0); }
#else
             if (v_7975 == SPID_NOPROP) v_7975 = nil; }}
#endif
    v_7975 = qcar(v_7975);
    goto v_7963;
v_7964:
    if (!symbolp(v_7974)) v_7974 = nil;
    else { v_7974 = qfastgets(v_7974);
           if (v_7974 != nil) { v_7974 = elt(v_7974, 32); // dummy
#ifdef RECORD_GET
             if (v_7974 != SPID_NOPROP)
                record_get(elt(fastget_names, 32), 1);
             else record_get(elt(fastget_names, 32), 0),
                v_7974 = nil; }
           else record_get(elt(fastget_names, 32), 0); }
#else
             if (v_7974 == SPID_NOPROP) v_7974 = nil; }}
#endif
    v_7974 = qcar(v_7974);
    goto v_7965;
v_7966:
...
v_7963:
    goto v_7964;
v_7965:
    v_7974 = (v_7975 == v_7974 ? lisp_true : nil);
    goto v_7955;
    v_7974 = nil;
v_7955:
    return onevalue(v_7974);
}
...
// copy arguments values to proper place
    v_8033 = v_7951;
// end of prologue
    v_8032 = (LispObject)0+TAG_FIXNUM; // 0
    stack[-1] = v_8032;
    v_8032 = (LispObject)0+TAG_FIXNUM; // 0
    stack[0] = v_8032;
    v_8032 = v_8033;
    fn = elt(env, 1); // ra_budan!-transform
    v_8032 = (*qfn1(fn))(fn, v_8032);
    env = stack[-4];
    stack[-3] = v_8032;
v_7967:
    v_8032 = stack[-3];
    if (v_8032 == nil) goto v_7970;
    else goto v_7971;
v_7970:
    goto v_7966;
v_7971:
    v_8032 = stack[-3];
    if (!consp(v_8032)) goto v_7980;
    else goto v_7981;
v_7980:
    v_8032 = lisp_true;
    goto v_7979;
...
v_7975:
    ...
    v_8032 = (*qfn1(fn))(fn, v_8032);
    env = stack[-4];
    if (v_8032 == nil) goto v_8001;
    v_8032 = (LispObject)-16+TAG_FIXNUM; // -1
    goto v_7999;
v_8001:
    v_8032 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_7999;
...
v_8014:
    goto v_8015;
v_8016:
    v_8032 = (LispObject)lessp2(v_8033, v_8032);
    v_8032 = v_8032 ? lisp_true : nil;
    env = stack[-4];
    if (v_8032 == nil) goto v_8011;
    v_8032 = stack[0];
    v_8032 = add1(v_8032);
    env = stack[-4];
    stack[0] = v_8032;
...
// end of prologue
    v_8049 = stack[0];
    v_8049 = Lalpha_char_p(nil, v_8049);
    env = stack[-1];
    if (v_8049 == nil) goto v_7955;
    else goto v_7954;
v_7955:
    v_8049 = stack[0];
    v_8049 = Ldigitp(nil, v_8049);
    env = stack[-1];
    if (v_8049 == nil) goto v_7960;
    else goto v_7959;
v_7960:
    goto v_7975;
v_7971:
...
v_7972:
    goto v_7973;
v_7974:
    if (v_8050 == v_8049) goto v_7969;
    else goto v_7970;
v_7969:
    goto v_7984;
v_7980:
    v_8050 = qvalue(elt(env, 2)); // lexer_style!*
    goto v_7981;
v_7982:
    v_8049 = (LispObject)262144+TAG_FIXNUM; // 16384
    goto v_7983;
v_7984:
    goto v_7980;
v_7981:
...
v_7983:
    ...
    env = stack[-1];
    v_8049 = (LispObject)zerop(v_8049);
    v_8049 = v_8049 ? lisp_true : nil;
    env = stack[-1];
    v_8049 = (v_8049 == nil ? lisp_true : nil);
    goto v_7968;
v_7970:
    v_8049 = nil;
    goto v_7968;
...
v_8011:
    ...
    goto v_8012;
v_8013:
    v_8049 = (LispObject)8388608+TAG_FIXNUM; // 524288
    goto v_8014;
v_8015:
    goto v_8011;
v_8012:
...
v_8038:
    ...
    goto v_8039;
v_8040:
    v_8049 = (LispObject)1048576+TAG_FIXNUM; // 65536
    goto v_8041;
v_8042:
    goto v_8038;
v_8039:
...
v_7964:
    ...
    v_8032 = nil;
v_7962:
    if (v_8032 == nil) goto v_7959;
    else goto v_7960;
v_7959:
    v_8032 = stack[0];
    v_8032 = qcar(v_8032);
    v_8032 = qcdr(v_8032);
    if (!consp(v_8032)) goto v_7978;
    else goto v_7979;
v_7978:
    v_8032 = lisp_true;
    goto v_7977;
v_7979:
    ...
    v_8032 = nil;
v_7977:
    if (v_8032 == nil) goto v_7975;
    v_8032 = stack[0];
    v_8032 = qcdr(v_8032);
    if (!consp(v_8032)) goto v_7997;
    else goto v_7998;
v_7997:
    v_8032 = lisp_true;
    goto v_7996;
...
// end of prologue
    ...
    v_8006 = (*qfn1(fn))(fn, v_8006);
    env = stack[-1];
    if (v_8006 == nil) goto v_7957;
    else goto v_7958;
v_7957:
    v_8006 = nil;
    goto v_7954;
v_7958:
    v_8006 = stack[0];
    if (!consp(v_8006)) goto v_7966;
    else goto v_7967;
v_7966:
    v_8006 = stack[0];
    v_8006 = (is_number(v_8006) ? lisp_true : nil);
    v_8006 = (v_8006 == nil ? lisp_true : nil);
    goto v_7965;
v_7967:
    v_8006 = nil;
    goto v_7965;
    v_8006 = nil;
v_7965:
    if (v_8006 == nil) goto v_7963;
    v_8006 = stack[0];
    fn = elt(env, 2); // qqe_qtidp
    v_8006 = (*qfn1(fn))(fn, v_8006);
    env = stack[-1];
    if (v_8006 == nil) goto v_7978;
    v_8006 = nil;
    goto v_7954;
v_7978:
    v_8006 = stack[0];
...
setup_type const u15_setup[] =
{
    ...
    {NULL, (one_args *)"u15", (two_args *)"64798 7113265 8309970", 0}
};
