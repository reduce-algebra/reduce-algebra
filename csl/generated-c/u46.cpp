...
v_11:
    ...
    v_64 = (LispObject)((std::intptr_t)(v_64) + 0x10);
...
v_8:
    ...
    v_25 = stack[0];
    v_25 = (LispObject)((std::intptr_t)(v_25) + 0x10);
    stack[0] = v_25;
    goto v_11;
v_13:
v_11:
...
v_13:
    ...
    stack[0] = v_27;
    v_24 = v_26;
    {   LispObject fn = basic_elt(env, 2); // preptayexp
...
setup_type const u46_setup[] =
{
    ...
    {NULL, (no_args *)"u46", (one_arg *)"57571 1882285 7917196",
        NULL, NULL, NULL}
};
