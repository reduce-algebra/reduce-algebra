...
v_15:
    fn = basic_elt(env, 14); // expansion_name
    v_364 = (*qfn0(fn))(fn);
    env = stack[-6];
    stack[-5] = v_364;
    stack[-1] = stack[-5];
    ...
    env = stack[-6];
    qvalue(basic_elt(env, 3)) = v_364; // pending_rules!*
    v_364 = stack[-5];
    goto v_8;
v_16:
    v_365 = stack[-2];
...
setup_type const u43_setup[] =
{
    ...
    {NULL, (no_args *)"u43", (one_arg *)"1513 2394024 4801552",
        NULL, NULL, NULL}
};
