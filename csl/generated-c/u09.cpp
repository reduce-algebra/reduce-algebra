...
// copy arguments values to proper place
    ...
    v_9 = v_2;
// end of prologue
    fn = basic_elt(env, 1); // evaluate!-horner
    v_10 = (*qfn1(fn))(fn, v_9);
    env = stack[-1];
    v_9 = stack[0];
    {
        fn = basic_elt(env, 2); // evaluate1
...
// copy arguments values to proper place
    v_7 = v_2;
// end of prologue
    fn = basic_elt(env, 1); // partitindexvar
    v_7 = (*qfn1(fn))(fn, v_7);
    env = stack[0];
    {
...
v_12:
    ...
    v_46 = qcdr(v_46);
    qvalue(basic_elt(env, 2)) = v_46; // outl!*
    goto v_8;
v_10:
v_8:
    v_46 = stack[0];
    fn = basic_elt(env, 6); // prin2x
...
// end of prologue
    v_22 = lisp_true;
    qvalue(basic_elt(env, 1)) = v_22; // exact!-quotient!-flag
    v_22 = v_24;
    fn = basic_elt(env, 3); // quotient!-mod!-p
