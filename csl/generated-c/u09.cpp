...
v_4218:
    ...
    qvalue(elt(env, 2)) = v_4235; // found_int
    goto v_4217;
v_4219:
    v_4235 = v_4236;
    v_4235 = qcdr(v_4235);
...
// copy arguments values to proper place
    ...
    stack[-1] = v_4206;
// end of prologue
    v_4237 = qvalue(elt(env, 1)); // !*gsugar
    if (v_4237 == nil) goto v_4214;
    else goto v_4215;
v_4214:
    v_4237 = nil;
    goto v_4213;
...
v_4225:
    v_4237 = v_4238;
    if (v_4237 == nil) goto v_4232;
    else goto v_4231;
v_4232:
    v_4237 = stack[-1];
    fn = elt(env, 3); // vdptdeg
    v_4237 = (*qfn1(fn))(fn, v_4237);
    env = stack[-3];
v_4231:
    goto v_4226;
v_4227:
...
v_4226:
    ...
    v_4237 = (*qfnn(fn))(fn, 3, stack[-2], stack[0], v_4237);
    goto v_4213;
    v_4237 = nil;
v_4213:
...
// end of prologue
    ...
    v_4220 = (*qfn1(fn))(fn, v_4220);
    v_4221 = v_4220;
    v_4220 = v_4221;
    if (v_4220 == nil) goto v_4213;
    else goto v_4214;
v_4213:
    v_4220 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_4212;
v_4214:
    v_4220 = v_4221;
    goto v_4212;
...
{
    env = qenv(env);
    LispObject v_4252, v_4253, v_4254;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
// copy arguments values to proper place
    v_4253 = v_4206;
// end of prologue
    v_4252 = qvalue(elt(env, 1)); // xdegreelist!*
    if (v_4252 == nil) goto v_4210;
    else goto v_4211;
v_4210:
    v_4252 = v_4253;
    fn = elt(env, 2); // mknwedge
    v_4252 = (*qfn1(fn))(fn, v_4252);
    env = stack[-1];
    {
        fn = elt(env, 3); // xdegree
        return (*qfn1(fn))(fn, v_4252);
    }
v_4211:
    v_4252 = v_4253;
    stack[0] = v_4252;
    v_4252 = (LispObject)0+TAG_FIXNUM; // 0
    v_4254 = v_4252;
v_4222:
    v_4252 = stack[0];
    if (v_4252 == nil) goto v_4227;
    else goto v_4228;
v_4227:
    v_4252 = v_4254;
    goto v_4221;
...
v_4241:
    goto v_4242;
v_4243:
    v_4252 = Latsoc(nil, v_4253, v_4252);
    v_4252 = qcdr(v_4252);
    goto v_4233;
v_4234:
    v_4253 = v_4254;
...
v_4227:
    goto v_4228;
v_4229:
    if (equal(v_4268, v_4267)) goto v_4224;
    else goto v_4225;
v_4224:
    goto v_4239;
v_4235:
...
v_4247:
    goto v_4248;
v_4249:
    if (equal(v_4268, v_4267)) goto v_4244;
    else goto v_4245;
v_4244:
    goto v_4260;
v_4256:
...
// end of prologue
    ...
    v_4221 = (*qfn1(fn))(fn, v_4221);
    env = stack[-2];
    goto v_4215;
v_4211:
    v_4221 = stack[0];
    fn = elt(env, 2); // simpcar
    stack[-1] = (*qfn1(fn))(fn, v_4221);
    env = stack[-2];
    goto v_4212;
v_4213:
    v_4221 = stack[0];
...
v_4214:
    {
        LispObject v_4224 = stack[-1];
        fn = elt(env, 4); // addsq
        return (*qfn2(fn))(fn, v_4224, v_4221);
    }
}
...
v_4213:
    {
        LispObject v_4244 = stack[-2];
        fn = elt(env, 1); // mkrn
        return (*qfn2(fn))(fn, v_4244, v_4239);
    }
}
...
v_4213:
    {
        LispObject v_4221 = stack[0];
        fn = elt(env, 2); // mo_sum
        return (*qfn2(fn))(fn, v_4221, v_4218);
    }
}
...
v_4211:
    v_4299 = stack[0];
    if (v_4299 == nil) goto v_4227;
    v_4299 = qvalue(elt(env, 1)); // !*globals
    if (v_4299 == nil) goto v_4232;
    v_4299 = stack[0];
    if (v_4299 == nil) goto v_4232;
    goto v_4247;
v_4243:
...
v_4244:
    goto v_4245;
v_4246:
    if (v_4300 == v_4299) goto v_4242;
    v_4299 = stack[0];
    if (symbolp(v_4299)) goto v_4253;
    v_4299 = nil;
    goto v_4251;
v_4253:
    goto v_4262;
...
v_4259:
    goto v_4260;
v_4261:
    v_4299 = Lassoc(nil, v_4300, v_4299);
    v_4299 = (v_4299 == nil ? lisp_true : nil);
    goto v_4251;
    v_4299 = nil;
v_4251:
    goto v_4240;
...
v_4276:
    goto v_4277;
v_4278:
    v_4299 = Lflagp(nil, v_4300, v_4299);
    env = stack[-1];
    if (v_4299 == nil) goto v_4272;
    else goto v_4273;
v_4272:
    goto v_4287;
v_4283:
...
v_4284:
    goto v_4285;
v_4286:
    v_4299 = Lflag(nil, v_4300, v_4299);
    env = stack[-1];
    goto v_4296;
v_4292:
    v_4300 = stack[0];
...
v_4293:
    goto v_4294;
v_4295:
    v_4299 = cons(v_4300, v_4299);
    env = stack[-1];
    qvalue(elt(env, 4)) = v_4299; // globs!*
    goto v_4271;
v_4273:
v_4271:
    goto v_4230;
...
setup_type const u09_setup[] =
{
    ...
    {NULL, (one_args *)"u09", (two_args *)"105427 7977333 7520458", 0}
};
