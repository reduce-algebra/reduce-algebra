...
v_762:
    ...
    goto v_763;
v_764:
    v_834 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_765;
v_766:
    goto v_762;
v_763:
    goto v_764;
v_765:
    v_834 = *(LispObject *)((char *)v_835 + (CELL-TAG_VECTOR) + (((intptr_t)v_834-TAG_FIXNUM)/(16/CELL)));
    stack[-1] = v_834;
    goto v_774;
v_770:
    v_835 = v_836;
...
v_797:
    goto v_798;
v_799:
    if (equal(v_835, v_834)) goto v_794;
    else goto v_795;
v_794:
    v_834 = stack[-1];
    v_834 = qcdr(v_834);
...
v_814:
    goto v_815;
v_816:
    v_834 = (LispObject)greaterp2(v_835, v_834);
    v_834 = v_834 ? lisp_true : nil;
    env = stack[-2];
    if (v_834 == nil) goto v_811;
    v_834 = stack[-1];
    v_834 = qcdr(v_834);
    stack[-1] = v_834;
    goto v_793;
...
v_779:
    v_834 = stack[0];
    v_834 = qcar(v_834);
    v_834 = (v_834 == nil ? lisp_true : nil);
    return onevalue(v_834);
}
...
v_773:
    v_872 = stack[-1];
    v_872 = qcar(v_872);
    v_872 = (consp(v_872) ? nil : lisp_true);
    goto v_771;
    v_872 = nil;
v_771:
    goto v_763;
...
v_792:
    goto v_793;
v_794:
    v_873 = Latsoc(nil, v_873, v_872);
    v_872 = v_873;
    if (v_873 == nil) goto v_790;
    goto v_811;
v_807:
    v_873 = stack[-1];
    v_873 = qcar(v_873);
...
v_808:
    goto v_809;
v_810:
    v_872 = (LispObject)greaterp2(v_873, v_872);
    v_872 = v_872 ? lisp_true : nil;
    env = stack[-3];
    if (v_872 == nil) goto v_805;
    goto v_825;
v_819:
    v_872 = stack[-1];
    v_872 = qcar(v_872);
...
v_824:
    fn = elt(env, 1); // repasc
    v_872 = (*qfnn(fn))(fn, 3, v_874, v_873, v_872);
    env = stack[-3];
    stack[0] = v_872;
    goto v_803;
v_805:
...
v_864:
    goto v_865;
v_866:
    v_872 = CC_powers0(elt(env, 0), v_873, v_872);
    env = stack[-3];
    goto v_858;
v_859:
    goto v_855;
...
// copy arguments values to proper place
    stack[-2] = v_755;
// end of prologue
    v_861 = qvalue(elt(env, 1)); // !*mcd
    if (v_861 == nil) goto v_760;
    v_861 = stack[-2];
    v_861 = qcar(v_861);
    v_861 = qcar(v_861);
    v_861 = qcdr(v_861);
...
v_796:
    goto v_797;
v_798:
    return difference2(v_862, v_861);
v_791:
    v_861 = stack[-2];
    v_861 = qcdr(v_861);
    stack[-2] = v_861;
...
v_817:
    fn = elt(env, 2); // degr
    v_862 = (*qfn2(fn))(fn, v_862, v_861);
    env = stack[-4];
    goto v_809;
v_810:
    v_861 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_811;
v_812:
    goto v_808;
v_809:
...
v_828:
    goto v_829;
v_830:
    v_861 = (LispObject)lessp2(v_862, v_861);
    v_861 = v_861 ? lisp_true : nil;
    env = stack[-4];
    if (v_861 == nil) goto v_825;
    goto v_843;
v_839:
    v_862 = stack[-1];
    goto v_840;
...
v_773:
    goto v_774;
v_775:
    v_797 = (LispObject)greaterp2(v_798, v_797);
    v_797 = v_797 ? lisp_true : nil;
    env = stack[-3];
    if (v_797 == nil) goto v_770;
    v_797 = stack[-1];
    v_797 = qcdr(v_797);
    stack[-1] = v_797;
    goto v_761;
...
v_761:
    {
        LispObject v_768 = stack[0];
        fn = elt(env, 2); // apply
        return (*qfn2(fn))(fn, v_768, v_766);
    }
}
...
v_763:
    goto v_764;
v_765:
    v_811 = Lflagp(nil, v_812, v_811);
    env = stack[-1];
    if (v_811 == nil) goto v_759;
    else goto v_760;
v_759:
    goto v_778;
v_774:
...
v_777:
    v_811 = Lflagp(nil, v_812, v_811);
    env = stack[-1];
    if (v_811 == nil) goto v_772;
    goto v_786;
v_782:
    v_812 = stack[0];
    goto v_783;
v_784:
    v_811 = qvalue(elt(env, 3)); // xseen!*
    goto v_785;
v_786:
    goto v_782;
v_783:
    goto v_784;
v_785:
    v_811 = cons(v_812, v_811);
    env = stack[-1];
    qvalue(elt(env, 3)) = v_811; // xseen!*
    goto v_770;
v_772:
    goto v_796;
v_792:
...
v_801:
    goto v_802;
v_803:
        return Lflag(nil, v_811, v_812);
v_760:
    v_811 = nil;
    goto v_758;
    v_811 = nil;
v_758:
    return onevalue(v_811);
}
...
// end of prologue
    v_841 = stack[0];
    fn = elt(env, 4); // vecp
    v_841 = (*qfn1(fn))(fn, v_841);
    env = stack[-1];
    if (v_841 == nil) goto v_763;
    v_841 = elt(env, 1); // !3vector
    goto v_761;
v_763:
    v_841 = stack[0];
    v_841 = qcar(v_841);
    if (!symbolp(v_841)) v_841 = nil;
    else { v_841 = qfastgets(v_841);
           if (v_841 != nil) { v_841 = elt(v_841, 2); // rtype
#ifdef RECORD_GET
             if (v_841 != SPID_NOPROP)
                record_get(elt(fastget_names, 2), 1);
             else record_get(elt(fastget_names, 2), 0),
                v_841 = nil; }
           else record_get(elt(fastget_names, 2), 0); }
#else
             if (v_841 == SPID_NOPROP) v_841 = nil; }}
#endif
    v_842 = v_841;
    if (v_841 == nil) goto v_768;
    v_841 = v_842;
    if (!symbolp(v_841)) v_841 = nil;
    else { v_841 = qfastgets(v_841);
           if (v_841 != nil) { v_841 = elt(v_841, 19); // rtypefn
#ifdef RECORD_GET
             if (v_841 != SPID_NOPROP)
...
v_778:
    goto v_779;
v_780:
        return Lapply1(nil, v_842, v_841);
v_768:
    v_841 = stack[0];
    v_841 = qcar(v_841);
    if (!symbolp(v_841)) v_841 = nil;
...
v_807:
    goto v_808;
v_809:
    v_841 = Lflagp(nil, v_842, v_841);
    env = stack[-1];
    if (v_841 == nil) goto v_804;
    v_841 = stack[0];
    v_841 = qcdr(v_841);
    if (v_841 == nil) goto v_816;
    else goto v_817;
v_816:
    v_841 = nil;
    goto v_815;
...
v_823:
    ...
    v_842 = (*qfn1(fn))(fn, v_841);
    env = stack[-1];
    goto v_824;
v_825:
    v_841 = elt(env, 3); // matrix
    goto v_826;
v_827:
    goto v_823;
v_824:
    goto v_825;
v_826:
    v_841 = (v_842 == v_841 ? lisp_true : nil);
    goto v_815;
    v_841 = nil;
v_815:
    goto v_802;
...
v_762:
    goto v_763;
v_764:
    return list3(v_771, v_770, v_769);
}
...
v_764:
    v_895 = stack[0];
    if (!consp(v_895)) goto v_767;
    else goto v_768;
v_767:
    v_895 = stack[0];
    if (symbolp(v_895)) goto v_773;
    v_895 = stack[0];
    if (is_number(v_895)) goto v_778;
    v_895 = stack[0];
    {
        fn = elt(env, 5); // getrtype1
        return (*qfn1(fn))(fn, v_895);
    }
v_778:
    v_895 = nil;
    goto v_776;
...
v_773:
    v_895 = stack[0];
    if (!symbolp(v_895)) v_895 = nil;
    else { v_895 = qfastgets(v_895);
           if (v_895 != nil) { v_895 = elt(v_895, 17); // share
#ifdef RECORD_GET
             if (v_895 == SPID_NOPROP)
...
#else
             if (v_895 == SPID_NOPROP) v_895 = nil; else v_895 = lisp_true; }}
#endif
    if (v_895 == nil) goto v_786;
    goto v_797;
v_793:
    v_895 = stack[0];
    fn = elt(env, 6); // eval
    v_896 = (*qfn1(fn))(fn, v_895);
    env = stack[-1];
    v_897 = v_896;
    goto v_794;
v_795:
...
v_786:
    ...
    if (!symbolp(v_895)) v_895 = nil;
           ...
           if (v_895 != nil) { v_895 = elt(v_895, 4); // avalue
#ifdef RECORD_GET
             if (v_895 != SPID_NOPROP)
...
#else
             if (v_895 == SPID_NOPROP) v_895 = nil; }}
#endif
    v_897 = v_895;
    if (v_895 == nil) goto v_808;
    goto v_817;
v_813:
    v_895 = v_897;
    v_896 = qcar(v_895);
    goto v_814;
v_815:
    v_895 = elt(env, 1); // (scalar generic)
    goto v_816;
v_817:
    goto v_813;
v_814:
    goto v_815;
v_816:
    v_895 = Lmemq(nil, v_896, v_895);
    if (v_895 == nil) goto v_812;
    else goto v_808;
v_812:
    goto v_806;
v_808:
    ...
    if (!symbolp(v_895)) v_895 = nil;
           ...
           if (v_895 != nil) { v_895 = elt(v_895, 2); // rtype
#ifdef RECORD_GET
             if (v_895 != SPID_NOPROP)
                record_get(elt(fastget_names, 2), 1);
             else record_get(elt(fastget_names, 2), 0),
...
v_806:
    ...
    if (!symbolp(v_895)) v_895 = nil;
           ...
           if (v_895 != nil) { v_895 = elt(v_895, 19); // rtypefn
#ifdef RECORD_GET
             if (v_895 != SPID_NOPROP)
                record_get(elt(fastget_names, 19), 1);
             else record_get(elt(fastget_names, 19), 0),
...
v_838:
    goto v_839;
v_840:
        return Lapply1(nil, v_896, v_895);
v_832:
    v_895 = v_897;
    v_895 = qcar(v_895);
    goto v_830;
...
v_768:
    v_895 = stack[0];
    v_895 = qcar(v_895);
    if (symbolp(v_895)) goto v_852;
    v_895 = nil;
    goto v_762;
v_852:
    v_895 = stack[0];
    fn = elt(env, 7); // physopp!*
    v_895 = (*qfn1(fn))(fn, v_895);
    env = stack[-1];
    if (v_895 == nil) goto v_857;
    v_895 = elt(env, 2); // physop
    goto v_762;
v_857:
    v_895 = stack[0];
    v_895 = qcar(v_895);
...
v_883:
    goto v_884;
v_885:
    if (v_896 == v_895) goto v_880;
    else goto v_881;
v_880:
    v_895 = elt(env, 4); // yetunknowntype
    goto v_762;
v_881:
    v_895 = stack[0];
    {
...
setup_type const u03_setup[] =
{
    ...
    {NULL, (one_args *)"u03", (two_args *)"87159 2331297 7285021", 0}
};
