...
{   bind_fluid_stack bind_fluid_var(-2, 1, -1);
    ...
    v_877 = nil;
    qvalue(elt(env, 1)) = v_877; // d
v_763:
    goto v_776;
v_772:
    v_878 = Lreadch(nil, 0);
    env = stack[-2];
    qvalue(elt(env, 2)) = v_878; // ch
    goto v_773;
v_774:
    v_877 = elt(env, 3); // !<
    goto v_775;
...
v_775:
    ...
    goto v_784;
v_780:
    v_878 = qvalue(elt(env, 2)); // ch
    goto v_781;
v_782:
    v_877 = qvalue(elt(env, 4)); // !$eof!$
    goto v_783;
v_784:
    goto v_780;
v_781:
...
v_763:
    goto v_764;
v_765:
    v_781 = Lmemq(nil, v_784, v_781);
    if (v_781 == nil) goto v_761;
    v_781 = v_782;
    goto v_759;
v_761:
    goto v_778;
...
setup_type const u03_setup[] =
{
    ...
    {NULL, (one_args *)"u03", (two_args *)"37115 6634642 2596832", 0}
};
