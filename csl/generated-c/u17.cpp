...
{   bind_fluid_stack bind_fluid_var(-8, 1, -4);
    ...
    v_10227 = lisp_true;
    qvalue(elt(env, 1)) = v_10227; // !*exp
    v_10227 = stack[-5];
    if (!consp(v_10227)) goto v_9866;
    else goto v_9867;
v_9866:
    v_10227 = lisp_true;
    goto v_9865;
v_9867:
    v_10227 = stack[-5];
    v_10227 = qcar(v_10227);
    v_10227 = (consp(v_10227) ? nil : lisp_true);
    goto v_9865;
    v_10227 = nil;
v_9865:
    if (v_10227 == nil) goto v_9863;
    goto v_9880;
v_9876:
    v_10228 = stack[-6];
    goto v_9877;
...
v_9879:
    fn = elt(env, 2); // qremd
    v_10227 = (*qfn2(fn))(fn, v_10228, v_10227);
    goto v_9856;
v_9863:
    v_10227 = nil;
    v_10227 = ncons(v_10227);
    env = stack[-8];
    stack[-1] = v_10227;
v_9857:
    v_10227 = stack[-6];
    if (!consp(v_10227)) goto v_9891;
    else goto v_9892;
v_9891:
    v_10227 = lisp_true;
    goto v_9890;
...
v_9904:
    fn = elt(env, 3); // praddf
    v_10227 = (*qfn2(fn))(fn, stack[0], v_10227);
    goto v_9856;
v_9888:
    goto v_9921;
v_9917:
...
v_9918:
    goto v_9919;
v_9920:
    if (v_10228 == v_10227) goto v_9915;
    else goto v_9916;
v_9915:
    goto v_9939;
v_9935:
...
v_9941:
    ...
    v_10227 = qcar(v_10227);
    v_10227 = qcar(v_10227);
    v_10228 = qcdr(v_10227);
    goto v_9942;
v_9943:
    v_10227 = stack[-5];
    v_10227 = qcar(v_10227);
    v_10227 = qcar(v_10227);
    v_10227 = qcdr(v_10227);
    goto v_9944;
v_9945:
    goto v_9941;
v_9942:
    goto v_9943;
v_9944:
    v_10228 = difference2(v_10228, v_10227);
    env = stack[-8];
    stack[-7] = v_10228;
    goto v_9936;
v_9937:
    v_10227 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_9938;
v_9939:
    goto v_9935;
v_9936:
    goto v_9937;
v_9938:
    v_10227 = (LispObject)lessp2(v_10228, v_10227);
    v_10227 = v_10227 ? lisp_true : nil;
    env = stack[-8];
    if (v_10227 == nil) goto v_9933;
    goto v_9960;
v_9956:
    stack[0] = stack[-1];
    goto v_9957;
...
v_9974:
    goto v_9975;
v_9976:
    v_10227 = CC_qremf(elt(env, 0), v_10228, v_10227);
    env = stack[-8];
    stack[-3] = v_10227;
    goto v_9989;
v_9985:
...
v_9992:
    ...
    goto v_9993;
v_9994:
    v_10227 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_9995;
v_9996:
    goto v_9992;
v_9993:
...
v_10021:
    goto v_10022;
v_10023:
    if (v_10228 == v_10227) goto v_10018;
    else goto v_10019;
v_10018:
    v_10227 = stack[-3];
    v_10227 = qcar(v_10227);
...
v_10048:
    fn = elt(env, 5); // to
    v_10228 = (*qfn2(fn))(fn, v_10228, v_10227);
    env = stack[-8];
    goto v_10040;
v_10041:
    v_10227 = (LispObject)16+TAG_FIXNUM; // 1
...
v_10093:
    goto v_10094;
v_10095:
    if (v_10228 == v_10227) goto v_10090;
    else goto v_10091;
v_10090:
    v_10227 = stack[-5];
    stack[-6] = v_10227;
...
v_10086:
    fn = elt(env, 4); // multf
    v_10227 = (*qfn2(fn))(fn, stack[-6], v_10227);
    env = stack[-8];
    goto v_10079;
v_10080:
    goto v_10076;
...
v_10079:
    fn = elt(env, 7); // addf
    stack[0] = (*qfn2(fn))(fn, stack[0], v_10227);
    env = stack[-8];
    goto v_10071;
v_10072:
    v_10227 = stack[-2];
...
v_10191:
    fn = elt(env, 4); // multf
    stack[0] = (*qfn2(fn))(fn, v_10228, v_10227);
    env = stack[-8];
    goto v_10183;
v_10184:
    goto v_10211;
...
v_10178:
    fn = elt(env, 3); // praddf
    v_10227 = (*qfn2(fn))(fn, stack[-1], v_10227);
    env = stack[-8];
    stack[-1] = v_10227;
    v_10227 = stack[-6];
    v_10227 = qcdr(v_10227);
...
{   bind_fluid_stack bind_fluid_var(-1, 1, 0);
    qvalue(elt(env, 1)) = v_9853; // !*!*noremove!*!*
    v_9853 = v_9854;
    fn = elt(env, 2); // remove!-free!-vars
    v_9853 = (*qfn1(fn))(fn, v_9853);
    ;}  // end of a binding scope
    return onevalue(v_9853);
}
...
{
    env = qenv(env);
    LispObject v_9956, v_9957, v_9958;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
// copy arguments values to proper place
    stack[-1] = v_9847;
// end of prologue
    v_9956 = (LispObject)0+TAG_FIXNUM; // 0
    v_9958 = v_9956;
v_9856:
    v_9956 = stack[-1];
    if (!consp(v_9956)) goto v_9863;
    else goto v_9864;
v_9863:
    v_9956 = lisp_true;
    goto v_9862;
v_9864:
    v_9956 = stack[-1];
    v_9956 = qcar(v_9956);
    v_9956 = (consp(v_9956) ? nil : lisp_true);
    goto v_9862;
    v_9956 = nil;
v_9862:
    if (v_9956 == nil) goto v_9860;
    goto v_9855;
v_9860:
    goto v_9878;
v_9874:
...
v_9881:
    ...
    stack[0] = v_9956;
    fn = elt(env, 1); // sfp
    v_9956 = (*qfn1(fn))(fn, v_9956);
    env = stack[-3];
    if (v_9956 == nil) goto v_9889;
    v_9956 = stack[0];
    v_9956 = CC_tmsf(elt(env, 0), v_9956);
    env = stack[-3];
    stack[0] = v_9956;
    goto v_9887;
v_9889:
    v_9956 = (LispObject)16+TAG_FIXNUM; // 1
    stack[0] = v_9956;
    goto v_9887;
    stack[0] = nil;
v_9887:
...
v_9922:
    ...
    goto v_9923;
v_9924:
    v_9956 = (LispObject)32+TAG_FIXNUM; // 2
    goto v_9925;
v_9926:
    goto v_9922;
v_9923:
...
// end of prologue
    v_9902 = v_9903;
    if (!consp(v_9902)) goto v_9851;
    else goto v_9852;
v_9851:
    v_9902 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_9850;
v_9852:
    v_9902 = v_9903;
...
v_9870:
    v_9902 = stack[-3];
    v_9902 = qcar(v_9902);
    v_9902 = CC_talp_td(elt(env, 0), v_9902);
    env = stack[-4];
    v_9902 = ncons(v_9902);
    env = stack[-4];
    stack[-1] = v_9902;
...
v_9889:
    goto v_9890;
v_9891:
    v_9902 = Lrplacd(nil, stack[0], v_9902);
    env = stack[-4];
    v_9902 = stack[-1];
    v_9902 = qcdr(v_9902);
    stack[-1] = v_9902;
...
v_9852:
    v_9860 = qcdr(v_9860);
    v_9860 = (v_9860 == nil ? lisp_true : nil);
    goto v_9850;
    v_9860 = nil;
v_9850:
    return onevalue(v_9860);
}
...
// end of prologue
    ...
    v_9852 = (*qfn1(fn))(fn, v_9852);
    v_9852 = (v_9852 == nil ? lisp_true : nil);
    return onevalue(v_9852);
}
...
v_9861:
    v_9907 = stack[-1];
    v_9907 = qcar(v_9907);
    v_9907 = (consp(v_9907) ? nil : lisp_true);
    goto v_9859;
    v_9907 = nil;
v_9859:
    if (v_9907 == nil) goto v_9857;
    goto v_9875;
v_9871:
    v_9907 = stack[0];
    v_9907 = qcdr(v_9907);
...
v_9893:
    ...
    stack[-2] = (*qfn2(fn))(fn, v_9908, v_9907);
    env = stack[-3];
    goto v_9885;
v_9886:
    goto v_9903;
...
v_9900:
    goto v_9901;
v_9902:
    v_9907 = CC_sq2sscfpl(elt(env, 0), v_9908, v_9907);
    goto v_9887;
v_9888:
    goto v_9884;
v_9885:
...
v_9887:
    {
        LispObject v_9912 = stack[-2];
        return Lappend(nil, v_9912, v_9907);
    }
    v_9907 = nil;
v_9851:
...
setup_type const u17_setup[] =
{
    ...
    {NULL, (one_args *)"u17", (two_args *)"170951 7099627 9483623", 0}
};
