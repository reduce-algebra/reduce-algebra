...
v_3601:
    fn = elt(env, 1); // pair
    v_3754 = (*qfn2(fn))(fn, v_3755, v_3754);
    env = stack[-10];
    stack[-3] = v_3754;
    v_3754 = stack[-3];
    if (v_3754 == nil) goto v_3608;
    else goto v_3609;
v_3608:
    v_3754 = nil;
    v_3755 = v_3754;
...
v_3617:
    goto v_3618;
v_3619:
    v_3754 = (LispObject)(intptr_t)((intptr_t)v_3755 + (intptr_t)v_3754 - TAG_FIXNUM);
    v_3754 = ncons(v_3754);
    env = stack[-10];
    stack[-1] = v_3754;
    stack[-2] = v_3754;
...
v_3636:
    goto v_3637;
v_3638:
    v_3754 = Lrplacd(nil, stack[0], v_3754);
    env = stack[-10];
    v_3754 = stack[-1];
    v_3754 = qcdr(v_3754);
    stack[-1] = v_3754;
...
v_3669:
    goto v_3670;
v_3671:
    v_3754 = Lrplacd(nil, stack[-5], v_3754);
    env = stack[-10];
    v_3754 = stack[-6];
    v_3754 = qcdr(v_3754);
    stack[-6] = v_3754;
...
{
    env = qenv(env);
    LispObject v_3594, v_3595, v_3596;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
// end of prologue
    v_3594 = v_3595;
    v_3594 = Lconsp(nil, v_3594);
    env = stack[0];
    if (v_3594 == nil) goto v_3572;
    goto v_3583;
v_3579:
    v_3594 = v_3595;
    v_3596 = qcar(v_3594);
...
v_3580:
    goto v_3581;
v_3582:
    if (v_3596 == v_3594) goto v_3577;
    else goto v_3578;
v_3577:
    v_3594 = (LispObject)16+TAG_FIXNUM; // 1
    qvalue(elt(env, 2)) = v_3594; // found_int
    goto v_3576;
v_3578:
    v_3594 = v_3595;
    v_3594 = qcdr(v_3594);
    fn = elt(env, 3); // multi_isarb_int
    v_3594 = (*qfn1(fn))(fn, v_3594);
    goto v_3576;
v_3576:
    goto v_3570;
v_3572:
...
// copy arguments values to proper place
    ...
    stack[-1] = v_3565;
// end of prologue
    v_3596 = qvalue(elt(env, 1)); // !*gsugar
    if (v_3596 == nil) goto v_3573;
    else goto v_3574;
v_3573:
    v_3596 = nil;
    goto v_3572;
...
v_3584:
    v_3596 = v_3597;
    if (v_3596 == nil) goto v_3591;
    else goto v_3590;
v_3591:
    v_3596 = stack[-1];
    fn = elt(env, 3); // vdptdeg
    v_3596 = (*qfn1(fn))(fn, v_3596);
    env = stack[-3];
v_3590:
    goto v_3585;
v_3586:
...
v_3585:
    ...
    v_3596 = (*qfnn(fn))(fn, 3, stack[-2], stack[0], v_3596);
    goto v_3572;
    v_3596 = nil;
v_3572:
    if (v_3596 == nil) goto v_3570;
    else goto v_3569;
v_3570:
    v_3596 = stack[-1];
v_3569:
...
// end of prologue
    ...
    v_3580 = v_3579;
    v_3579 = v_3580;
    if (v_3579 == nil) goto v_3572;
    else goto v_3573;
v_3572:
    v_3579 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_3571;
v_3573:
    v_3579 = v_3580;
    goto v_3571;
...
{
    env = qenv(env);
    LispObject v_3611, v_3612, v_3613;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
// copy arguments values to proper place
    v_3612 = v_3565;
// end of prologue
    v_3611 = qvalue(elt(env, 1)); // xdegreelist!*
    if (v_3611 == nil) goto v_3569;
    else goto v_3570;
v_3569:
    v_3611 = v_3612;
    fn = elt(env, 2); // mknwedge
    v_3611 = (*qfn1(fn))(fn, v_3611);
    env = stack[-1];
    {
        fn = elt(env, 3); // xdegree
        return (*qfn1(fn))(fn, v_3611);
    }
v_3570:
    v_3611 = v_3612;
    stack[0] = v_3611;
    v_3611 = (LispObject)0+TAG_FIXNUM; // 0
    v_3613 = v_3611;
v_3581:
    v_3611 = stack[0];
    if (v_3611 == nil) goto v_3586;
    else goto v_3587;
v_3586:
    v_3611 = v_3613;
    goto v_3580;
...
v_3600:
    goto v_3601;
v_3602:
    v_3611 = Latsoc(nil, v_3612, v_3611);
    v_3611 = qcdr(v_3611);
    goto v_3592;
v_3593:
    v_3612 = v_3613;
...
v_3586:
    goto v_3587;
v_3588:
    if (equal(v_3627, v_3626)) goto v_3583;
    else goto v_3584;
v_3583:
    goto v_3598;
v_3594:
...
v_3606:
    goto v_3607;
v_3608:
    if (equal(v_3627, v_3626)) goto v_3603;
    else goto v_3604;
v_3603:
    goto v_3619;
v_3615:
...
// end of prologue
    ...
    v_3580 = (*qfn1(fn))(fn, v_3580);
    env = stack[-2];
    goto v_3574;
v_3570:
    v_3580 = stack[0];
    fn = elt(env, 2); // simpcar
    stack[-1] = (*qfn1(fn))(fn, v_3580);
    env = stack[-2];
    goto v_3571;
v_3572:
    v_3580 = stack[0];
...
v_3573:
    {
        LispObject v_3583 = stack[-1];
        fn = elt(env, 4); // addsq
        return (*qfn2(fn))(fn, v_3583, v_3580);
    }
}
...
v_3572:
    {
        LispObject v_3603 = stack[-2];
        fn = elt(env, 1); // mkrn
        return (*qfn2(fn))(fn, v_3603, v_3598);
    }
}
...
v_3572:
    {
        ...
        fn = elt(env, 2); // mo_sum
        return (*qfn2(fn))(fn, v_3580, v_3577);
    }
}
...
v_3570:
    v_3658 = stack[0];
    if (v_3658 == nil) goto v_3586;
    v_3658 = qvalue(elt(env, 1)); // !*globals
    if (v_3658 == nil) goto v_3591;
    v_3658 = stack[0];
    if (v_3658 == nil) goto v_3591;
    goto v_3606;
v_3602:
...
v_3603:
    goto v_3604;
v_3605:
    if (v_3659 == v_3658) goto v_3601;
    v_3658 = stack[0];
    if (symbolp(v_3658)) goto v_3612;
    v_3658 = nil;
    goto v_3610;
v_3612:
    goto v_3621;
...
v_3618:
    goto v_3619;
v_3620:
    v_3658 = Lassoc(nil, v_3659, v_3658);
    v_3658 = (v_3658 == nil ? lisp_true : nil);
    goto v_3610;
    v_3658 = nil;
v_3610:
    goto v_3599;
...
v_3635:
    goto v_3636;
v_3637:
    v_3658 = Lflagp(nil, v_3659, v_3658);
    env = stack[-1];
    if (v_3658 == nil) goto v_3631;
    else goto v_3632;
v_3631:
    goto v_3646;
v_3642:
...
v_3643:
    goto v_3644;
v_3645:
    v_3658 = Lflag(nil, v_3659, v_3658);
    env = stack[-1];
    goto v_3655;
v_3651:
    v_3659 = stack[0];
...
v_3652:
    goto v_3653;
v_3654:
    v_3658 = cons(v_3659, v_3658);
    env = stack[-1];
    qvalue(elt(env, 4)) = v_3658; // globs!*
    goto v_3630;
v_3632:
v_3630:
    goto v_3589;
...
setup_type const u08_setup[] =
{
    ...
    {NULL, (one_args *)"u08", (two_args *)"48577 2173519 221936", 0}
};
