...
v_20:
    ...
    v_75 = qcdr(v_75);
    v_75 = CC_ra_budanKtransform(basic_elt(env, 0), v_75);
    env = stack[-4];
    stack[-3] = v_75;
    v_75 = stack[-2];
    if (!car_legal(v_75)) v_75 = cdrerror(v_75); else
...
v_21:
    ...
    env = stack[-1];
    {
        fn = basic_elt(env, 4); // lalr_prin_reduction
...
v_15:
    ...
    env = stack[-10];
    fn = basic_elt(env, 1); // processpartitie1
...
v_66:
    ...
    v_126 = qcdr(v_125);
    v_125 = stack[-5];
    fn = basic_elt(env, 5); // get_first_kernel
...
v_62:
    ...
    v_125 = (*qfn2(fn))(fn, v_126, v_125);
    env = stack[-8];
    fn = basic_elt(env, 7); // update_kc_list
...
v_40:
    ...
    v_125 = ncons(v_125);
    env = stack[-8];
    v_125 = CC_split_f(basic_elt(env, 0), stack[-2], stack[-1], stack[0], v_125);
    env = stack[-8];
    stack[-3] = v_125;
    v_125 = stack[-7];
    stack[-6] = v_125;
...
{   bind_fluid_stack bind_fluid_var(-4, 5, 0);
    qvalue(basic_elt(env, 5)) = nil; // alglist!*
    v_42 = nil;
    v_42 = ncons(v_42);
    env = stack[-4];
    qvalue(basic_elt(env, 5)) = v_42; // alglist!*
    v_43 = stack[-1];
    v_42 = stack[-2];
...
setup_type const u12_setup[] =
{
    ...
    {NULL, (no_args *)"u12", (one_arg *)"105611 3541651 6174024",
        NULL, NULL, NULL}
};
