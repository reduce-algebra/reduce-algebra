...
{
    env = qenv(env);
    LispObject v_6639, v_6640, v_6641;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
{   bind_fluid_stack bind_fluid_var(-7, 1, -6);
    ...
    v_6639 = qvalue(elt(env, 2)); // !*anygcd
    if (v_6639 == nil) goto v_6333;
    else goto v_6334;
v_6333:
    v_6639 = lisp_true;
    goto v_6332;
v_6334:
    ...
    v_6639 = (*qfn1(fn))(fn, v_6639);
    env = stack[-7];
    if (v_6639 == nil) goto v_6341;
    else goto v_6342;
v_6341:
    v_6639 = lisp_true;
    goto v_6340;
v_6342:
    ...
    v_6639 = (*qfn1(fn))(fn, v_6639);
    env = stack[-7];
    v_6639 = (v_6639 == nil ? lisp_true : nil);
    goto v_6340;
    v_6639 = nil;
v_6340:
    goto v_6332;
    v_6639 = nil;
v_6332:
    if (v_6639 == nil) goto v_6330;
    v_6639 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_6326;
v_6330:
    v_6639 = qvalue(elt(env, 3)); // !*gcd
    if (v_6639 == nil) goto v_6355;
    goto v_6364;
v_6360:
    goto v_6371;
v_6367:
...
v_6370:
    ...
    v_6639 = (*qfn2(fn))(fn, v_6640, v_6639);
    env = stack[-7];
    stack[-3] = v_6639;
    v_6640 = Llength(nil, v_6639);
    env = stack[-7];
    goto v_6361;
v_6362:
    v_6639 = (LispObject)16+TAG_FIXNUM; // 1
...
v_6361:
    goto v_6362;
v_6363:
    v_6639 = (LispObject)greaterp2(v_6640, v_6639);
    v_6639 = v_6639 ? lisp_true : nil;
    env = stack[-7];
    if (v_6639 == nil) goto v_6355;
    v_6639 = stack[-3];
...
v_6424:
    ...
    v_6639 = (*qfn2(fn))(fn, stack[-5], v_6639);
    env = stack[-7];
    stack[-5] = v_6639;
    goto v_6434;
v_6430:
...
v_6433:
    fn = elt(env, 11); // quotf1
    v_6639 = (*qfn2(fn))(fn, stack[-4], v_6639);
    env = stack[-7];
    stack[-4] = v_6639;
    v_6639 = qvalue(elt(env, 3)); // !*gcd
    if (v_6639 == nil) goto v_6441;
    goto v_6448;
v_6444:
    goto v_6454;
v_6450:
...
v_6453:
    fn = elt(env, 12); // gcdk
    v_6640 = (*qfn2(fn))(fn, v_6640, v_6639);
    env = stack[-7];
    goto v_6445;
v_6446:
    v_6639 = stack[-2];
...
v_6582:
    ...
    v_6639 = (*qfnn(fn))(fn, 3, v_6641, v_6640, v_6639);
    env = stack[-7];
    stack[-2] = v_6639;
    goto v_6386;
v_6563:
...
{
    env = qenv(env);
    LispObject v_6501, v_6502, v_6503;
    LispObject fn;
    LispObject v_6321, v_6320, v_6319;
    va_list aa;
    va_start(aa, nargs);
...
v_6331:
    ...
    goto v_6332;
v_6333:
    v_6501 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_6334;
v_6335:
    goto v_6331;
v_6332:
    goto v_6333;
v_6334:
    v_6501 = cons(v_6502, v_6501);
    env = stack[-4];
    stack[-3] = v_6501;
v_6327:
    v_6501 = stack[-2];
    if (v_6501 == nil) goto v_6340;
    else goto v_6341;
v_6340:
    v_6501 = stack[-3];
    goto v_6326;
...
v_6349:
    v_6501 = stack[-2];
    v_6501 = qcar(v_6501);
    v_6501 = (consp(v_6501) ? nil : lisp_true);
    goto v_6347;
    v_6501 = nil;
v_6347:
    if (v_6501 == nil) goto v_6345;
    goto v_6362;
v_6358:
    stack[0] = stack[-3];
    goto v_6359;
...
v_6361:
    {
        ...
        fn = elt(env, 6); // addsq
        return (*qfn2(fn))(fn, v_6508, v_6501);
    }
v_6345:
    v_6501 = stack[0];
    if (v_6501 == nil) goto v_6373;
    v_6501 = stack[-2];
    v_6501 = qcar(v_6501);
    v_6501 = qcdr(v_6501);
    if (!consp(v_6501)) goto v_6379;
    else goto v_6380;
v_6379:
    v_6501 = lisp_true;
    goto v_6378;
...
v_6378:
    ...
    goto v_6329;
v_6373:
    v_6501 = qvalue(elt(env, 1)); // !*mymatch
    if (v_6501 == nil) goto v_6395;
    goto v_6402;
v_6398:
    v_6501 = stack[-2];
    v_6502 = qcar(v_6501);
...
v_6401:
    ...
    v_6501 = (*qfn2(fn))(fn, v_6502, v_6501);
    env = stack[-4];
    goto v_6393;
v_6395:
    goto v_6413;
...
v_6393:
    v_6503 = v_6501;
    v_6501 = stack[0];
    if (v_6501 == nil) goto v_6423;
    else goto v_6424;
v_6423:
    v_6501 = lisp_true;
    goto v_6422;
v_6424:
    v_6501 = qvalue(elt(env, 2)); // mchfg!*
    v_6501 = (v_6501 == nil ? lisp_true : nil);
    goto v_6422;
    v_6501 = nil;
v_6422:
    if (v_6501 == nil) goto v_6420;
    goto v_6328;
v_6420:
    v_6501 = nil;
    qvalue(elt(env, 2)) = v_6501; // mchfg!*
    goto v_6444;
v_6440:
    v_6501 = v_6503;
    v_6502 = qcar(v_6501);
...
v_6441:
    goto v_6442;
v_6443:
    if (equal(v_6502, v_6501)) goto v_6438;
    else goto v_6439;
v_6438:
    goto v_6452;
v_6448:
...
v_6449:
    goto v_6450;
v_6451:
    v_6501 = (v_6502 == v_6501 ? lisp_true : nil);
    goto v_6437;
v_6439:
    v_6501 = nil;
    goto v_6437;
...
v_6464:
    ...
    goto v_6328;
v_6435:
    v_6501 = qvalue(elt(env, 3)); // !*resubs
    if (v_6501 == nil) goto v_6468;
    else goto v_6469;
v_6468:
    goto v_6328;
v_6469:
    v_6501 = qvalue(elt(env, 4)); // !*sub2
    if (v_6501 == nil) goto v_6473;
    else goto v_6471;
v_6473:
    v_6501 = qvalue(elt(env, 5)); // powlis1!*
    if (v_6501 == nil) goto v_6475;
    else goto v_6471;
v_6475:
    goto v_6472;
v_6471:
...
v_6485:
    fn = elt(env, 6); // addsq
    v_6501 = (*qfn2(fn))(fn, v_6501, v_6502);
    env = stack[-4];
    stack[-3] = v_6501;
    v_6501 = stack[-2];
    v_6501 = qcdr(v_6501);
...
setup_type const u12_setup[] =
{
    ...
    {NULL, (one_args *)"u12", (two_args *)"117705 4819786 5558605", 0}
};
