...
v_8660:
    {
        LispObject v_8680 = stack[0];
        return Lgreaterp(nil, v_8680, v_8672);
    }
    v_8672 = nil;
    goto v_8561;
    v_8672 = nil;
...
{   bind_fluid_stack bind_fluid_var(-8, 1, -4);
    ...
    v_8839 = lisp_true;
    qvalue(elt(env, 1)) = v_8839; // !*exp
    v_8839 = stack[-5];
    if (!consp(v_8839)) goto v_8478;
    else goto v_8479;
v_8478:
    v_8839 = lisp_true;
    goto v_8477;
v_8479:
    v_8839 = stack[-5];
    v_8839 = qcar(v_8839);
    v_8839 = (consp(v_8839) ? nil : lisp_true);
    goto v_8477;
    v_8839 = nil;
v_8477:
    if (v_8839 == nil) goto v_8475;
    goto v_8492;
v_8488:
    v_8840 = stack[-6];
    goto v_8489;
...
v_8491:
    fn = elt(env, 2); // qremd
    v_8839 = (*qfn2(fn))(fn, v_8840, v_8839);
    goto v_8468;
v_8475:
    v_8839 = nil;
    v_8839 = ncons(v_8839);
...
v_8516:
    fn = elt(env, 3); // praddf
    v_8839 = (*qfn2(fn))(fn, stack[0], v_8839);
    goto v_8468;
v_8500:
    goto v_8533;
v_8529:
...
v_8554:
    goto v_8555;
v_8556:
    v_8840 = difference2(v_8840, v_8839);
    env = stack[-8];
    stack[-7] = v_8840;
    goto v_8548;
v_8549:
    v_8839 = (LispObject)0+TAG_FIXNUM; // 0
    goto v_8550;
v_8551:
    goto v_8547;
v_8548:
    goto v_8549;
v_8550:
    v_8839 = (LispObject)lessp2(v_8840, v_8839);
    v_8839 = v_8839 ? lisp_true : nil;
    env = stack[-8];
    if (v_8839 == nil) goto v_8545;
    goto v_8572;
v_8568:
    stack[0] = stack[-1];
    goto v_8569;
...
v_8586:
    goto v_8587;
v_8588:
    v_8839 = CC_qremf(elt(env, 0), v_8840, v_8839);
    env = stack[-8];
    stack[-3] = v_8839;
    goto v_8601;
v_8597:
...
v_8604:
    ...
    goto v_8605;
v_8606:
    v_8839 = (LispObject)16+TAG_FIXNUM; // 1
    goto v_8607;
v_8608:
    goto v_8604;
v_8605:
...
v_8660:
    fn = elt(env, 5); // to
    v_8840 = (*qfn2(fn))(fn, v_8840, v_8839);
    env = stack[-8];
    goto v_8652;
v_8653:
    v_8839 = (LispObject)16+TAG_FIXNUM; // 1
...
v_8698:
    fn = elt(env, 4); // multf
    v_8839 = (*qfn2(fn))(fn, stack[-6], v_8839);
    env = stack[-8];
    goto v_8691;
v_8692:
    goto v_8688;
...
v_8691:
    fn = elt(env, 7); // addf
    stack[0] = (*qfn2(fn))(fn, stack[0], v_8839);
    env = stack[-8];
    goto v_8683;
v_8684:
    v_8839 = stack[-2];
...
v_8803:
    fn = elt(env, 4); // multf
    stack[0] = (*qfn2(fn))(fn, v_8840, v_8839);
    env = stack[-8];
    goto v_8795;
v_8796:
    goto v_8823;
...
v_8790:
    fn = elt(env, 3); // praddf
    v_8839 = (*qfn2(fn))(fn, stack[-1], v_8839);
    env = stack[-8];
    stack[-1] = v_8839;
    v_8839 = stack[-6];
    v_8839 = qcdr(v_8839);
...
{   bind_fluid_stack bind_fluid_var(-1, 1, 0);
    qvalue(elt(env, 1)) = v_8465; // !*!*noremove!*!*
    v_8465 = v_8466;
    fn = elt(env, 2); // remove!-free!-vars
    v_8465 = (*qfn1(fn))(fn, v_8465);
    ;}  // end of a binding scope
    return onevalue(v_8465);
}
...
{
    env = qenv(env);
    LispObject v_8568, v_8569, v_8570;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
// copy arguments values to proper place
    stack[-1] = v_8459;
// end of prologue
    v_8568 = (LispObject)0+TAG_FIXNUM; // 0
    v_8570 = v_8568;
v_8468:
    v_8568 = stack[-1];
    if (!consp(v_8568)) goto v_8475;
    else goto v_8476;
v_8475:
    v_8568 = lisp_true;
    goto v_8474;
v_8476:
    v_8568 = stack[-1];
    v_8568 = qcar(v_8568);
    v_8568 = (consp(v_8568) ? nil : lisp_true);
    goto v_8474;
    v_8568 = nil;
v_8474:
    if (v_8568 == nil) goto v_8472;
    goto v_8467;
v_8472:
    goto v_8490;
v_8486:
...
v_8493:
    ...
    stack[0] = v_8568;
    fn = elt(env, 1); // sfp
    v_8568 = (*qfn1(fn))(fn, v_8568);
    env = stack[-3];
    if (v_8568 == nil) goto v_8501;
    v_8568 = stack[0];
    v_8568 = CC_tmsf(elt(env, 0), v_8568);
    env = stack[-3];
    stack[0] = v_8568;
    goto v_8499;
v_8501:
    v_8568 = (LispObject)16+TAG_FIXNUM; // 1
    stack[0] = v_8568;
    goto v_8499;
    stack[0] = nil;
v_8499:
...
v_8534:
    ...
    goto v_8535;
v_8536:
    v_8568 = (LispObject)32+TAG_FIXNUM; // 2
    goto v_8537;
v_8538:
    goto v_8534;
v_8535:
...
v_8464:
    ...
    v_8514 = (*qfn1(fn))(fn, v_8514);
    env = stack[-4];
    stack[-3] = v_8514;
    v_8514 = stack[-3];
    if (v_8514 == nil) goto v_8481;
    else goto v_8482;
v_8481:
    v_8514 = nil;
    goto v_8475;
v_8482:
    v_8514 = stack[-3];
    v_8514 = qcar(v_8514);
    v_8514 = CC_talp_td(elt(env, 0), v_8514);
    env = stack[-4];
    v_8514 = ncons(v_8514);
    env = stack[-4];
    stack[-1] = v_8514;
...
v_8501:
    goto v_8502;
v_8503:
    v_8514 = Lrplacd(nil, stack[0], v_8514);
    env = stack[-4];
    v_8514 = stack[-1];
    v_8514 = qcdr(v_8514);
    stack[-1] = v_8514;
...
v_8464:
    v_8472 = qcdr(v_8472);
    v_8472 = (v_8472 == nil ? lisp_true : nil);
    goto v_8462;
    v_8472 = nil;
v_8462:
    return onevalue(v_8472);
}
...
// end of prologue
    ...
    v_8464 = (*qfn1(fn))(fn, v_8464);
    v_8464 = (v_8464 == nil ? lisp_true : nil);
    return onevalue(v_8464);
}
...
v_8505:
    ...
    stack[-2] = (*qfn2(fn))(fn, v_8520, v_8519);
    env = stack[-3];
    goto v_8497;
v_8498:
    goto v_8515;
...
v_8512:
    goto v_8513;
v_8514:
    v_8519 = CC_sq2sscfpl(elt(env, 0), v_8520, v_8519);
    goto v_8499;
v_8500:
    goto v_8496;
v_8497:
...
v_8499:
    {
        LispObject v_8524 = stack[-2];
        return Lappend(nil, v_8524, v_8519);
    }
    v_8519 = nil;
v_8463:
...
setup_type const u16_setup[] =
{
    ...
    {NULL, (one_args *)"u16", (two_args *)"68931 2012172 6513738", 0}
};
