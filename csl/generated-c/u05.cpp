...
v_18:
    ...
    v_94 = stack[-2];
    fn = basic_elt(env, 3); // prepd
    stack[-2] = (*qfn1(fn))(fn, v_94);
    env = stack[-4];
    v_94 = stack[-1];
    fn = basic_elt(env, 4); // exchk
    v_94 = (*qfn1(fn))(fn, v_94);
    env = stack[-4];
    v_94 = cons(stack[-2], v_94);
    env = stack[-4];
    fn = basic_elt(env, 5); // retimes
    v_94 = (*qfn1(fn))(fn, v_94);
    env = stack[-4];
    v_96 = v_94;
    v_95 = v_96;
    v_94 = basic_elt(env, 1); // plus
    if (!consp(v_95)) goto v_40;
    v_95 = qcar(v_95);
    if (v_95 == v_94) goto v_39;
    else goto v_40;
v_39:
    v_94 = v_96;
...
v_16:
    ...
    if (!car_legal(v_94)) v_94 = carerror(v_94); else
    v_94 = qcar(v_94);
    if (!car_legal(v_94)) stack[-3] = cdrerror(v_94); else
    stack[-3] = qcdr(v_94);
    v_94 = stack[-2];
    if (!car_legal(v_94)) v_94 = carerror(v_94); else
    v_94 = qcar(v_94);
    ...
    v_95 = qcar(v_94);
    v_94 = basic_elt(env, 2); // k!*
    if (v_95 == v_94) goto v_76;
    else goto v_77;
v_76:
    v_94 = stack[-1];
    v_95 = v_94;
...
v_75:
    v_94 = stack[0];
    v_94 = CC_prepf1a_reversed(basic_elt(env, 0), stack[-3], v_95, v_94);
    env = stack[-4];
    stack[0] = v_94;
    v_94 = stack[-2];
    if (!car_legal(v_94)) v_94 = cdrerror(v_94); else
...
{   bind_fluid_stack bind_fluid_var(-4, 2, 0);
    qvalue(basic_elt(env, 2)) = v_62; // !*roundall
    v_63 = stack[-2];
    v_62 = stack[-1];
    fn = basic_elt(env, 5); // quotf
    v_62 = (*qfn2(fn))(fn, v_63, v_62);
...
setup_type const u05_setup[] =
{
    ...
    {NULL, (no_args *)"u05", (one_arg *)"142675 4931277 4679738",
        NULL, NULL, NULL}
};
