...
v_17:
    ...
    v_28 = (LispObject)((std::intptr_t)(v_28) + 0x10);
    goto v_5;
    v_28 = nil;
v_5:
...
v_16:
    ...
    if (!car_legal(v_296)) v_296 = carerror(v_296); else
    v_296 = car(v_296);
    {   LispObject fn = basic_elt(env, 1); // lto_delq
...
v_55:
    ...
    stack[0] = cdr(v_296);
    v_296 = stack[-1];
    {   LispObject fn = basic_elt(env, 3); // ibalp_calcmom
...
v_141:
    ...
    env = stack[-6];
    v_296 = stack[-3];
    {   LispObject fn = basic_elt(env, 4); // ibalp_getnewwl
    v_296 = (*qfn1(fn))(fn, v_296);
    }
    env = stack[-6];
    stack[-1] = v_296;
...
setup_type const u18_setup[] =
{
    ...
    {NULL, (no_args *)"u18", (one_arg *)"172187 4366394 2013585",
        NULL, NULL, NULL}
};
