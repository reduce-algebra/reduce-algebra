...
// end of prologue
    stack[-9] = nil;
    v_3257 = qvalue(elt(env, 1)); // itemset_collection
    stack[-4] = v_3257;
v_3106:
    v_3257 = stack[-4];
...
{
    env = qenv(env);
    LispObject v_3364, v_3365, v_3366;
    LispObject fn;
#ifdef CHECK_STACK
    if_check_stack;
#endif
...
v_3107:
    {
        fn = elt(env, 1); // nreverse
        return (*qfn2(fn))(fn, v_3365, v_3364);
    }
v_3101:
    v_3364 = stack[-1];
    if (v_3364 == nil) goto v_3111;
    else goto v_3112;
v_3111:
    goto v_3119;
v_3115:
...
v_3127:
    v_3364 = stack[-2];
    v_3364 = qcar(v_3364);
    v_3364 = (consp(v_3364) ? nil : lisp_true);
    goto v_3125;
    v_3364 = nil;
v_3125:
    if (v_3364 == nil) goto v_3123;
    v_3364 = stack[-1];
    if (!consp(v_3364)) goto v_3141;
    else goto v_3142;
v_3141:
    v_3364 = lisp_true;
    goto v_3140;
...
v_3162:
    ...
    v_3364 = (*qfn2(fn))(fn, v_3365, v_3364);
    env = stack[-4];
    fn = elt(env, 3); // !*n2f
    v_3364 = (*qfn1(fn))(fn, v_3364);
    env = stack[-4];
    goto v_3154;
v_3155:
    goto v_3151;
...
v_3154:
    {
        LispObject v_3371 = stack[0];
        fn = elt(env, 1); // nreverse
        return (*qfn2(fn))(fn, v_3371, v_3364);
    }
v_3138:
    goto v_3173;
v_3169:
...
v_3206:
    goto v_3207;
v_3208:
    if (equal(v_3365, v_3364)) goto v_3203;
    else goto v_3204;
v_3203:
    goto v_3221;
v_3217:
...
v_3225:
    goto v_3226;
v_3227:
    stack[0] = CC_generalKplusKmodKp(elt(env, 0), v_3365, v_3364);
    env = stack[-4];
    goto v_3240;
v_3236:
    v_3364 = stack[-2];
...
v_3237:
    goto v_3238;
v_3239:
    v_3364 = CC_generalKplusKmodKp(elt(env, 0), v_3365, v_3364);
    env = stack[-4];
    v_3365 = stack[0];
    v_3366 = v_3365;
    if (v_3366 == nil) goto v_3249;
    else goto v_3250;
v_3249:
    goto v_3248;
v_3250:
...
v_3259:
    goto v_3260;
v_3261:
    v_3364 = acons(v_3366, v_3365, v_3364);
    env = stack[-4];
    goto v_3248;
    v_3364 = nil;
v_3248:
...
v_3220:
    {
        LispObject v_3372 = stack[-3];
        fn = elt(env, 1); // nreverse
        return (*qfn2(fn))(fn, v_3372, v_3364);
    }
v_3204:
    goto v_3279;
v_3275:
...
v_3276:
    goto v_3277;
v_3278:
    if (equal(v_3365, v_3364)) goto v_3273;
    else goto v_3274;
v_3273:
    goto v_3292;
v_3288:
...
v_3289:
    goto v_3290;
v_3291:
    v_3364 = ((intptr_t)v_3365 > (intptr_t)v_3364) ? lisp_true : nil;
    goto v_3272;
v_3274:
    v_3364 = nil;
    goto v_3272;
...
v_3311:
    goto v_3312;
v_3313:
    if (equal(v_3365, v_3364)) goto v_3309;
    goto v_3328;
v_3324:
    v_3364 = stack[-2];
    v_3364 = qcar(v_3364);
...
v_3107:
    ...
    v_3158 = qcdr(v_3158);
    v_3158 = qcar(v_3158);
    v_3158 = Labsval(nil, v_3158);
    env = stack[-5];
    fn = elt(env, 2); // msd
    v_3158 = (*qfn1(fn))(fn, v_3158);
    env = stack[-5];
    v_3158 = add1(v_3158);
    env = stack[-5];
    goto v_3108;
...
v_3101:
    ...
    v_3158 = (*qfn2(fn))(fn, stack[-3], v_3158);
    env = stack[-5];
    stack[-3] = v_3158;
    goto v_3124;
v_3118:
...
v_3140:
    goto v_3141;
v_3142:
    v_3158 = difference2(v_3159, v_3158);
    env = stack[-5];
    goto v_3123;
v_3124:
    goto v_3118;
...
v_3121:
    goto v_3122;
v_3123:
    v_3158 = list2star(stack[-4], stack[0], v_3158);
    env = stack[-5];
    stack[-3] = v_3158;
    goto v_3155;
v_3151:
...
{
    env = qenv(env);
    LispObject v_3227, v_3228, v_3229;
    LispObject fn;
    LispObject v_3094, v_3093, v_3092, v_3091;
    va_list aa;
    va_start(aa, nargs);
...
v_3109:
    fn = elt(env, 1); // mchk
    v_3227 = (*qfn2(fn))(fn, v_3228, v_3227);
    env = stack[-11];
    v_3228 = v_3227;
    v_3227 = stack[-9];
    v_3227 = qcdr(v_3227);
...
v_3153:
    ...
    stack[0] = (*qfnn(fn))(fn, 3, v_3229, v_3228, v_3227);
    env = stack[-11];
    goto v_3140;
v_3141:
    goto v_3163;
...
v_3162:
    ...
    v_3228 = (*qfn2(fn))(fn, v_3228, v_3227);
    env = stack[-11];
    goto v_3142;
v_3143:
    v_3227 = stack[-6];
...
v_3142:
    goto v_3143;
v_3144:
    v_3227 = CC_mcharg2(elt(env, 0), 4, stack[-1], stack[0], v_3228, v_3227);
    env = stack[-11];
    stack[-5] = v_3227;
    v_3227 = stack[-5];
    fn = elt(env, 4); // lastpair
    v_3227 = (*qfn1(fn))(fn, v_3227);
    env = stack[-11];
    stack[-4] = v_3227;
    v_3227 = stack[-10];
    v_3227 = qcdr(v_3227);
...
v_3184:
    goto v_3185;
v_3186:
    v_3227 = Lrplacd(nil, stack[-3], v_3227);
    env = stack[-11];
    v_3227 = stack[-4];
    fn = elt(env, 4); // lastpair
    v_3227 = (*qfn1(fn))(fn, v_3227);
...
setup_type const u07_setup[] =
{
    ...
    {NULL, (one_args *)"u07", (two_args *)"172863 5679913 7658343", 0}
};
