...
echo "Date;Lisp;Test;Status;RefCpu;Cpu;DeltaCpu;RefGc;Gc;DeltaGc" > $log/regression-times.csv

if [ ! -f $timefile ]; then
    echo "Date;Lisp;Test;Status;RefCpu;Cpu;DeltaCpu;RefGc;Gc;DeltaGc" > $timefile
fi
