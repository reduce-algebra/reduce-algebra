...
"""))
        ...
        title_rest = "{:d} problems with at least 1 CPU time $\\geq$ 60 s".format(
            n_rest)
...
"""))
        ...
        if not combo_rest.empty:
            summary.write(
                html.plot_scatter_ref_now(combo_rest, title=title_rest))
        summary.write("</div>")
