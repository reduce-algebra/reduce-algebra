...
def summary(
    ...
    with open(summary_html, mode="w") as summary:
        ...
        if not combo_bad.empty:
            ...
            summary.write(
                html.
                p('Benchmark problems with existing "now" logs that were tested '
        ...
        summary.write(
            html.
            p('"Average CPU time" refers to the arithmetic mean between the CSL '
        ...
        if not combo60.empty:
            summary.write(
                html.plot_scatter(combo60,
                                  title="Average CPU times more than 1 min"))
        summary.write("</div>")
        ...
        if not combo0.empty:
            ...
            summary.write(
                html.
                p("Benchmark problems with an average of CSL and PSL CPU times between "
        ...
        if not combo1.empty:
            ...
            summary.write(
                html.
                p("Benchmark problems with an average of CSL and PSL CPU time between "
        ...
        if not combo60.empty:
            ...
            summary.write(
                html.
                p("Benchmark problems with an average of CSL and PSL CPU time of more "
