...
A script interface to rbench. Supports automated parallel computation of benchmark sets, cron jobs,
and generation and display of an HTML summary.
"""
...
def cron(args):
    ...
    print("</code>")
    print("</pre>")
    analytics.summary(ref=args.source,
                      now=args.result,
                      dump=True,
                      full_html=False)
    print(html.end)
