...
<head>
	...
	<title>REDUCE Bibliography</title>
...
<body>
	<div class="container-fluid">
		<header><img src="images/icon.png" class="d-none d-md-block" />Bibliography</header>
		<div class="row">
			...
			<div id="main" class="col-md-9 col-xl-7">
				...
				<dl>
					...
					<dd><a href="http://link.aps.org/doi/10.1103/PhysRevA.27.530">Analytic evaluation of an O(&#945;) vertex correction to the rate of orthopositronium</a>. <em>Phys. Rev. A</em> <strong>27</strong> no. 1, pages 530-532, 1983.</dd>
					...
					<dd><a href="http://link.aps.org/doi/10.1103/PhysRevLett.24.562">The order &#945;<sup>2</sup> electrodynamic corrections to the Lamb shift</a>. <em>Physical Review Letters</em> <strong>24</strong> no. 11, pages 562-565, 1970.</dd>
					...
					<dt id="Audoly:98">[Audoly:98] S.&nbsp;Audoly, L.&nbsp;D'Angio', M.P. Saccomani, and C.&nbsp;Cobelli.</dt>
					...
					<dd><a href="http://dx.doi.org/10.1007/BF01552334">Decay B &#8594; D l <span style="text-decoration: overline;">&#957;</span> from QCD sum rules</a>. <em>Zeitschrift f&uuml;r Physik C. Particles and Fields</em> <strong>47</strong>, pages 669-675, 1990.</dd>
					...
					<dd><a href="http://link.aps.org/abstract/PRD/v73/e074021">Topics in associated j/&#968; + c + <span style="text-decoration: overline;">c</span> production at modern colliders</a>. <em>Physical Review D (Particles and Fields)</em> <strong>73</strong> no. 7, page 074021, 2006.</dd>
					<dt id="Baranov:08">[Baranov:08] S.&nbsp;P. Baranov and A.&nbsp;Szczurek.</dt>
					<dd><a href="http://arxiv.org/abs/0710.1792">Inclusive production of j/&#968; meson in proton-proton collisions at bnl rhic</a>. <em>Physical Review D (Particles and Fields)</em> <strong>77</strong> no. 5, page 054016, 2008.</dd>
					...
					<dd><a href="http://arxiv.org/abs/hep-ph/0504223">A new method for calculation of traces of dirac &#947;-matrices in minkowski space</a>. <em>Nuclear Physics B</em>
						<strong>733</strong> no. 1-2, pages 48-58, January 2006.</dd>
					...
					<dd><a href="http://dx.doi.org/10.1007/BF01559486">Three-loop on-shell charge renormalization without integration: &#923;<sup><span style="text-decoration: overline;">MS</span></sup><sub>QED</sub> to four loops</a>. <em>Zeitschrift f&uuml;r Physik C. Particles and Fields</em> <strong>54</strong> no. 4, pages 599-606, December 1992.</dd>
					...
					<dd>On the enumeration of irreducible &#954;-fold euler sums and their roles in knot theory and field theory. Technical Report OUT-4102-62, Open University, Milton Keynes MK7 6AA, England, April 1996.</dd>
					...
					<dd>Analysis of the differential equations for the exclusive processes and explanation for the ``Mystery'' of the Gamma-Distribution. Preprint E2-89-286, JINR, 1989.</dd>
					...
					<dd><a href="http://link.aps.org/doi/10.1103/PhysRev.168.1801">Phenomenological analysis of the &#947;nn* form factors</a>. <em>Phys. Rev.</em> <strong>168</strong> no. 5, pages 1801-1809, 1969.</dd>
					...
					<dd>Calculation of one-loop diagrams of 1 &#8594; 2 decays with REDUCE. In: <em>Proc. Int. Conf. on Computer Algebra in Theoretical Physics, Dubna</em>, pages 226-231, 1983.</dd>
					...
					<dd><a href="http://dx.doi.org/10.1016/0370-2693(80)90118-5">The connection between the &#923; parameters of lattice and continuum QCD</a>. <em>Physics Letters B</em> <strong>93</strong> no. 1-2, pages 165-169, June 1980.</dd>
					...
					<dd><a href="http://dx.doi.org/10.1007/3-540-51517-8_120">DIMREG - the package for calculations in the dimensional regularization with 4-dimensional &#947;<sup>5</sup>
					...
					<dd><a href="http://arxiv.org/abs/nlin/0511056v1">On weakly non-local, nilpotent, and super-recursion operators for n=1 homogeneous super-equations</a>. In: <em>Proc. Int. Workshop `Supersymmetries and Quantum Symmetries-05 (SQS'05)</em>, pages 234-240. JINR, 2005. preprint, to appear in proceedings of Dubna International Workshop ``Supersymmetries and Quantum Symmetries'' (SQS'05), arXiv math-ph/0511056.</dd>
					...
					<dd><a href="http://dx.doi.org/10.1016/0010-4655(81)90129-6">A program for computing the conical functions of the first kind P<sup>m</sup><sub>-1/2+i&#964;</sub>(x) for m = 0 and m = 1</a>. <em>Computer Physics Communications</em> <strong>23</strong> no. 1, pages 51-61, 1981.</dd>
					<dt id="Koelbig:82">[Koelbig:82] K.&nbsp;S. K&ouml;lbig.</dt>
					<dd>Closed expressions for &#8747;<sub>0</sub><sup>1</sup> t<sup>-1</sup>&nbsp;log<sup>n-1</sup> t log<sup>p</sup>(1-t) dt. <em>Math. Comp.</em> <strong>39</strong> no. 160, pages 647-654, October 1982.</dd>
					<dt id="Koelbig:83">[Koelbig:83] K.&nbsp;S. K&ouml;lbig.</dt>
					<dd>On the integral &#8747;<sub>0</sub><sup>&#960;/2</sup>&nbsp;log<sup>n</sup> cos x&nbsp;log<sup>p</sup> sin x dx. <em>Math. Comp.</em> <strong>40</strong>, pages 565-570, April 1983.</dd>
					<dt id="Koelbig:83a">[Koelbig:83a] K.&nbsp;S. K&ouml;lbig.</dt>
					<dd>On the integral &#8747;<sub>0</sub><sup>&#8734;</sup>&nbsp;e<sup>-&#956; t</sup>&nbsp;t<sup>&#957;-1</sup>&nbsp;log<sup>m</sup>t&nbsp;dt. <em>Math. Comp.</em> <strong>41</strong>, pages 171-182, 1983.</dd>
					...
					<dd><a href="http://dx.doi.org/10.1016/0377-0427(86)90070-1">On the integral &#8747;<sub>0</sub><sup>&#8734;</sup>&nbsp;x<sup>&#957;-1</sup>&nbsp;(1+&#946; x)<sup>-&#955;</sup>&nbsp;ln<sup>m</sup>x&nbsp;dx</a>. <em>Journal of Comp. and Appl. Math.</em> <strong>14</strong> no. 3, pages 319-344, March 1986.</dd>
					<dt id="Koelbig:85">[Koelbig:85] K.&nbsp;S. K&ouml;lbig.</dt>
					<dd><a href="http://documents.cern.ch/cgi-bin/setlink?base=generic&categ=public&id=cer-000074639">On the integral &#8747;<sub>0</sub><sup>1</sup>&nbsp;x<sup>&#957;-1</sup>&nbsp;(1-x)<sup>-&#955;</sup>&nbsp;ln<sup>m</sup>x&nbsp;dx</a>. <em>Journal of Computational and Applied Mathematics</em> <strong>18</strong> no. 3, pages 369-394, June 1987.</dd>
					...
					<dd><a href="http://arxiv.org/abs/hep-ph/0608287">Next-to-next-to-leading order O(&#945;<sup>2</sup> &#945;<sub>S</sub><sup>2</sup>) results for top quark pair production in photon-photon collisions: The one-loop squared contributions</a>. <em>Physical Review D (Particles and Fields)</em> <strong>74</strong> no. 9, page 094006, 2006.</dd>
					<dt id="Koerner:06a">[Koerner:06a] J.&nbsp;G. K&ouml;rner, Z.&nbsp;Merebashvili, and M.&nbsp;Rogal.</dt>
					<dd><a href="http://arxiv.org/abs/hep-ph/0511264">One-loop amplitudes for four-point functions with two external massive quarks and two external massless partons up to O(&#949;<sup>2</sup>)</a>. <em>Physical Review D (Particles and Fields)</em> <strong>73</strong> no. 3, page 034030, 2006.</dd>
					...
					<dd><a href="http://dx.doi.org/10.1016/0010-4655(88)90052-5">Program ``COLOR'' for computing the group-theoretic weight of Feynman diagrams in Non-Abelian gauge theories</a>. <em>Computer Physics Communications</em> <strong>48</strong> no. 2, pages 327-334, February 1988.</dd>
					...
					<dd>Symmetry breaking and &#960; K amplitudes in the unphysical region. Report UNIGRAZ-UTP 08/79, Institut f&uuml;r Theor. Physik, Univ. Graz, 1979.</dd>
					...
					<dd>Signature for W boson production from jet analysis in e<sup>+</sup>e<sup>-</sup> &#8594; W<sup>+</sup>W<sup>-</sup> &#8594; hadrons. Preprint 78/P.1019, CPT 2, CNRS, Marseille, June 1978.</dd>
					...
					<dd>Computa&ccedil;&atilde;o alg&eacute;brica: ``um assistente matem&atilde;tico''. <em>Ci&ecirc;ncia e Cultura</em> <strong>40</strong> no. 9, pages 843-852, September 1988.</dd>
					...
					<dt id="Saccomani:96">[Saccomani:96] M.P. Saccomani, S.&nbsp;Audoly, L.&nbsp;D'Angio', and C.&nbsp;Cobelli.</dt>
					...
					<dt id="Saccomani:97">[Saccomani:97] M.P. Saccomani, S.&nbsp;Audoly, L.&nbsp;D'Angio', and C.&nbsp;Cobelli.</dt>
					...
					<dt id="Saccomani:94a">[Saccomani:94a] M.P. Saccomani, S.&nbsp;Audoly, L.&nbsp;D'Angio', R.&nbsp;Sattier, and C.&nbsp;Cobelli.</dt>
					...
					<dt id="Saccomani:94">[Saccomani:94] M.P. Saccomani, R.&nbsp;Sattier, L.&nbsp;D'Angio', S.&nbsp;Audoly, and C.&nbsp;Cobelli.</dt>
					...
					<dd><a href="http://dx.doi.org/10.1002/prop.19800280403">An approximation scheme for constructing &#960;<sub>0</sub>&#960; amplitudes from ACU requirements</a>.  <em>Fortschritte der Physik</em> <strong>28</strong> no. 4, pages 201-235, 1980.</dd>
					...
					<dd>The use of ``LET'' statements in producing short comprehended outputs. Technical Report Technion-PH-77-36, Department of Physics, Technion-Israel Institute of Technology, Haifa, Israel, 1977.</dd>
					<dt id="Silagadze:06">[Silagadze:06] Z.&nbsp;K. Silagadze.</dt>
					<dd><a href="http://arxiv.org/abs/hep-ph/0606284">Two-photon contributions to e<sup>+</sup>e<sup>-</sup>&#8594;&eta;&#947; and e<sup>+</sup>e<sup>-</sup>&#8594; &eta;'&#947;</a>. <em>Physical Review D (Particles and Fields)</em> <strong>74</strong> no. 5, page 054003, 2006.</dd>
					...
					<dt id="Triulzi:00">[Triulzi:00]</dt>
					<dd>A.&nbsp;Triulzi and T.&nbsp;Wolf, <a href="http://lie.math.brocku.ca/twolf/papers/sub.ps">Recognizing overdetermined subsystems of systems of equations</a>. 2000.</dd>
					...
					<dt id="Wolf:98c">[Wolf:98c]</dt>
					<dd>T.&nbsp;Wolf, <a href="http://www.springer.com/math/cse/book/978-3-540-65466-7"><em>Conservation Laws for Geodesic Motion in Curved Spaces and PDEs</em></a>, chapter 3.1.5.1, pages 187-190. Springer, 2002.</dd>
					<dt id="Wolf:98b">[Wolf:98b]</dt>
					<dd>T.&nbsp;Wolf, <a href="http://www.springer.com/math/cse/book/978-3-540-65466-7"><em>Crack, LiePDE, ApplySym and ConLaw</em></a>, chapter 4.3.5 and on CD-ROM, pages 465-468. Springer, 2002.</dd>
					...
					<dt id="Wolf:04b">[Wolf:04b]</dt>
					<dd>T.&nbsp;Wolf, <a href="http://lie.math.brocku.ca/twolf/papers/merge-sig.ps">Merging solutions of polynomial algebraic systems</a>. preprint,, 2004.</dd>
					...
					<dt id="Wolf:07">[Wolf:07]</dt>
					<dd>T.&nbsp;Wolf, <a href="http://lie.math.brocku.ca/twolf/papers/uode.pdf">The parametric solution of underdetermined linear ODEs</a>. preprint, 2007.</dd>
					...
					<dd><a href="https://sites.google.com/site/fjwcentaur/papers/ore_lodo.pdf">REDUCE Implementation of Primitives for Univariate Skew Polynomials and Linear Ordinary Differential Operators: A progress report</a>. Technical report, Queen Mary, University of London, January 1995.</dd>
					<dt id="Wright:97">[Wright:97] F.&nbsp;J. Wright.</dt>
					<dd><a href="https://sites.google.com/site/fjwcentaur/papers/odesolve.pdf">An Enhanced ODE Solver for REDUCE</a>. <i>Programming and Computer Software</i> No 3, 1997, in English, and <i>Programmirovanie</i> No 3, 1997, pp 5–22, in Russian.</dd>
					<dt id="Wright:99">[Wright:99] F.&nbsp;J. Wright.</dt>
					<dd><a href="https://sites.google.com/site/fjwcentaur/papers/ODESolve_talk.pdf">Design and Implementation of ODESolve 1+ : An Enhanced REDUCE ODE Solver</a>. Technical report, Queen Mary, University of London, May 1999.</dd>
					<dt id="Wright:99a">[Wright:99a] F.&nbsp;J. Wright.</dt>
					<dd><a href="https://sites.google.com/site/fjwcentaur/papers/WebDemo_talk.pdf">Design and Implementation of Web-Based Software Demonstrations</a>. Technical report, Queen Mary, University of London, May 1999.</dd>
					...
					<dd><a href="https://sites.google.com/site/fjwcentaur/papers/SpecfnODEs.pdf">Recognising and Solving Special Function ODEs</a>. Technical report, Queen Mary, University of London, January 2000.</dd>
