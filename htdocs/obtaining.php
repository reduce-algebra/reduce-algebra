	...
	<div id="content">
		...
		<div id="middle">
			...
			<div id="main">
				...
				<p>If you have <a href="http://www.cygwin.com/">Cygwin</a> installed then the REDUCE installer will automatically add a number of commands to the Cygwin /usr/local/bin/ directory, in particular redcsl and redpsl. These commands are therefore automatically accessible from a Cygwin shell and run respectively the GUI and command-line versions of REDUCE described above.</p>
			</div>
			<!--/#main-->
		</div>
		<!--/#middle-->
