			...
			<div id="main">
				...
				<p>
					This is to download and install a pre-packaged REDUCE release that contains all necessary binary files as well as documentation (and the main REDUCE source code). We currently release REDUCE in this way primarily for Microsoft Windows, Apple MacOS and some versions of GNU/Linux. This approach should work well if you use a supported platform and don't need the very latest version. Simply click on the <a href="https://sourceforge.net/p/reduce-algebra/" rel="nofollow">
						<img class="sflogo" alt="Download REDUCE" src="https://sourceforge.net/sflogo.php?type=10&group_id=248416"></a> logo to visit the project page and then, towards the top of the page, you should see a green box containing the word Download with a filename below it. SourceForge uses heuristics to pick a recent distribution file with an appropriate extension for your platform automatically (although it might get it wrong, especially for GNU/Linux).
				</p>
				<p>
				...
				<h3>Microsoft Windows and Apple MacOS</h3>
				<p>
					On Microsoft Windows or Apple MacOS you should see a filename of the form:
				</p>
				<ul>
				...
				<p>
					where <em>yyyy-mm-dd</em> represents the release date in numerical format.</p>
				<p>
				...
				<h3>GNU/Linux</h3>
				<p>
					On GNU/Linux you are probably best advised to ignore the default download file and proceed as follows. Below the green box is a link labelled Browse All Files, and clicking on either that link or the Files link on the toolbar takes you to a page offering recent REDUCE releases for all supported platforms. Each release is a directory, which normally contains the Windows and MacOS distribution files as described above plus a generic source code bundle in the form of a <a href="https://en.wikipedia.org/wiki/Tar_(computing)">compressed tar archive</a> and sets of distribution files for GNU/Linux in the form of <a>compressed tar archives</a>, <a href="https://en.wikipedia.org/wiki/Rpm_(software)">.rpm files</a> and <a href="https://en.wikipedia.org/wiki/Deb_(file_format)">.deb files</a>.</p>
				<p>
