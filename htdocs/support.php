		...
		<div id="middle">
			...
			<div id="main">
				<dl>
					...
					<dd>For CSL REDUCE, running <code>redcsl --nogui --help</code> at a command prompt (assuming <code>redcsl</code> is on your search path – see <a href="obtaining.php">Obtaining REDUCE</a>) lists the start-up options.</dd>
				</dl>
