...
(rdf "$pxc/sys-dm.sl")
(rdf "$pxc/tags.sl")
(rdf "$pxc/macintel64-lap.sl")
(rdf "$pxc/macintel64-cmac.sl")
(rdf "$pxc/macintel64-comp.sl")
(rdf "$pc/faslout.sl")
(rdf "$pxc/macintel64-spec.sl")
...
% (rdf "$pxc/unixmacintel64-lap-to-asm.sl")
% (rdf "$pxc/unixmacintel64-asm.sl")
