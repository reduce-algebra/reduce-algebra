...
# Here I specialise what I am doing to build JUST the mingw-w64 versions
...
export MACHINE=mingw-w64

export PXK=../psl/dist/kernel/mingw-w64
...
script -c "./vsl -i Winasm.img tmp.sl" Winmain.log
