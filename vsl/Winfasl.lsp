...
(setq @psys "../psl/dist/bin/mingw-w64")

(setq @pl   "../psl/dist/lap/mingw-w64")

(setq @pk   "../psl/dist/kernel")
(setq @pxk  "../psl/dist/kernel/mingw-w64")

(setq @pnk  "../psl/dist/nonkernel")
(setq @pxnk "../psl/dist/nonkernel/mingw-w64")
(setq @pnkl "../psl/dist/nonkernel/mingw-w64/lap")

(setq @pc   "../psl/dist/comp")
(setq @pxc  "../psl/dist/comp/mingw-w64")

(setq @pu   "../psl/dist/util")
(setq @pxu  "../psl/dist/util/mingw-w64")

(setq @pdist   "../psl/dist/distrib")
(setq @pxdist  "../psl/dist/distrib/mingw-w64")
...
(rdf "$pxc/sys-dm.sl")
(rdf "$pxc/tags.sl")
(rdf "$pxc/mingw-w64-lap.sl")
(rdf "$pxc/mingw-w64-cmac.sl")
(rdf "$pxc/mingw-w64-comp.sl")
(rdf "$pc/faslout.sl")
(rdf "$pxc/mingw-w64-spec.sl")
