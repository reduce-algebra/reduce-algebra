...
(flag
  '(or and not member equal neq eq geq greaterp leq remainder lessp numberp
     ordp flag)
  'direct)
...
(de mapcon (x !*pi!*)
  (cond ((null x) nil) (t (nconc (apply !*pi!* (list x)) (mapcon (cdr x) !*pi!*)))) )

(de mapcons (u !*s!*) (mapcar u (function (lambda (j) (cons !*s!* j)))) )

(de mappend (u !*s!*) (mapcar u (function (lambda (j) (append !*s!* j)))) )
...
(de subs3t (u v)
  (prog (x y z)
    ...
    (cond (mchfg!* (return (multpq (car u) y))))
...
(de mapc2 (u !*pi!*)
  (mapcar
    u
    (function (lambda (j) (mapcar j (function (lambda (k) (apply !*pi!* (list k))))) ))) )
...
(de addm1 (u v !*pi!*)
  (cond
    ...
    (t (cons (apply !*pi!* (list (car u) (car v))) (addm1 (cdr u) (cdr v) !*pi!*)))) )
...
(de mkvarg (u !*pi!*)
  (prog (z)
    ...
    (setq z (cons nil 1))
a   (cond ((null u) (return z)))
    (setq z (addsq (multsq (apply !*pi!* (list (cdar u))) (caar u)) z))
    (setq u (cdr u))
    (go a)))
...
(de emult1 (u v i)
  ((lambda (x !*s!*)
     ((lambda (m n)
        (cond
          ((equal m 4) (times2 24 n))
          ((equal m 3) (multn (times2 6 n) (mkdot (car x) (car !*s!*))))
          (t (multn
              (times2 n (cond ((equal m 0) 1) (t m)))
              (car
                (detq
                  (maplist
                    x
