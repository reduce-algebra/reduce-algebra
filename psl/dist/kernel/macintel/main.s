...
// (*entry init-pointers expr 0)
 .globl l0001
l0001:
 movl _symval+1044,%edi
 movl %edi,_symval+1072
 movl _symval+1040,%edi
 movl %edi,_symval+1076
 movl $7996,%eax
 add _symval+1040,%eax
 movl %eax,_symval+1080
 movl _symval+1040,%edi
 movl %edi,_symval+1084
 movl _symval+1088,%eax
 movl %eax,_symval+1092
 ret
 .long 0
...
l0002:
 ...
 movl %eax,_symval+1100
 movl %eax,_symval+1104
 movl %eax,_symval+1108
 movl %eax,_symval+1112
 movl %eax,_symval+1116
 movl %eax,_symval+1120
 movl %eax,_symval+1124
 movl %eax,_symval+1128
 movl %eax,_symval+1132
 movl %eax,_symval+1136
 movl %eax,_symval+1140
 movl %eax,_symval+1144
 movl %eax,_symval+1148
 movl %eax,_symval+1152
 movl %eax,_symval+1156
 movl %eax,_symval+1160
 movl %eax,_symval+1164
 movl %eax,_symval+1168
 movl %eax,_symval+1172
 movl %eax,_symval+1176
 movl %eax,_symval+1180
 movl %eax,_symval+1184
 movl %eax,_symval+1188
 movl %eax,_symval+1192
 ret
 .long 0
...
_psl_main:
 .globl _psl_main
 movl 4(%esp),%edi
 movl %edi,_symval+1200
 movl 8(%esp),%edi
 movl %edi,_symval+1204
 sub $12,%esp
 movl _symval+1200,%edi
 movl %edi,(%esp)
 movl _symval+1204,%edi
 movl %edi,4(%esp)
 movl %ebx,8(%esp)
 movl _symval+1200,%eax
 movl _symval+1204,%ebx
 movl $27,_symval+1128
 call *symfnc+1208
 movl (%esp),%edi
 movl %edi,_symval+1200
 movl 4(%esp),%edi
 movl %edi,_symval+1204
 movl 8(%esp),%edi
 movl %edi,_symval+1212
 call *symfnc+1068
 movl %esp,%edx
 shr $5,%edx
 movl %edx,_symval+1216
 call *symfnc+1220
 call *symfnc+1224
l0003:
 xor %eax,%eax
...
reduceup:
 ...
 call *symfnc+1248
 movl %eax,12(%esp)
 movl $((30*0x8000000)+116),_symval+1256
 movl 8(%esp),%eax
 call *symfnc+1260
 movl 12(%esp),%eax
 call *symfnc+1264
...
l0018:
 ...
 xor %ecx,%ecx
 movl (%esp),%ebx
 movl _symval+1048,%eax
 shl $1,%ebx
 movw %cx,0(%ebx,%eax,1)
 incl (%esp)
 jmp l0018
l0019:
 movl _symval+1356,%edi
 movl 512(%edi),%eax
 call *symfnc+1360
 movl $128,%ecx
 movl %eax,%ebx
...
l0047:
 ...
 movl (%esp),%ecx
 shl $2,%ecx
 add _symval+1356,%ecx
 movl %ebx,(%ecx)
 movl (%esp),%edx
 shl $2,%edx
 add _symval+1412,%edx
 movl $((30*0x8000000)+128),%ebp
 movl %ebp,(%edx)
 movl (%esp),%eax
 shl $2,%eax
 add _symval+1416,%eax
 movl %ebp,(%eax)
 movl (%esp),%eax
 shl $2,%eax
 add _symval+1420,%eax
 movl (%esp),%ebx
 and $134217727,%ebx
 or $-402653184,%ebx
 movl %ebx,(%eax)
...
l0056:
 ...
 call *symfnc+1448
l0057:
 movl _symval+1452,%eax
 movl %eax,32(%esp)
 movl 28(%esp),%edi
 movl %edi,_symval+1452
 movl 40(%esp),%eax
 call *symfnc+1456
 movl 32(%esp),%edi
 movl %edi,_symval+1452
...
l0088:
 ...
 sar $2,%ecx
 movl $4,%ebx
 add _symval+1036,%ebx
 movl (%esp),%eax
 call *symfnc+1336
 xor %eax,%eax
 add _symval+1036,%eax
 and $134217727,%eax
 or $536870912,%eax
 call *symfnc+1368
 movl %eax,20(%esp)
...
l0094:
 ...
 jle l0095
 movl $15,%eax
 and _symval+1144,%eax
 cmpl $0,%eax
 je l0095
 movl _symval+1144,%ebx
 shr $4,%ebx
 shl $4,%ebx
 add $16,%ebx
 movl %ebx,_symval+1144
l0095:
 movl _symval+1144,%eax
 movl (%esp),%ebx
 shl $2,%ebx
 add _symval+1144,%ebx
 movl %ebx,_symval+1144
 cmpl _symval+1132,%ebx
 jle l0096
 movl %eax,_symval+1144
...
l0101:
 movl %eax,%ecx
 movl _symval+1108,%eax
 movl %ecx,%ebx
 shl $2,%ebx
 add _symval+1108,%ebx
 movl %ebx,_symval+1108
 cmpl _symval+1116,%ebx
 jl l0102
 movl %ecx,%ebx
 jmp *symfnc+1528
l0102:
...
l0106:
 ...
 movl %eax,%ebx
 shl $2,%ebx
 add _symval+1356,%ebx
 movl (%ebx),%edi
 movl %edi,_symval+1352
 ret
 .long 1
// (*entry gtwrds expr 1)
 .globl gtwrds
...
l0156:
 ...
 push %ebx
 push %eax
 movl _symval+1212,%ebx
 call _echoon
 movl %ebx,_symval+1212
 movl 20(%esp),%esp
 ret
 .globl echooff
 .long 0
