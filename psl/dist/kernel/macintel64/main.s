...
_psl_main:
 ...
 mov _symval@GOTPCREL(%rip),%r8
 mov %rdx,2472(%r8)
 mov _symval@GOTPCREL(%rip),%r10
 mov 2144(%r10),%r10
 mov _symval@GOTPCREL(%rip),%r11
 mov 2152(%r11),%r11
...
l0296:
 .quad 43
 .byte 112,114,111,102,105,108,32,102,117
 .byte 110,99,116,105,111,110,32,110,111,32
 .byte 108,111,110,103,101,114,32,115,117
 .byte 112,112,111,114,116,101,100,32,111
 .byte 110,32,77,97,99,79,83,0,0
 .quad 4
// (*entry unix-profile expr 4)
 .globl l0297
l0297:
 mov l0295@GOTPCREL(%rip),%rax
 mov 0(%rax),%rax
 mov _symfnc@GOTPCREL(%rip),%rsi
 mov $372,%rdi
 jmp *2976(%rsi)
...
codeaddressp:
 ...
 jmp l0313
l0312:
 mov l0310@GOTPCREL(%rip),%rax
 mov 0(%rax),%rax
l0313:
 cmp %r15,%rax
 je l0314
 mov l0311@GOTPCREL(%rip),%rax
 mov 0(%rax),%rax
 mov _symfnc@GOTPCREL(%rip),%rsi
 mov $512,%rdi
 call *4096(%rsi)
