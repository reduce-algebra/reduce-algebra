...
(DefAnyreg CAR
	   ...
	   ((regp anyp)    (*move SOURCE REGISTER)
			   (*wor  REGISTER 16#8000000)
			   (displacement REGISTER 16#b0000000))
	   ((anyp regp)    (*move SOURCE REGISTER)
			   (*wor  REGISTER 16#8000000)
			   (displacement REGISTER 16#b0000000))
	   (       (!*Field REGISTER SOURCE InfStartingBit InfBitLength)
		   (displacement REGISTER 16#8000000))
)
...
(DefAnyreg CDR
	   ...
	   ((regp anyp)    (*move SOURCE REGISTER)
			   (*wor  REGISTER 16#8000000)
			   (displacement source 16#b0000004))  
	   ((anyp regp)    (*move SOURCE REGISTER) 
			   (*wor  REGISTER 16#8000000)
			   (displacement REGISTER 16#b0000004))
	   (       (!*Field REGISTER SOURCE InfStartingBit InfBitLength)
		   (displacement REGISTER 16#8000004))
)
...
%	   ((RegP InumP)  (Displacement SOURCE ARGTWO))
	   ...
	   ((RegP RegP)    (*move SOURCE REGISTER)
			   (*wor REGISTER 16#8000000)
			   (Indexed ARGTWO (Displacement REGISTER 0)))
	   ((RegP  AnyP)       (*MOVE SOURCE REGISTER)
...
(deflist '(
	 (Byte    ((mov (indexed (reg 2) (displacement (reg 1) 16#8000000))
			(reg AL))
		   (cbw) 
		   (cwde)))
    %   (PutByte  ((mov (reg CL) (indexed (reg 1) (displacement (reg 2) 0)))))
	(putByte  ((mov (indexed (reg 2)(displacement (reg 1) 16#8000000))
			(reg 4))
		   (*wshift (reg 4) -8)
		   (*wshift (reg 4) 8)
		   (*wand (reg 3) 255)
	...
	(HalfWord ((shl 1 (reg 2))
	       (mov (indexed (reg 2) (displacement (reg 1) 16#8000000))
			(reg AX))
	       (cwde)))
	(PutHalfWord ((shl 1 (reg 2))
	       (OS:)(mov (reg CX) (indexed (reg 1)(displacement (reg 2)
			 16#8000000))))))
  'OpenCode)
