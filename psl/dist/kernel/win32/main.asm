...
l0276:
 push edi
 mov eax,4*08000000h+OFFSET l0275
 mov edi,332
 call [symfnc+1328]
 mov esi,symval+1356
 pop edi
...
l0278:
 mov  DWORD PTR [esp-32],eax
 push eax
 mov eax,4*08000000h+OFFSET l0277
 mov edi,332
 call [symfnc+1328]
 mov eax,DWORD PTR [esp]
 mov edi,332
...
l0280:
 cmp eax,30*08000000h+OFFSET 128
 je l0281
 mov eax,30*08000000h+OFFSET 507
 mov edi,506
 call [symfnc+2024]
 and eax,134217727
 cmp eax,DWORD PTR [esp]
...
l0729:
 DD 6
 DB 117,120,109,105,110,117,115,0
 PUBLIC l0730
  align 4
l0730:
 DD 7
