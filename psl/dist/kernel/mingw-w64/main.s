...
l0077:
 .quad [[254<<56]+128]
 .quad 5
/ (*entry do-relocation-new expr 5)
 .globl l0087
l0087:
 sub $48,%rsp
 mov l0086(%rip),%rdi
...
l0141:
 mov 16(%rsp),%rbx
 mov 8(%rsp),%rax
 call *symfnc+2984(%rip)
 mov 24(%rsp),%rbx
 call *symfnc+2984(%rip)
 mov %rax,%rbx
 mov (%rsp),%rax
 call *symfnc+3040(%rip)
l0142:
 mov 16(%rsp),%rax
 add $32,%rsp
 ret
...
l0749:
 .quad 12
 .byte 95,114,101,115,101,116,115,116,107
 .byte 111,102,108,119,0
 .globl l0750
l0750:
 .quad 5
