...
(put 'wplus2 'pass-1-macro 'pa1m-wplus2)

(de pa1m-wplus2(u)
   (cond ((eq (caddr u) 1) (list 'wincr (cadr u)))
         ((eq (caddr u) -1)(list 'wdecr (cadr u)))
         ((eq (cadr u) 1)  (list 'wincr (caddr u)))
         ((eq (cadr u) -1) (list 'wdecr (caddr u)))
         (t nil)))

(put 'wdifference 'pass-1-macro 'pa1m-wdifference)

(de pa1m-wdifference(u)
   (cond ((eq (caddr u) 1) (list 'wdecr (cadr u)))
         ((eq (caddr u) -1)(list 'wincr (cadr u)))
         (t nil)))
)
