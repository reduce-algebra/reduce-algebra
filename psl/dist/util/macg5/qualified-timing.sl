...
% Package:        Utilities
%
% Copyright (c) 1988, Konrad Zuse Zentrum Berlin, all rights reserved
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
(de qualtime11(u)
  ...
  (push u *allqualtime*)
  (unless (getd u) (printf "*** Function not defined : %w %n" u) (return nil))
  (when (eq u 'equal) (prin2t " Timing for Equal impossible")
                      (return NIL))
  (fluid1 name)
   `(progn
       (copyd ',name ',u)
