...
(put 'wdivide 'opencode
		'((divw (reg 3) (reg 1) (reg 2))
                  (mullw (reg 4) (reg 3) (reg 2))
...
(put 'wtimesdouble 'opencode
     ...
     '(% double length unsigned mutiply;
       (mulhw (reg 3) (reg 1) (reg 2))
       (mullw (reg 1) (reg 1) (reg 2))
       (*WSHIFT (reg 3) 2)
       (*MOVE (reg 1) (reg 2))
       (*WSHIFT (reg 2) -30)
       (*WOR (reg 3)(reg 2))
