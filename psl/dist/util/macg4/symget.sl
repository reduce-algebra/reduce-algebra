...
(defcmacro *symflag  ((*move argone (reg t5))
                      ...
                      (rlwinm (reg t5) (reg t5) 2 5 29) % inf <<2
                      (*wplus2 (reg t5) (reg t4))
                      (*field (reg t5) (reg t5) 5 27)
		   %   (*move 4 (reg t6))
		   %   (rlwimi (reg t5) (reg t6) 27 0 4)
...
(progn % IBM RS 6000
  (put 'putsymflag 'opencode '((*move ($fluid &symflag&) (reg 5))
			      (rlwinm (reg 3) (reg 1) 2 5 29) % inf *4
			      (*wplus2 (reg 5) (reg 3))
			      (*field (reg 5) (reg 5) 5 27)
			      (*move (indexed (reg 5) 4) (reg 3))
			      (*move 1 (reg 4))
			      (slw (reg 4) (reg 4) (reg 2))
			      (*wor (reg 3) (reg 4))
