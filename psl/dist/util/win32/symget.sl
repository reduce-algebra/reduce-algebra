...
(if_system Cray
   ...
   (defcmacro *symflag  ((*move argone (reg t1))
			 ...
			 (*wshift (reg t1) 5)  % inf
			 (*wshift (reg t1) -3) % and * 4
			 (*wplus2 (reg t1) (reg t2))
			 (*wshift (reg t1) 5) % inf
			 (*wshift (reg t1) -5) % inf
			 (*move (memory (reg t1) 4) (reg t1))
...
(if_system Cray
 (progn
  (put 'putsymflag 'opencode '((*move (reg 1) (reg a6))
			       (*move (reg t15) (reg a7))
			       (*wplus2 (reg a6) (reg a7))
			       (*move (indexed (reg a6) 1) (reg s6))
			       (*move (reg 2) (reg a5))
			       (*move 1 (reg s7))
			       (*wshift(reg s7) (reg a5))
			       (*wor  (reg s6) (reg s7))
			       (*move (reg s6) (indexed (reg a6) 1))))

  (put 'delsymflag 'opencode '((*move (reg 1) (reg a6))
			       (*move (reg t15) (reg a7))
			       (*wplus2 (reg a6) (reg a7))
			       (*move (indexed (reg a6) 1) (reg s6))
			       (*move (reg 2) (reg a5))
...
(progn % SUN386
  (put 'putsymflag 'opencode '((*move ($fluid &symflag&) (reg 5))
			       ...
			       (*wshift (reg 5) 5)
			       (*wshift (reg 5) -5) % inf
			       (*move (memory (reg 5) 4) (reg 4))
			       (*move 1 (reg t1))
			       (*wshift (reg t1) (reg 2))
			       (*wor  (reg 4) (reg t1))
			       (*move (reg 4) (memory (reg 5) 4))))
