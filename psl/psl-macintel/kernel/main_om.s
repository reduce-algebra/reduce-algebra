...
l0053:
 ...
 call *symfnc+1416
l0054:
 movl symval+1420,%eax
 movl %eax,32(%esp)
 movl 28(%esp),%edi
 movl %edi,symval+1420
 movl 40(%esp),%eax
 call *symfnc+1424
 movl 32(%esp),%edi
 movl %edi,symval+1420
...
l0133:
 ...
 call *symfnc+1552
 movl 4(%esp),%edi
 cmpl $((30*0x8000000)+386),%edi
 je l0134
 movl 4(%esp),%ecx
 movl $((30*0x8000000)+387),%ebx
 movl (%esp),%eax
 add $12,%esp
 jmp *symfnc+1520
l0134:
